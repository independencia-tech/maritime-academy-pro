...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "MAP" },
      { title: "Maritime Academy Pro" },
      { name: "description", content: "Maritime Academy Pro — maritime training built around international IMO, STCW, SOLAS, MARPOL and COLREG standards." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Maritime Academy Pro" },
      { property: "og:description", content: "Maritime Academy Pro — maritime training built around international IMO, STCW, SOLAS, MARPOL and COLREG standards." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Maritime Academy Pro" },
      { name: "twitter:description", content: "Maritime Academy Pro — maritime training built around international IMO, STCW, SOLAS, MARPOL and COLREG standards." },
