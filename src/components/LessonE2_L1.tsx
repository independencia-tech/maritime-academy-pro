...
const T: any = {
  fr: {
    ...
    quiz: [
      { q: "Quel type de pompe est le plus repandu a bord pour le ballastage ?", opts: ["Pompe a pistons", "Pompe centrifuge", "Pompe a engrenages", "Pompe a vis"], correct: 1, expl: "La pompe centrifuge est la plus repandue a bord pour le ballastage car elle offre un debit eleve a pression moderee, est robuste et simple. Elle est ideale pour les grands debits d'eau de mer (500-2000 m3/h)." },
      { q: "La cavitation se produit quand :", opts: ["La pression de refoulement est trop elevee", "La pression d'aspiration descend sous la pression de vapeur du liquide", "La vitesse de rotation est trop elevee", "Le debit est trop important"], correct: 1, expl: "La cavitation se produit quand la pression absolue en aspiration chute sous la pression de vapeur saturante du liquide. Des bulles de vapeur se forment et implosent violemment sur la roue, causant erosion et vibrations." },
      { q: "Quel composant d'un circuit hydraulique limite la pression maximale ?", opts: ["Le filtre hydraulique", "L'accumulateur", "La soupape de surete", "Le distributeur"], correct: 2, expl: "La soupape de surete (relief valve) limite la pression maximale du circuit hydraulique en s'ouvrant quand la pression depasse le seuil regle et en renvoyant l'huile au reservoir. C'est une protection obligatoire." },
      { q: "Selon les lois de similarite des pompes, si on double la vitesse d'une pompe centrifuge, la puissance consommee est multipliee par :", opts: ["2", "4", "8", "16"], correct: 2, expl: "Selon la loi de similarite : P2/P1 = (n2/n1)3. Si n2 = 2 x n1 : P2 = P1 x 8. La puissance est proportionnelle au cube de la vitesse. C'est pourquoi les variateurs de frequence permettent d'economiser beaucoup d'energie." },
      { q: "Une pompe a engrenages est preferee pour pomper du fuel oil lourd (HFO) car :", opts: ["Elle a un debit plus eleve qu'une centrifuge", "Elle est auto-amorcante et adaptee aux fluides visqueux", "Elle coute moins cher", "Elle ne necessite pas d'entretien"], correct: 1, expl: "La pompe a engrenages est auto-amorcante et gere tres bien les fluides visqueux comme le HFO. Elle maintient un debit constant quelle que soit la viscosite du fluide, contrairement a la pompe centrifuge dont les performances chutent avec les fluides visqueux." },
    ],
  },
  ...
  en: {
    ...
    quiz: [
      { q: "Which pump type is most common on board for ballasting?", opts: ["Piston pump", "Centrifugal pump", "Gear pump", "Screw pump"], correct: 1, expl: "The centrifugal pump is most common on board for ballasting as it offers high flow at moderate pressure, is robust and simple. Ideal for large seawater flows (500-2000 m3/h)." },
      { q: "Cavitation occurs when:", opts: ["Delivery pressure is too high", "Suction pressure drops below liquid vapour pressure", "Rotation speed is too high", "Flow is too high"], correct: 1, expl: "Cavitation occurs when absolute suction pressure drops below the liquid's saturated vapour pressure. Vapour bubbles form and implode violently on the impeller, causing erosion and vibration." },
      { q: "Which hydraulic circuit component limits maximum pressure?", opts: ["Hydraulic filter", "Accumulator", "Relief valve", "Directional valve"], correct: 2, expl: "The relief valve limits maximum hydraulic circuit pressure by opening when pressure exceeds the set threshold and returning oil to the reservoir. Mandatory overpressure protection." },
      { q: "Per pump similarity laws, doubling centrifugal pump speed multiplies power consumption by:", opts: ["2", "4", "8", "16"], correct: 2, expl: "Similarity law: P2/P1 = (n2/n1)3. If n2 = 2xn1: P2 = 8xP1. Power is proportional to speed cubed. This is why VFDs achieve great energy savings on board." },
      { q: "A gear pump is preferred for heavy fuel oil (HFO) because:", opts: ["It has higher flow than centrifugal", "It is self-priming and handles viscous fluids well", "It costs less", "It requires no maintenance"], correct: 1, expl: "The gear pump is self-priming and handles viscous fluids like HFO very well. It maintains constant flow regardless of fluid viscosity, unlike the centrifugal pump whose performance drops with viscous fluids." },
    ],
  },
  ...
  pt: {
    ...
    quiz: [
      { q: "Que tipo de bomba e mais comum a bordo para o lastro?", opts: ["Bomba de pistoes", "Bomba centrifuga", "Bomba de engrenagens", "Bomba de parafuso"], correct: 1, expl: "A bomba centrifuga e a mais comum para o lastro: caudal elevado a pressao moderada, robusta e simples. Ideal para grandes caudais de agua do mar (500-2000 m3/h)." },
      { q: "A cavitacao ocorre quando:", opts: ["A pressao de descarga e demasiado alta", "A pressao de aspiracao desce abaixo da pressao de vapor do liquido", "A velocidade de rotacao e demasiado alta", "O caudal e demasiado elevado"], correct: 1, expl: "A cavitacao ocorre quando a pressao absoluta na aspiracao cai abaixo da pressao de vapor saturado do liquido. Bolhas de vapor formam-se e implodem violentamente na roda, causando erosao e vibracoes." },
      { q: "Que componente do circuito hidraulico limita a pressao maxima?", opts: ["O filtro hidraulico", "O acumulador", "A valvula de seguranca", "O distribuidor"], correct: 2, expl: "A valvula de seguranca limita a pressao maxima abrindo quando a pressao excede o limiar regulado e devolvendo o oleo ao reservatorio. Protecao obrigatoria contra sobrepressao." },
      { q: "Segundo as leis de semelhanca, duplicar a velocidade de uma bomba centrifuga multiplica a potencia consumida por:", opts: ["2", "4", "8", "16"], correct: 2, expl: "Lei de semelhanca: P2/P1 = (n2/n1)3. Se n2 = 2 x n1: P2 = 8 x P1. A potencia e proporcional ao cubo da velocidade. Por isso os variadores de frequencia permitem grande poupanca de energia." },
      { q: "Prefere-se uma bomba de engrenagens para o fuel oil pesado (HFO) porque:", opts: ["Tem maior caudal que a centrifuga", "E autocebante e adequada a fluidos viscosos", "Custa menos", "Nao requer manutencao"], correct: 1, expl: "A bomba de engrenagens e autocebante e lida muito bem com fluidos viscosos como o HFO. Mantém caudal constante independentemente da viscosidade, ao contrario da centrifuga." },
    ],
  },
};
