...
const T: any = {
  fr: {
    ...
    quiz: [
      { q: "Un alternateur tourne a 1500 tr/min avec 2 paires de poles. Quelle est la frequence produite ?", opts: ["25 Hz", "50 Hz", "60 Hz", "100 Hz"], correct: 1, expl: "f = (n x p) / 60 = (1500 x 2) / 60 = 50 Hz. Pour 60 Hz avec 2 paires de poles, il faudrait tourner a 1800 tr/min." },
      { q: "Quel organe controle la TENSION de sortie de l'alternateur ?", opts: ["Le governor", "Le disjoncteur ACB", "L'AVR (regulateur de tension)", "Le synchroscope"], correct: 2, expl: "L'AVR (Automatic Voltage Regulator) controle la tension en ajustant le courant d'excitation du rotor. Le governor controle la frequence en reglant la vitesse du moteur diesel." },
      { q: "Lors d'un couplage en parallele, le synchroscope tourne dans le sens antihoraire. Que faire ?", opts: ["Fermer immediatement le disjoncteur", "Augmenter la vitesse du groupe entrant (governor)", "Diminuer la tension du groupe entrant (AVR)", "Arreter le groupe entrant"], correct: 1, expl: "Sens antihoraire = groupe entrant trop LENT (frequence trop basse). Il faut augmenter sa vitesse avec le governor pour accelerer jusqu'a ce que la frequence corresponde au reseau." },
      { q: "Quelle est la tension triphasee standard pour les gros consommateurs a bord ?", opts: ["24V", "220V", "440V", "6600V"], correct: 2, expl: "440V triphase est la tension standard pour les gros consommateurs a bord (moteurs, pompes, compresseurs). Le 220V est utilise pour l'eclairage et les prises. Le 24V DC est pour les systemes de controle." },
      { q: "Le groupe electrogene de secours doit demarrer automatiquement en combien de secondes selon SOLAS ?", opts: ["15 secondes", "30 secondes", "60 secondes", "5 minutes"], correct: 1, expl: "SOLAS exige que le groupe electrogene de secours demarre et soit pret a alimenter les circuits vitaux en 30 secondes maximum apres la perte de la source principale." },
    ],
  },
  ...
  en: {
    ...
    quiz: [
      { q: "An alternator runs at 1500 rpm with 2 pole pairs. What is the frequency produced?", opts: ["25 Hz", "50 Hz", "60 Hz", "100 Hz"], correct: 1, expl: "f = (n x p) / 60 = (1500 x 2) / 60 = 50 Hz. For 60 Hz with 2 pole pairs, speed would need to be 1800 rpm." },
      { q: "Which device controls the alternator output VOLTAGE?", opts: ["The governor", "The ACB circuit breaker", "The AVR (voltage regulator)", "The synchroscope"], correct: 2, expl: "The AVR controls voltage by adjusting rotor excitation current. The governor controls frequency by regulating diesel engine speed." },
      { q: "During parallel operation, the synchroscope rotates anticlockwise. What should you do?", opts: ["Close the breaker immediately", "Increase incoming generator speed (governor)", "Decrease incoming generator voltage (AVR)", "Stop the incoming generator"], correct: 1, expl: "Anticlockwise = incoming generator TOO SLOW (frequency too low). Increase its speed with the governor until frequency matches the network." },
      { q: "What is the standard three-phase voltage for large consumers on board?", opts: ["24V", "220V", "440V", "6600V"], correct: 2, expl: "440V three-phase is the standard voltage for large consumers on board (motors, pumps, compressors). 220V for lighting and sockets. 24V DC for control systems." },
      { q: "The emergency generator must start automatically within how many seconds per SOLAS?", opts: ["15 seconds", "30 seconds", "60 seconds", "5 minutes"], correct: 1, expl: "SOLAS requires the emergency generator to start and be ready to supply vital circuits within 30 seconds maximum after loss of main power." },
    ],
  },
  ...
  es: {
    ...
    quiz: [
      { q: "Un alternador gira a 1500 rpm con 2 pares de polos. Cual es la frecuencia producida?", opts: ["25 Hz", "50 Hz", "60 Hz", "100 Hz"], correct: 1, expl: "f = (n x p) / 60 = (1500 x 2) / 60 = 50 Hz. Para 60 Hz con 2 pares de polos, habria que girar a 1800 rpm." },
      { q: "Que organo controla la TENSION de salida del alternador?", opts: ["El governor", "El disyuntor ACB", "El AVR (regulador de tension)", "El sincronoscopio"], correct: 2, expl: "El AVR controla la tension ajustando la corriente de excitacion del rotor. El governor controla la frecuencia regulando la velocidad del motor diesel." },
      { q: "Durante un acoplamiento en paralelo, el sincronoscopio gira en sentido antihorario. Que hacer?", opts: ["Cerrar el disyuntor inmediatamente", "Aumentar la velocidad del grupo entrante (governor)", "Disminuir la tension del grupo entrante (AVR)", "Parar el grupo entrante"], correct: 1, expl: "Sentido antihorario = grupo entrante demasiado LENTO (frecuencia baja). Aumentar su velocidad con el governor hasta que la frecuencia coincida con la red." },
      { q: "Cual es la tension trifasica estandar para los grandes consumidores a bordo?", opts: ["24V", "220V", "440V", "6600V"], correct: 2, expl: "440V trifasico es la tension estandar para grandes consumidores (motores, bombas, compresores). 220V para alumbrado y tomas. 24V DC para control." },
      { q: "El generador de emergencia debe arrancar automaticamente en cuantos segundos segun SOLAS?", opts: ["15 segundos", "30 segundos", "60 segundos", "5 minutos"], correct: 1, expl: "SOLAS exige que el generador de emergencia arranque y este listo para alimentar los circuitos vitales en 30 segundos maximo tras la perdida de la fuente principal." },
    ],
  },
  ...
  pt: {
    ...
    quiz: [
      { q: "Um alternador gira a 1500 rpm com 2 pares de polos. Qual e a frequencia produzida?", opts: ["25 Hz", "50 Hz", "60 Hz", "100 Hz"], correct: 1, expl: "f = (n x p) / 60 = (1500 x 2) / 60 = 50 Hz. Para 60 Hz com 2 pares de polos, seria necessario girar a 1800 rpm." },
      { q: "Que dispositivo controla a TENSAO de saida do alternador?", opts: ["O governor", "O disjuntor ACB", "O AVR (regulador de tensao)", "O sincronoscópio"], correct: 2, expl: "O AVR controla a tensao ajustando a corrente de excitacao do rotor. O governor controla a frequencia regulando a velocidade do motor diesel." },
      { q: "Durante a operacao em paralelo, o sincronoscópio gira no sentido anti-horario. O que fazer?", opts: ["Fechar o disjuntor imediatamente", "Aumentar a velocidade do grupo entrante (governor)", "Diminuir a tensao do grupo entrante (AVR)", "Parar o grupo entrante"], correct: 1, expl: "Sentido anti-horario = grupo entrante DEMASIADO LENTO (frequencia baixa). Aumentar a velocidade com o governor ate a frequencia coincidir com a rede." },
      { q: "Qual e a tensao trifasica padrao para grandes consumidores a bordo?", opts: ["24V", "220V", "440V", "6600V"], correct: 2, expl: "440V trifasico e a tensao padrao para grandes consumidores (motores, bombas, compressores). 220V para iluminacao e tomadas. 24V DC para controlo." },
      { q: "O gerador de emergencia deve arrancar automaticamente em quantos segundos segundo o SOLAS?", opts: ["15 segundos", "30 segundos", "60 segundos", "5 minutos"], correct: 1, expl: "O SOLAS exige que o gerador de emergencia arranque e esteja pronto a alimentar circuitos vitais em 30 segundos maximo apos a perda da fonte principal." },
    ],
  },
};
...
export default function LessonE2_L4({ lang="fr", onBack, onComplete, onQuizScored }:{ lang?:string; onBack:()=>void; onComplete?:(xp?:number)=>void; onQuizScored?:(score:number,maxScore:number)=>void; }) {
  const t = T[lang] || T.fr;
  ...
  const lessonOf=lang==="fr"?"Leçon 4/7":lang==="en"?"Lesson 4/7":lang==="es"?"Lección 4/7":"Lição 4/7";
  const badgeText=lang==="fr"?`⚡ ${moduleFull} · Leçon 4/7 · ⭐ Premium · 200 XP`:lang==="en"?`⚡ ${moduleFull} · Lesson 4/7 · ⭐ Premium · 200 XP`:lang==="es"?`⚡ ${moduleFull} · Lección 4/7 · ⭐ Premium · 200 XP`:`⚡ ${moduleFull} · Lição 4/7 · ⭐ Premium · 200 XP`;
    ...
    <div style={{position:"sticky",top:0,zIndex:100,background:"rgba(6,14,26,0.97)",backdropFilter:"blur(14px)",borderBottom:`1px solid ${C.cyan}33`}}>
      <div style={{display:"flex",alignItems:"center",gap:10,padding:"0 14px",height:52}}>
        ...
        <div style={{flex:1,minWidth:0}}>
          <div style={{fontSize:10,color:C.cyan,letterSpacing:1,fontFamily:"'Cinzel',serif"}}>⚡ {moduleFull}{sub?" · "+sub:""}</div>
