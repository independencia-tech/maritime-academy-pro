...
function getBank(lang: string) {
  const b: any = {
    fr:[
      {q:"Qu'est-ce que la combustion stoechiometrique et pourquoi est-elle impossible a atteindre en pratique ?",opts:["C'est la combustion normale utilisee sur toutes les chaudieres","La reaction theorique parfaite avec exactement l'air necessaire ; impossible en pratique car le melange n'est jamais parfaitement homogene, d'ou un exces d'air toujours utilise","Une combustion sans air du tout","Une combustion qui ne produit aucun gaz"],correct:1,expl:"La combustion stoechiometrique necessite exactement 13,5 kg d'air par kg de HFO. En pratique impossible car le melange air-combustible n'est jamais parfaitement homogene : on travaille donc toujours avec un exces d'air (lambda > 1)."},
      {q:"Quelle est la plage optimale du coefficient d'exces d'air (lambda) pour une chaudiere HFO ?",opts:["0,50-0,70","1,10-1,20","2,00-2,50","5,00 et plus"],correct:1,expl:"Lambda = 1,10-1,20 (10-20% d'exces d'air) est optimal pour le HFO, correspondant a un O2 residuel de 2-4% dans les fumees. En dessous, manque d'air et suie ; au-dessus, pertes energetiques."},
      {q:"Pourquoi le HFO doit-il etre prechauffe avant le bruleur ?",opts:["Pour le steriliser","Pour reduire sa viscosite (jusqu'a 700 cSt a froid) a 10-20 cSt permettant une bonne atomisation","Pour augmenter sa densite","Le prechauffage n'est pas necessaire pour le HFO"],correct:1,expl:"Le HFO est extremement visqueux a froid (jusqu'a 700 cSt). Chauffe a 120-150 degC, sa viscosite descend a 10-20 cSt, permettant une atomisation correcte par le gicleur du bruleur."},
      {q:"Que signifie une fumee noire ou gris fonce a la sortie d'une chaudiere ?",opts:["Une combustion parfaite","Un manque d'air ou un exces de combustible, causant des imbrules et de la suie","De l'eau dans le combustible uniquement","Un fonctionnement normal a pleine charge"],correct:1,expl:"Une fumee noire/gris fonce indique un manque d'air ou un exces de fuel, produisant des imbrules (suie, CO). Il faut augmenter l'air et verifier la viscosite du combustible."},
      {q:"Quels sont les principaux produits d'une combustion incomplete du HFO ?",opts:["Uniquement de la vapeur d'eau","CO (monoxyde de carbone toxique), suie et hydrocarbures imbrules","De l'azote pur uniquement","Aucun produit different de la combustion complete"],correct:1,expl:"Une combustion incomplete (manque d'air) produit du CO toxique, de la suie (carbone imbrule, reglemente par MARPOL Annexe VI) et des hydrocarbures imbrules, en plus du CO2 et H2O normaux."},
      {q:"Comment fonctionne un bruleur a pression mecanique ?",opts:["Il vaporise le combustible par chauffage seul","Le combustible est pompe a haute pression (15-30 bar) dans un gicleur qui le pulverise en fines gouttelettes","Il utilise uniquement de la vapeur pour atomiser","Il fonctionne sans pompe, par gravite"],correct:1,expl:"Le combustible est pompe a 15-30 bar dans un gicleur (nozzle) qui le pulverise en fines gouttelettes coniques ; l'air est soufflé autour par un ventilateur. Le gicleur s'use et doit etre nettoye/remplace regulierement."},
      {q:"A quoi sert l'analyse des gaz de combustion (CO2, O2, CO) ?",opts:["Uniquement a des fins statistiques","A ajuster le rapport air/combustible jusqu'a obtenir O2 = 2-4% et CO < 200 ppm simultanement","A mesurer la vitesse du navire","A remplacer le detecteur de flamme"],correct:1,expl:"L'analyse continue des gaz (CO2, O2, CO) permet d'ajuster precisement le rapport air/fuel pour optimiser la combustion, viser O2 entre 2 et 4% et CO sous 200 ppm."},
      {q:"Que faut-il faire imperativement avant de redemarrer un bruleur apres une extinction de flamme ?",opts:["Rallumer immediatement pour ne pas perdre de pression","Purger la chambre de combustion (3-4 volumes) pour eliminer les gaz non brules avant tout redemarrage","Augmenter la pression du combustible avant de rallumer","Rien de particulier, le redemarrage est automatique"],correct:1,expl:"Apres une extinction de flamme, des gaz non brules peuvent s'etre accumules dans le foyer. Un rallumage direct crée un risque d'explosion : une purge obligatoire (3-4 volumes de chambre) est necessaire avant tout redemarrage."},
      {q:"Que se passe-t-il si le rapport air/combustible (A/F) est trop eleve (exces d'air important) ?",opts:["La combustion devient plus efficace sans limite","Les gaz chauds emportent trop de chaleur, reduisant le rendement de la chaudiere","Cela n'a aucun effet sur le rendement","Le risque d'explosion augmente fortement"],correct:1,expl:"Un exces d'air trop important emporte de la chaleur utile dans les fumees, reduisant le rendement. L'optimal se situe legerement au-dessus de la stoechiometrie (lambda = 1,10-1,20)."},
      {q:"Qu'est-ce que la corrosion a basse temperature (point de rosee acide) dans une chaudiere ?",opts:["Une corrosion qui ne concerne que l'exterieur de la coque","Le SO2 du combustible se transforme en acide sulfurique quand la surface descend sous le point de rosee acide (130-150 degC)","Une corrosion causee uniquement par l'eau de mer","Un phenomene sans consequence pratique"],correct:1,expl:"Le SO2 issu de la combustion du soufre du HFO se transforme en SO3 puis en acide sulfurique au contact de vapeur d'eau, si la surface d'echange descend sous le point de rosee acide (130-150 degC). Prevention : maintenir les gaz au-dessus de ce seuil."},
      {q:"Quel est le role du systeme de gestion du bruleur (BMS - Burner Management System) ?",opts:["Il sert uniquement a afficher la temperature","Il controle le demarrage sequence, regule le fonctionnement et coupe automatiquement le combustible en cas de defaut, avec verrouillage","Il ne fait que demarrer manuellement le bruleur","Il remplace la soupape de surete"],correct:1,expl:"Le BMS gere le demarrage sequence (purge, allumage progressif), la regulation en fonctionnement, et la coupure automatique du combustible en cas de defaut (extinction flamme, basse pression), avec verrouillage obligeant a investiguer avant tout redemarrage."},
      {q:"Que fixe MARPOL Annexe VI concernant la teneur en soufre du combustible des chaudieres ?",opts:["Aucune limite n'est fixee","Maximum 0,5% de soufre en haute mer, 0,1% dans les zones ECA","Maximum 5% de soufre partout","La limite ne s'applique qu'aux moteurs, pas aux chaudieres"],correct:1,expl:"MARPOL Annexe VI limite la teneur en soufre du combustible a 0,5% en haute mer (depuis 2020) et 0,1% dans les zones de controle des emissions (ECA), imposant l'usage de VLSFO, MGO ou de scrubbers."},
      {q:"Quels sont les trois principaux types de bruleurs utilises sur les chaudieres marines ?",opts:["Il n'existe qu'un seul type universel","Pression mecanique, a vapeur (steam-assisted) et rotatif","Uniquement des bruleurs a gaz","Electrique, magnetique et hydraulique"],correct:1,expl:"Les trois principaux types sont le bruleur a pression mecanique (gicleur haute pression), le bruleur a vapeur (atomisation assistee par vapeur) et le bruleur rotatif (coupelle tournante). Le choix depend de la puissance et du type de combustible."},
      {q:"Quel est le role du registre d'air (air damper) sur un bruleur ?",opts:["Il sert uniquement a arreter le bruleur","Il regle le debit d'air admis en fonction de la charge, couple au ventilateur pour ajuster le rapport air/combustible","Il chauffe l'air avant combustion","Il filtre le combustible avant le gicleur"],correct:1,expl:"Le registre d'air regle l'ouverture pour ajuster le debit d'air admis en fonction de la charge du bruleur, permettant de maintenir un rapport air/combustible optimal a chaque niveau de puissance."},
      {q:"Que signifie une alarme de CO (monoxyde de carbone) elevee dans les fumees de combustion ?",opts:["Un fonctionnement optimal du bruleur","Un signe de combustion incomplete et un danger toxique, necessitant un ajustement immediat du rapport air/fuel","Une simple indication de la temperature des gaz","Un probleme uniquement lie a la qualite du combustible"],correct:1,expl:"Un CO eleve (> 200 ppm) indique une combustion incomplete par manque d'air, produisant un gaz toxique et un risque d'intoxication. Il faut ajuster immediatement le rapport air/fuel en augmentant l'air."},
    ],
    en:[
      {q:"What is stoichiometric combustion and why is it impossible to achieve in practice?",opts:["It is the normal combustion used on all boilers","The theoretically perfect reaction with exactly the required air; impossible in practice since the mixture is never perfectly homogeneous, hence excess air is always used","Combustion with no air at all","Combustion producing no gases"],correct:1,expl:"Stoichiometric combustion requires exactly 13.5 kg of air per kg of HFO. In practice impossible because the air-fuel mixture is never perfectly homogeneous: excess air (lambda > 1) is always used."},
      {q:"What is the optimal range of the excess air coefficient (lambda) for an HFO boiler?",opts:["0.50-0.70","1.10-1.20","2.00-2.50","5.00 or more"],correct:1,expl:"Lambda = 1.10-1.20 (10-20% excess air) is optimal for HFO, corresponding to a residual O2 of 2-4% in flue gases. Below this, air shortage and soot; above, energy losses."},
      {q:"Why must HFO be preheated before the burner?",opts:["To sterilise it","To reduce its viscosity (up to 700 cSt cold) to 10-20 cSt allowing proper atomisation","To increase its density","Preheating is not necessary for HFO"],correct:1,expl:"HFO is extremely viscous when cold (up to 700 cSt). Heated to 120-150 degC, its viscosity drops to 10-20 cSt, allowing correct atomisation by the burner nozzle."},
      {q:"What does black or dark grey smoke at the boiler outlet indicate?",opts:["Perfect combustion","Insufficient air or excess fuel, causing unburnt products and soot","Only water in the fuel","Normal operation at full load"],correct:1,expl:"Black/dark grey smoke indicates insufficient air or excess fuel, producing unburnt products (soot, CO). Air must be increased and fuel viscosity checked."},
      {q:"What are the main products of incomplete HFO combustion?",opts:["Only water vapour","CO (toxic carbon monoxide), soot and unburnt hydrocarbons","Only pure nitrogen","No products different from complete combustion"],correct:1,expl:"Incomplete combustion (insufficient air) produces toxic CO, soot (unburnt carbon, regulated under MARPOL Annex VI) and unburnt hydrocarbons, in addition to normal CO2 and H2O."},
      {q:"How does a mechanical pressure burner work?",opts:["It vaporises fuel by heating alone","Fuel is pumped at high pressure (15-30 bar) through a nozzle that atomises it into fine droplets","It uses only steam for atomisation","It works without a pump, by gravity"],correct:1,expl:"Fuel is pumped at 15-30 bar through a nozzle that atomises it into fine conical droplets; air is blown around it by a fan. The nozzle wears and must be regularly cleaned/replaced."},
      {q:"What is flue gas analysis (CO2, O2, CO) used for?",opts:["Only for statistical purposes","To adjust the air/fuel ratio until O2 = 2-4% and CO < 200 ppm simultaneously","To measure the vessel's speed","To replace the flame detector"],correct:1,expl:"Continuous gas analysis (CO2, O2, CO) allows precise adjustment of the air/fuel ratio to optimise combustion, targeting O2 between 2 and 4% and CO below 200 ppm."},
      {q:"What must be done before restarting a burner after a flame failure?",opts:["Relight immediately to avoid losing pressure","Purge the combustion chamber (3-4 chamber volumes) to eliminate unburnt gases before any restart","Increase fuel pressure before relighting","Nothing special, restart is automatic"],correct:1,expl:"After a flame failure, unburnt gases may have accumulated in the furnace. Direct relighting creates an explosion risk: a mandatory purge (3-4 chamber volumes) is required before any restart."},
      {q:"What happens if the air/fuel ratio (A/F) is too high (large excess air)?",opts:["Combustion becomes more efficient without limit","Hot gases carry away too much heat, reducing boiler efficiency","It has no effect on efficiency","The explosion risk increases sharply"],correct:1,expl:"Too much excess air carries useful heat away in the flue gases, reducing efficiency. The optimum is slightly above stoichiometry (lambda = 1.10-1.20)."},
      {q:"What is cold-end (acid dew point) corrosion in a boiler?",opts:["Corrosion that only affects the outer hull","SO2 from the fuel turns into sulphuric acid when the surface drops below the acid dew point (130-150 degC)","Corrosion caused only by seawater","A phenomenon with no practical consequence"],correct:1,expl:"SO2 from burning HFO sulphur turns into SO3 then sulphuric acid on contact with water vapour, if the heat exchange surface drops below the acid dew point (130-150 degC). Prevention: keep flue gases above this threshold."},
      {q:"What is the role of the Burner Management System (BMS)?",opts:["It only displays temperature","It controls sequenced startup, regulates operation, and automatically cuts fuel on fault, with lockout","It only manually starts the burner","It replaces the safety valve"],correct:1,expl:"The BMS manages sequenced startup (purge, progressive ignition), operating regulation, and automatic fuel cutoff on fault (flame failure, low pressure), with lockout forcing investigation before any restart."},
      {q:"What does MARPOL Annex VI set for boiler fuel sulphur content?",opts:["No limit is set","Maximum 0.5% sulphur at sea, 0.1% in ECA zones","Maximum 5% sulphur everywhere","The limit only applies to engines, not boilers"],correct:1,expl:"MARPOL Annex VI limits fuel sulphur content to 0.5% at sea (since 2020) and 0.1% in Emission Control Areas (ECA), requiring VLSFO, MGO or scrubbers."},
      {q:"What are the three main types of burners used on marine boilers?",opts:["There is only one universal type","Mechanical pressure, steam-assisted and rotary","Only gas burners","Electric, magnetic and hydraulic"],correct:1,expl:"The three main types are the mechanical pressure burner (high-pressure nozzle), the steam-assisted burner (steam atomisation) and the rotary cup burner. Choice depends on power output and fuel type."},
      {q:"What is the role of the air register (air damper) on a burner?",opts:["It only serves to stop the burner","It adjusts the air flow admitted according to load, coupled with the fan to set the air/fuel ratio","It heats the air before combustion","It filters the fuel before the nozzle"],correct:1,expl:"The air register adjusts its opening to set the air flow admitted according to burner load, allowing an optimal air/fuel ratio to be maintained at every power level."},
      {q:"What does a high CO (carbon monoxide) alarm in combustion flue gases indicate?",opts:["Optimal burner operation","A sign of incomplete combustion and a toxic hazard, requiring immediate adjustment of the air/fuel ratio","A simple indication of flue gas temperature","A problem related only to fuel quality"],correct:1,expl:"High CO (> 200 ppm) indicates incomplete combustion from insufficient air, producing a toxic gas and poisoning risk. The air/fuel ratio must be adjusted immediately by increasing air."},
    ],
    es:[
      {q:"¿Que es la combustion estequiometrica y por que es imposible lograrla en la practica?",opts:["Es la combustion normal usada en todas las calderas","La reaccion teorica perfecta con exactamente el aire necesario; imposible en la practica porque la mezcla nunca es perfectamente homogenea, de ahi que siempre se use exceso de aire","Una combustion sin aire alguno","Una combustion que no produce ningun gas"],correct:1,expl:"La combustion estequiometrica requiere exactamente 13,5 kg de aire por kg de HFO. En la practica es imposible porque la mezcla aire-combustible nunca es perfectamente homogenea: siempre se trabaja con exceso de aire (lambda > 1)."},
      {q:"¿Cual es el rango optimo del coeficiente de exceso de aire (lambda) para una caldera de HFO?",opts:["0,50-0,70","1,10-1,20","2,00-2,50","5,00 o mas"],correct:1,expl:"Lambda = 1,10-1,20 (10-20% de exceso de aire) es optimo para el HFO, correspondiendo a un O2 residual del 2-4% en los gases. Por debajo, falta de aire y hollin; por encima, perdidas energeticas."},
      {q:"¿Por que el HFO debe precalentarse antes del quemador?",opts:["Para esterilizarlo","Para reducir su viscosidad (hasta 700 cSt en frio) a 10-20 cSt permitiendo una buena atomizacion","Para aumentar su densidad","El precalentamiento no es necesario para el HFO"],correct:1,expl:"El HFO es extremadamente viscoso en frio (hasta 700 cSt). Calentado a 120-150 degC, su viscosidad baja a 10-20 cSt, permitiendo una atomizacion correcta por la tobera del quemador."},
      {q:"¿Que significa un humo negro o gris oscuro a la salida de una caldera?",opts:["Una combustion perfecta","Falta de aire o exceso de combustible, causando imbrulados y hollin","Solo agua en el combustible","Un funcionamiento normal a plena carga"],correct:1,expl:"El humo negro/gris oscuro indica falta de aire o exceso de fuel, produciendo imbrulados (hollin, CO). Hay que aumentar el aire y verificar la viscosidad del combustible."},
      {q:"¿Cuales son los principales productos de una combustion incompleta del HFO?",opts:["Solo vapor de agua","CO (monoxido de carbono toxico), hollin e hidrocarburos sin quemar","Solo nitrogeno puro","Ningun producto diferente de la combustion completa"],correct:1,expl:"Una combustion incompleta (falta de aire) produce CO toxico, hollin (carbono sin quemar, regulado por MARPOL Anexo VI) e hidrocarburos sin quemar, ademas del CO2 y H2O normales."},
      {q:"¿Como funciona un quemador de presion mecanica?",opts:["Vaporiza el combustible solo por calentamiento","El combustible se bombea a alta presion (15-30 bar) a traves de una tobera que lo atomiza en finas gotas","Usa solo vapor para atomizar","Funciona sin bomba, por gravedad"],correct:1,expl:"El combustible se bombea a 15-30 bar a traves de una tobera que lo atomiza en finas gotas conicas; el aire es soplado alrededor por un ventilador. La tobera se desgasta y debe limpiarse/sustituirse regularmente."},
      {q:"¿Para que sirve el analisis de gases de combustion (CO2, O2, CO)?",opts:["Solo con fines estadisticos","Para ajustar la relacion aire/combustible hasta obtener O2 = 2-4% y CO < 200 ppm simultaneamente","Para medir la velocidad del buque","Para sustituir al detector de llama"],correct:1,expl:"El analisis continuo de gases (CO2, O2, CO) permite ajustar con precision la relacion aire/combustible para optimizar la combustion, buscando O2 entre 2 y 4% y CO por debajo de 200 ppm."},
      {q:"¿Que hay que hacer obligatoriamente antes de rearrancar un quemador tras una extincion de llama?",opts:["Reencender inmediatamente para no perder presion","Purgar la camara de combustion (3-4 volumenes) para eliminar gases sin quemar antes de cualquier rearranque","Aumentar la presion del combustible antes de reencender","Nada especial, el rearranque es automatico"],correct:1,expl:"Tras una extincion de llama, pueden haberse acumulado gases sin quemar en el hogar. Un reencendido directo crea riesgo de explosion: es obligatoria una purga (3-4 volumenes de camara) antes de cualquier rearranque."},
      {q:"¿Que ocurre si la relacion aire/combustible (A/F) es demasiado alta (gran exceso de aire)?",opts:["La combustion se vuelve mas eficaz sin limite","Los gases calientes se llevan demasiado calor, reduciendo el rendimiento de la caldera","No tiene ningun efecto sobre el rendimiento","El riesgo de explosion aumenta fuertemente"],correct:1,expl:"Un exceso de aire demasiado grande se lleva calor util en los gases de humo, reduciendo el rendimiento. El optimo esta ligeramente por encima de la estequiometria (lambda = 1,10-1,20)."},
      {q:"¿Que es la corrosion por punto de rocio acido en una caldera?",opts:["Una corrosion que solo afecta al exterior del casco","El SO2 del combustible se transforma en acido sulfurico cuando la superficie baja del punto de rocio acido (130-150 degC)","Una corrosion causada solo por el agua de mar","Un fenomeno sin consecuencia practica"],correct:1,expl:"El SO2 procedente de la combustion del azufre del HFO se transforma en SO3 y luego en acido sulfurico al contacto con vapor de agua, si la superficie de intercambio baja del punto de rocio acido (130-150 degC)."},
      {q:"¿Cual es el papel del sistema de gestion del quemador (BMS)?",opts:["Solo sirve para mostrar la temperatura","Controla el arranque secuenciado, regula el funcionamiento y corta automaticamente el combustible ante un fallo, con bloqueo","Solo arranca manualmente el quemador","Sustituye a la valvula de seguridad"],correct:1,expl:"El BMS gestiona el arranque secuenciado (purga, encendido progresivo), la regulacion en funcionamiento, y el corte automatico del combustible ante un fallo (extincion de llama, baja presion), con bloqueo que obliga a investigar antes de rearrancar."},
      {q:"¿Que establece MARPOL Anexo VI sobre el contenido de azufre del combustible de calderas?",opts:["No se establece ningun limite","Maximo 0,5% de azufre en alta mar, 0,1% en zonas ECA","Maximo 5% de azufre en todas partes","El limite solo se aplica a los motores, no a las calderas"],correct:1,expl:"MARPOL Anexo VI limita el contenido de azufre del combustible al 0,5% en alta mar (desde 2020) y al 0,1% en zonas de control de emisiones (ECA), exigiendo el uso de VLSFO, MGO o depuradores."},
      {q:"¿Cuales son los tres principales tipos de quemadores usados en calderas marinas?",opts:["Solo existe un tipo universal","Presion mecanica, asistido por vapor y rotativo","Solo quemadores de gas","Electrico, magnetico e hidraulico"],correct:1,expl:"Los tres tipos principales son el quemador de presion mecanica (tobera de alta presion), el quemador asistido por vapor (atomizacion con vapor) y el quemador rotativo (copa giratoria). La eleccion depende de la potencia y el tipo de combustible."},
      {q:"¿Cual es la funcion del registro de aire (air damper) en un quemador?",opts:["Solo sirve para detener el quemador","Ajusta el caudal de aire admitido segun la carga, acoplado al ventilador para fijar la relacion aire/combustible","Calienta el aire antes de la combustion","Filtra el combustible antes de la tobera"],correct:1,expl:"El registro de aire ajusta su apertura para fijar el caudal de aire admitido segun la carga del quemador, permitiendo mantener una relacion aire/combustible optima en cada nivel de potencia."},
      {q:"¿Que indica una alarma de CO (monoxido de carbono) elevado en los gases de combustion?",opts:["Un funcionamiento optimo del quemador","Un signo de combustion incompleta y un peligro toxico, que exige un ajuste inmediato de la relacion aire/combustible","Solo una indicacion de la temperatura de los gases","Un problema relacionado unicamente con la calidad del combustible"],correct:1,expl:"Un CO elevado (> 200 ppm) indica una combustion incompleta por falta de aire, produciendo un gas toxico y riesgo de intoxicacion. Hay que ajustar de inmediato la relacion aire/combustible aumentando el aire."},
    ],
    pt:[
      {q:"O que e a combustao estequiometrica e por que e impossivel alcanca-la na pratica?",opts:["E a combustao normal usada em todas as caldeiras","A reacao teoricamente perfeita com exatamente o ar necessario; impossivel na pratica pois a mistura nunca e perfeitamente homogenea, por isso usa-se sempre excesso de ar","Uma combustao sem ar nenhum","Uma combustao que nao produz gases"],correct:1,expl:"A combustao estequiometrica requer exatamente 13,5 kg de ar por kg de HFO. Na pratica e impossivel porque a mistura ar-combustivel nunca e perfeitamente homogenea: trabalha-se sempre com excesso de ar (lambda > 1)."},
      {q:"Qual e a faixa otima do coeficiente de excesso de ar (lambda) para uma caldeira de HFO?",opts:["0,50-0,70","1,10-1,20","2,00-2,50","5,00 ou mais"],correct:1,expl:"Lambda = 1,10-1,20 (10-20% de excesso de ar) e otimo para o HFO, correspondendo a um O2 residual de 2-4% nos gases. Abaixo disso, falta de ar e fuligem; acima, perdas energeticas."},
      {q:"Por que o HFO deve ser pre-aquecido antes do queimador?",opts:["Para esteriliza-lo","Para reduzir a sua viscosidade (ate 700 cSt a frio) para 10-20 cSt permitindo boa atomizacao","Para aumentar a sua densidade","O pre-aquecimento nao e necessario para o HFO"],correct:1,expl:"O HFO e extremamente viscoso a frio (ate 700 cSt). Aquecido a 120-150 degC, a sua viscosidade desce para 10-20 cSt, permitindo atomizacao correta pelo bico do queimador."},
      {q:"O que significa um fumo preto ou cinzento escuro na saida de uma caldeira?",opts:["Uma combustao perfeita","Falta de ar ou excesso de combustivel, causando inqueimados e fuligem","Apenas agua no combustivel","Um funcionamento normal a plena carga"],correct:1,expl:"O fumo preto/cinzento escuro indica falta de ar ou excesso de fuel, produzindo inqueimados (fuligem, CO). E preciso aumentar o ar e verificar a viscosidade do combustivel."},
      {q:"Quais sao os principais produtos de uma combustao incompleta do HFO?",opts:["Apenas vapor de agua","CO (monoxido de carbono toxico), fuligem e hidrocarbonetos por queimar","Apenas azoto puro","Nenhum produto diferente da combustao completa"],correct:1,expl:"Uma combustao incompleta (falta de ar) produz CO toxico, fuligem (carbono por queimar, regulado pela MARPOL Anexo VI) e hidrocarbonetos por queimar, alem do CO2 e H2O normais."},
      {q:"Como funciona um queimador de pressao mecanica?",opts:["Vaporiza o combustivel apenas por aquecimento","O combustivel e bombeado a alta pressao (15-30 bar) atraves de um bico que o atomiza em finas gotas","Usa apenas vapor para atomizar","Funciona sem bomba, por gravidade"],correct:1,expl:"O combustivel e bombeado a 15-30 bar atraves de um bico que o atomiza em finas gotas conicas; o ar e soprado a volta por um ventilador. O bico desgasta-se e deve ser limpo/substituido regularmente."},
      {q:"Para que serve a analise dos gases de combustao (CO2, O2, CO)?",opts:["Apenas para fins estatisticos","Para ajustar a relacao ar/combustivel ate obter O2 = 2-4% e CO < 200 ppm simultaneamente","Para medir a velocidade do navio","Para substituir o detetor de chama"],correct:1,expl:"A analise continua dos gases (CO2, O2, CO) permite ajustar com precisao a relacao ar/combustivel para otimizar a combustao, visando O2 entre 2 e 4% e CO abaixo de 200 ppm."},
      {q:"O que e obrigatorio fazer antes de rearrancar um queimador apos uma extincao de chama?",opts:["Reacender imediatamente para nao perder pressao","Purgar a camara de combustao (3-4 volumes) para eliminar gases por queimar antes de qualquer rearranque","Aumentar a pressao do combustivel antes de reacender","Nada de especial, o rearranque e automatico"],correct:1,expl:"Apos uma extincao de chama, podem ter-se acumulado gases por queimar na fornalha. Um reacendimento direto cria risco de explosao: e obrigatoria uma purga (3-4 volumes de camara) antes de qualquer rearranque."},
      {q:"O que acontece se a relacao ar/combustivel (A/F) for demasiado alta (grande excesso de ar)?",opts:["A combustao torna-se mais eficaz sem limite","Os gases quentes levam calor a mais, reduzindo o rendimento da caldeira","Nao tem efeito nenhum no rendimento","O risco de explosao aumenta fortemente"],correct:1,expl:"Um excesso de ar demasiado grande leva calor util nos gases de combustao, reduzindo o rendimento. O otimo situa-se ligeiramente acima da estequiometria (lambda = 1,10-1,20)."},
      {q:"O que e a corrosao por ponto de orvalho acido numa caldeira?",opts:["Uma corrosao que so afeta o exterior do casco","O SO2 do combustivel transforma-se em acido sulfurico quando a superficie desce abaixo do ponto de orvalho acido (130-150 degC)","Uma corrosao causada apenas pela agua do mar","Um fenomeno sem consequencia pratica"],correct:1,expl:"O SO2 proveniente da combustao do enxofre do HFO transforma-se em SO3 e depois em acido sulfurico ao contacto com vapor de agua, se a superficie de troca descer abaixo do ponto de orvalho acido (130-150 degC)."},
      {q:"Qual e o papel do sistema de gestao do queimador (BMS)?",opts:["So serve para mostrar a temperatura","Controla o arranque sequenciado, regula o funcionamento e corta automaticamente o combustivel em caso de falha, com bloqueio","So arranca manualmente o queimador","Substitui a valvula de seguranca"],correct:1,expl:"O BMS gere o arranque sequenciado (purga, ignicao progressiva), a regulacao em funcionamento, e o corte automatico do combustivel em caso de falha (extincao de chama, baixa pressao), com bloqueio que obriga a investigar antes de rearrancar."},
      {q:"O que estabelece a MARPOL Anexo VI sobre o teor de enxofre do combustivel de caldeiras?",opts:["Nenhum limite e estabelecido","Maximo 0,5% de enxofre em alto mar, 0,1% em zonas ECA","Maximo 5% de enxofre em todo o lado","O limite so se aplica aos motores, nao as caldeiras"],correct:1,expl:"A MARPOL Anexo VI limita o teor de enxofre do combustivel a 0,5% em alto mar (desde 2020) e 0,1% em zonas de controlo de emissoes (ECA), exigindo o uso de VLSFO, MGO ou lavadores de gases."},
      {q:"Quais sao os tres principais tipos de queimadores usados em caldeiras marinhas?",opts:["So existe um tipo universal","Pressao mecanica, assistido a vapor e rotativo","So queimadores a gas","Eletrico, magnetico e hidraulico"],correct:1,expl:"Os tres tipos principais sao o queimador de pressao mecanica (bico de alta pressao), o queimador assistido a vapor (atomizacao a vapor) e o queimador rotativo (copo giratorio). A escolha depende da potencia e do tipo de combustivel."},
      {q:"Qual e a funcao do registo de ar (air damper) num queimador?",opts:["So serve para parar o queimador","Ajusta o caudal de ar admitido conforme a carga, acoplado ao ventilador para fixar a relacao ar/combustivel","Aquece o ar antes da combustao","Filtra o combustivel antes do bico"],correct:1,expl:"O registo de ar ajusta a sua abertura para fixar o caudal de ar admitido conforme a carga do queimador, permitindo manter uma relacao ar/combustivel otima em cada nivel de potencia."},
      {q:"O que indica um alarme de CO (monoxido de carbono) elevado nos gases de combustao?",opts:["Um funcionamento otimo do queimador","Um sinal de combustao incompleta e um perigo toxico, exigindo um ajuste imediato da relacao ar/combustivel","Apenas uma indicacao da temperatura dos gases","Um problema relacionado apenas com a qualidade do combustivel"],correct:1,expl:"Um CO elevado (> 200 ppm) indica uma combustao incompleta por falta de ar, produzindo um gas toxico e risco de intoxicacao. E preciso ajustar de imediato a relacao ar/combustivel aumentando o ar."},
    ],
  };
  return b[lang]||b.fr;
}
