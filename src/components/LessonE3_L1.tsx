...
function getQuiz(lang: string) {
  const q: any = {
    fr:[
      {q:"Dans une chaudière acuatubulaire, où circule l'eau ?",opts:["Autour des tubes","À l'intérieur des tubes","Dans le foyer","Dans la cheminée"],correct:1,expl:"Dans une chaudière acuatubulaire (water tube), l'eau circule À L'INTÉRIEUR des tubes, et les gaz chauds passent AUTOUR. C'est l'inverse d'une chaudière ignitubulaire (fire tube). L'acuatubulaire permet des pressions bien plus élevées (jusqu'à 100 bar)."},
      {q:"À quelle pression est réglée la soupape de sûreté d'une chaudière par rapport à la pression de service maximale (PMS) ?",opts:["Exactement à la PMS","5% au-dessus de la PMS","10% au-dessus de la PMS","50% au-dessus de la PMS"],correct:2,expl:"La soupape de sûreté est réglée à 10% au-dessus de la pression maximale de service (PMS). Exemple : pour une chaudière à 7 bar de PMS, la soupape s'ouvre à 7,7 bar. Cela laisse une marge de sécurité sans déclencher la soupape lors des petites variations de pression normales."},
      {q:"Quelle est la pression de service typique d'une chaudière auxiliaire de navire moderne ?",opts:["1-3 bar","7-10 bar","20-30 bar","40-100 bar"],correct:1,expl:"La chaudière auxiliaire standard d'un navire moderne fonctionne à 7-10 bar. À 7 bar, la vapeur est à 165 degC ; à 10 bar, elle est à 180 degC. Les chaudières de propulsion vapeur (navires anciens ou GNL) travaillent à 40-100 bar."},
      {q:"Qu'est-ce qu'une chaudière composite ?",opts:["Une chaudière avec deux brûleurs","Une chaudière combinant un économiseur ECE et un brûleur auxiliaire","Une chaudière acuatubulaire et ignitubulaire en parallèle","Une chaudière fonctionnant au HFO et au MDO"],correct:1,expl:"Une chaudière composite combine un économiseur de gaz d'échappement (ECE) et un brûleur auxiliaire. En navigation, l'ECE récupère gratuitement la chaleur des gaz d'échappement du moteur principal. Le brûleur prend le relais à l'arrêt ou quand la demande dépasse la production ECE. C'est la solution la plus économique."},
      {q:"Que se passe-t-il automatiquement quand le niveau d'eau dans une chaudière descend à 150mm sous le niveau normal ?",opts:["Une alarme sonore se déclenche","Le brûleur s'arrête automatiquement","La soupape de sûreté s'ouvre","La pompe d'alimentation démarre"],correct:1,expl:"À 150mm sous le niveau normal, le brûleur s'arrête automatiquement (safety shutdown) pour éviter que les tubes chauffants soient exposés à sec, ce qui provoquerait une surchauffe et risquerait une explosion. L'alarme de bas niveau se déclenche à 75mm - stade précoce pour augmenter l'alimentation avant l'arrêt."},
    ],
    en:[
      {q:"In a water tube boiler, where does water circulate?",opts:["Around the tubes","Inside the tubes","In the furnace","In the funnel"],correct:1,expl:"In a water tube boiler, water circulates INSIDE the tubes, and hot gases pass AROUND them. The opposite of a fire tube boiler. Water tube allows much higher pressures (up to 100 bar)."},
      {q:"At what pressure is a boiler safety valve set relative to maximum allowable working pressure (MAWP)?",opts:["Exactly at MAWP","5% above MAWP","10% above MAWP","50% above MAWP"],correct:2,expl:"Safety valve set at 10% above MAWP. Example: 7 bar MAWP boiler → valve opens at 7.7 bar. This provides safety margin without triggering on normal small pressure variations."},
      {q:"What is the typical service pressure of a modern vessel auxiliary boiler?",opts:["1-3 bar","7-10 bar","20-30 bar","40-100 bar"],correct:1,expl:"Standard auxiliary boiler operates at 7-10 bar. At 7 bar, steam is 165 degC; at 10 bar, 180 degC. Steam propulsion boilers (old vessels or LNG) operate at 40-100 bar."},
      {q:"What is a composite boiler?",opts:["A boiler with two burners","A boiler combining EGE economiser and auxiliary burner","Parallel water tube and fire tube boiler","A boiler running on HFO and MDO"],correct:1,expl:"A composite boiler combines exhaust gas economiser (EGE) and auxiliary burner. At sea, EGE recovers main engine exhaust heat for free. Burner takes over when stopped or demand exceeds EGE output. Most economical solution."},
      {q:"What happens automatically when boiler water level drops to 150mm below normal?",opts:["Audible alarm triggers","Burner automatically shuts down","Safety valve opens","Feed pump starts"],correct:1,expl:"At 150mm below normal, burner automatically shuts down (safety shutdown) to prevent heating tubes being exposed dry, which would cause overheating and explosion risk. Low level alarm triggers at 75mm - early stage to increase feed before shutdown."},
    ],
    es:[
      {q:"En una caldera acuatubular, ¿dónde circula el agua?",opts:["Alrededor de los tubos","Por el interior de los tubos","En el hogar","En la chimenea"],correct:1,expl:"En una caldera acuatubular (water tube), el agua circula POR EL INTERIOR de los tubos y los gases calientes pasan ALREDEDOR. Lo contrario de una pirotubular. La acuatubular permite presiones mucho más altas (hasta 100 bar)."},
      {q:"¿A qué presión se ajusta la válvula de seguridad respecto a la PMS?",opts:["Exactamente a la PMS","5% sobre la PMS","10% sobre la PMS","50% sobre la PMS"],correct:2,expl:"La válvula se ajusta al 10% sobre la PMS. Ejemplo: caldera de 7 bar → válvula se abre a 7,7 bar. Proporciona margen de seguridad sin dispararse en variaciones normales."},
      {q:"¿Cuál es la presión de servicio típica de una caldera auxiliar de buque moderno?",opts:["1-3 bar","7-10 bar","20-30 bar","40-100 bar"],correct:1,expl:"La caldera auxiliar estándar funciona a 7-10 bar. A 7 bar el vapor está a 165 degC; a 10 bar a 180 degC. Calderas de propulsión: 40-100 bar."},
      {q:"¿Qué es una caldera compuesta?",opts:["Una caldera con dos quemadores","Una caldera que combina economizador EGE y quemador auxiliar","Caldera acuatubular y pirotubular en paralelo","Una caldera que funciona con HFO y MDO"],correct:1,expl:"Una caldera compuesta combina economizador de gases de escape (EGE) y quemador auxiliar. En navegación el EGE recupera calor gratis. El quemador suple en parada. Solución más económica."},
      {q:"¿Qué ocurre automáticamente cuando el nivel de agua baja 150mm bajo el normal?",opts:["Suena una alarma","El quemador se para automáticamente","La válvula de seguridad se abre","La bomba de alimentación arranca"],correct:1,expl:"A 150mm, el quemador se para automáticamente para evitar que los tubos queden expuestos en seco → sobrecalentamiento → riesgo de explosión. La alarma de bajo nivel actúa a 75mm."},
    ],
    pt:[
      {q:"Numa caldeira aquatubular, onde circula a água?",opts:["À volta dos tubos","No interior dos tubos","No forno","Na chaminé"],correct:1,expl:"Numa caldeira aquatubular, a água circula NO INTERIOR dos tubos e os gases quentes passam À VOLTA. O contrário de uma pirotubular. A aquatubular permite pressões muito mais altas (até 100 bar)."},
      {q:"A que pressão está regulada a válvula de segurança em relação à PMS?",opts:["Exatamente na PMS","5% acima da PMS","10% acima da PMS","50% acima da PMS"],correct:2,expl:"A válvula está regulada a 10% acima da PMS. Exemplo: caldeira de 7 bar → válvula abre a 7,7 bar. Proporciona margem de segurança sem disparar em variações normais."},
      {q:"Qual é a pressão de serviço típica de uma caldeira auxiliar de navio moderno?",opts:["1-3 bar","7-10 bar","20-30 bar","40-100 bar"],correct:1,expl:"A caldeira auxiliar padrão funciona a 7-10 bar. A 7 bar o vapor está a 165 degC; a 10 bar a 180 degC. Caldeiras de propulsão: 40-100 bar."},
      {q:"O que é uma caldeira composta?",opts:["Uma caldeira com dois queimadores","Uma caldeira que combina economizador EGE e queimador auxiliar","Caldeira aquatubular e pirotubular em paralelo","Uma caldeira que funciona com HFO e MDO"],correct:1,expl:"Uma caldeira composta combina economizador de gases de escape (EGE) e queimador auxiliar. Em navegação o EGE recupera calor grátis. O queimador supre em paragem. Solução mais económica."},
      {q:"O que acontece automaticamente quando o nível de água baixa 150mm abaixo do normal?",opts:["Soa um alarme","O queimador para automaticamente","A válvula de segurança abre","A bomba de alimentação arranca"],correct:1,expl:"A 150mm, o queimador para automaticamente para evitar que os tubos fiquem expostos a seco → sobreaquecimento → risco de explosão. O alarme de nível baixo atua a 75mm."},
    ],
  };
  return q[lang]||q.fr;
}
...
export default function LessonE3_L1({ lang="fr", onBack, onComplete, onQuizScored }:{ lang?:string; onBack:()=>void; onComplete?:(xp?:number)=>void; onQuizScored?:(score:number,maxScore:number)=>void; }) {
  const t=T[lang]||T.fr;
