...
const T = {
  fr:{
    ...
    shipSurfer:"🏄 Franchissement de barre (Surfer)",
  ...
  es:{
    ...
    shipSurfer:"🏄 Cruce de rompientes (Surfer)",
  ...
  pt:{
    ...
    shipSurfer:"🏄 Transposição de arrebentação (Surfer)",
...
export default function QuestionnaireS7({
  ...
  const moreShips=[
    ...
    {id:"surfer",emoji:"🏄",label:t.shipSurfer},
