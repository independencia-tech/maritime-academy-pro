...
function QuestionBank({ lang }) {
  ...
  const handleAnswer=(i)=>{if(answered)return;setSel(i);setAnswered(true);if(i===list[idx].ans)setScore(s=>s+1);};
...
// MAIN EXPORT
// ══════════════════════════════════════
export default function LessonE7_L2({ lang="fr", onBack=()=>{}, onComplete=()=>{} }) {
  const t=T[lang]||T.fr;
