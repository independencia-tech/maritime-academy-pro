  ...
  export const BANK={
    fr:[
      {q:"Que signifie PLC dans le domaine de l'automatisme industriel ?",
        ...
        correct:1,expl:"PLC = Programmable Logic Controller (Automate Programmable Industriel en francais). C'est le composant fondamental du controle-commande industriel, present sur tous les navires modernes pour controler les machines principales, generateurs, purificateurs et systemes auxiliaires."},
      {q:"Quelle est la difference fondamentale entre un PLC et un DCS ?",
        ...
        correct:1,expl:"PLC (Programmable Logic Controller) : controle local d'une machine unique avec temps reel dur (< 10ms). DCS (Distributed Control System) : controle reparti sur l'ensemble d'un process industriel (salle des machines VLCC) avec temps reel souple (50-500ms) et architecture redondante."},
      {q:"Que signifie SCADA ?",
        ...
        correct:1,expl:"SCADA = Supervisory Control And Data Acquisition. C'est le niveau superieur de la pyramide automatisme : supervision a distance, collecte de donnees, historisation, gestion d'alarmes. En maritime : Kongsberg K-IMS, Wartsila NACOS, ABB EMMA supervisant les performances de la flotte."},
      {q:"Dans un cycle SCAN PLC, quelle est la sequence correcte ?",
        ...
        correct:1,expl:"Le cycle SCAN PLC suit toujours la sequence : 1) Lecture des entrees (capteurs), 2) Execution du programme utilisateur, 3) Mise a jour des sorties (actionneurs), 4) Communication reseau. Ce cycle se repete typiquement en moins de 10ms pour les machines critiques."},
      {q:"Quelle est la plage de signal standard pour les entrees/sorties analogiques d'un PLC maritime ?",
        ...
        correct:2,expl:"4-20mA est le standard industriel universel pour les signaux analogiques. L'avantage majeur : le courant de repos est 4mA (jamais 0), ce qui permet de detecter une rupture de cable (signal tombe a 0mA = panne). 4mA = valeur min (0%), 20mA = valeur max (100%)."},
      ...
      {q:"Dans une boucle de regulation PID, que corrige l'action Integrale (I) ?",
        ...
        correct:1,expl:"L'action Integrale (I) corrige l'erreur statique (ecart residuel entre PV et SP apres stabilisation). P seul laisse toujours un ecart residuel. I accumule l'erreur dans le temps et augmente la sortie jusqu'a eliminer l'ecart. Risque : trop de I = oscillations (windup)."},
      {q:"Quelle est la difference entre une entree DI et une entree AI dans un PLC ?",
        ...
        correct:1,expl:"DI (Digital Input) : signal logique 0 ou 1 (ex: vanne ouverte/fermee, moteur en marche/arret). AI (Analog Input) : signal continu 4-20mA representant une valeur physique (temperature, pression, niveau). Les capteurs maritimes envoient majoritairement des signaux AI."},
      {q:"Quel protocole de communication est le plus utilise dans les systemes PLC maritimes ?",
        ...
        correct:1,expl:"Modbus RTU (serie) et Modbus TCP (Ethernet) sont les protocoles les plus repandus dans les systemes maritimes. Simples, robustes, ouverts et standardises depuis 1979 (Modicon). Autres protocoles utilisés en maritime : Profibus, Profinet, NMEA 2000, CANopen."},
      {q:"Dans la pyramide d'automatisme, quel niveau represente le DCS ?",
        ...
        correct:2,expl:"La pyramide d'automatisme (ISA-95) : Niveau 0 = terrain (capteurs/actionneurs), Niveau 1 = commande locale (PLC), Niveau 2 = controle de process (DCS), Niveau 3 = supervision et historisation (SCADA/MES), Niveau 4 = ERP/gestion enterprise. Le DCS est au niveau 2, entre PLC et SCADA."},
      ...
      {q:"Qu'est-ce que le 'temps de cycle' d'un PLC ?",
        ...
        correct:1,expl:"Le temps de cycle PLC = temps pour completer un cycle SCAN : lecture entrees + execution programme + mise a jour sorties + communication. Pour les machines critiques : 5-10ms. Pour les process non critiques : 50-200ms. Un temps de cycle trop long = risque de ne pas detecter une anomalie rapide (ex: surtension)."},
      {q:"Quelle est la principale difference entre Profibus et Profinet ?",
        ...
        correct:1,expl:"Profibus (Process Field Bus) : communication serie RS-485, jusqu'a 12Mbps, max 125 noeuds. Profinet : version Ethernet industriel (100Mbps ou 1Gbps), supports TCP/IP, temps reel garanti. Les nouveaux navires migrent vers Profinet/Ethernet IP pour les debit eleves et l'integration IoT maritime."},
    ...
    en:[
      ...
      {q:"What is the fundamental difference between a PLC and a DCS?",
        ...
        correct:1,expl:"PLC: local control of a single machine with hard real-time (< 10ms). DCS (Distributed Control System): distributed control across an entire industrial process (VLCC engine room) with soft real-time (50-500ms) and redundant architecture."},
      {q:"What does SCADA stand for?",
        opts:["System Control And Data Analysis","Supervisory Control And Data Acquisition","Safety Control And Data Access","Systematic Control And Device Alert"],
        correct:1,expl:"SCADA = Supervisory Control And Data Acquisition. It is the top level of the automation pyramid: remote supervision, data collection, historization, alarm management. Maritime examples: Kongsberg K-IMS, Wartsila NACOS, ABB EMMA supervising fleet performance."},
      {q:"In a PLC SCAN cycle, what is the correct sequence?",
        ...
        correct:1,expl:"The PLC SCAN cycle always follows: 1) Read inputs (sensors), 2) Execute user program, 3) Update outputs (actuators), 4) Network communication. This cycle repeats typically in under 10ms for critical machinery."},
      {q:"What is the standard signal range for analog I/O in a maritime PLC?",
        opts:["0-5V","0-10V","4-20mA","0-1A"],
        correct:2,expl:"4-20mA is the universal industrial standard for analog signals. Key advantage: idle current is 4mA (never 0), allowing cable break detection (signal drops to 0mA = fault). 4mA = min value (0%), 20mA = max value (100%)."},
      {q:"MV El Faro (2015) was lost primarily because of:",
        ...
        correct:1,expl:"MV El Faro sank because engine management system alerts (low oil pressure, bilge pump, stability) were repeatedly ignored by command. The captain maintained course toward Hurricane Joaquin. 33 deaths. SCADA/PLC alerts are mandatory safety signals."},
      {q:"In a PID control loop, what does the Integral (I) action correct?",
        ...
        correct:1,expl:"The Integral (I) action corrects steady-state error (residual gap between PV and SP after stabilization). P alone always leaves residual error. I accumulates error over time and increases output until the gap is eliminated. Risk: too much I = oscillations (windup)."},
      {q:"What is the difference between DI and AI inputs in a PLC?",
        ...
        correct:1,expl:"DI (Digital Input): logic signal 0 or 1 (e.g. valve open/closed, motor running/stopped). AI (Analog Input): continuous 4-20mA signal representing a physical value (temperature, pressure, level). Maritime sensors mostly send AI signals."},
      {q:"Which communication protocol is most used in maritime PLC systems?",
        opts:["USB","Modbus RTU/TCP","Bluetooth","RS-232 serial"],
        correct:1,expl:"Modbus RTU (serial) and Modbus TCP (Ethernet) are the most widely used protocols in maritime systems. Simple, robust, open and standardized since 1979 (Modicon). Other maritime protocols: Profibus, Profinet, NMEA 2000, CANopen."},
      {q:"In the automation pyramid, which level does DCS represent?",
        ...
        correct:2,expl:"ISA-95 automation pyramid: Level 0 = field (sensors/actuators), Level 1 = local control (PLC), Level 2 = process control (DCS), Level 3 = supervision and historization (SCADA/MES), Level 4 = ERP/enterprise management. DCS is at level 2, between PLC and SCADA."},
      {q:"What is redundancy in a maritime DCS?",
        ...
        correct:1,expl:"DCS redundancy = duplication of critical components: redundant CPU (Active/Standby), redundant power supply (two sources), redundant network (dual bus). If one component fails, the system automatically switches to the backup without control interruption. Mandatory for critical VLCC systems."},
      {q:"What is the role of OPC in maritime SCADA systems?",
        ...
        correct:1,expl:"OPC (OLE for Process Control, now OPC-UA) is an interoperability standard allowing heterogeneous systems (Siemens PLC + ABB DCS + Kongsberg SCADA) to communicate and exchange data. Essential for integrating systems from different manufacturers aboard modern vessels."},
      {q:"What is the PLC 'scan time'?",
        ...
        correct:1,expl:"PLC scan time = time to complete one SCAN cycle: read inputs + execute program + update outputs + communication. For critical machinery: 5-10ms. For non-critical processes: 50-200ms. Too long a scan time = risk of missing a fast anomaly (e.g. overvoltage)."},
      {q:"What is the main difference between Profibus and Profinet?",
        ...
        correct:1,expl:"Profibus: serial RS-485 communication, up to 12Mbps, max 125 nodes. Profinet: industrial Ethernet version (100Mbps or 1Gbps), supports TCP/IP, guaranteed real-time. New vessels are migrating to Profinet/Ethernet IP for high throughput and maritime IoT integration."},
      {q:"Why does a maritime PLC system use certified function blocks (e.g. IEC 61511)?",
        ...
        correct:1,expl:"IEC 61511 (Safety Instrumented Systems) defines SIL levels (Safety Integrity Level) 1 to 4. Critical safety functions (emergency ME stop, HFO valve closure, fire alarms) must be implemented in SIL-certified blocks. On VLCC: SIL 2 minimum for systems related to propulsion and cargo safety."},
    ],
    es:[
      {q:"?Que significa PLC en automatizacion industrial?",
        opts:["Power Line Controller","Programmable Logic Controller","Process Level Control","Peripheral Logic Computer"],
        correct:1,expl:"PLC = Programmable Logic Controller (Automata Programable Industrial). Es el componente fundamental del control industrial, presente en todos los buques modernos para controlar motores principales, generadores, purificadores y sistemas auxiliares."},
      {q:"?Cual es la diferencia fundamental entre un PLC y un DCS?",
        ...
        correct:1,expl:"PLC: control local de una maquina unica con tiempo real duro (menor de 10ms). DCS (Distributed Control System): control distribuido en todo un proceso industrial (sala de maquinas VLCC) con tiempo real suave (50-500ms) y arquitectura redundante."},
      {q:"?Que significa SCADA?",
        opts:["System Control And Data Analysis","Supervisory Control And Data Acquisition","Safety Control And Data Access","Systematic Control And Device Alert"],
        correct:1,expl:"SCADA = Supervisory Control And Data Acquisition. Es el nivel superior de la piramide de automatizacion: supervision remota, recopilacion de datos, historizacion, gestion de alarmas. En maritimo: Kongsberg K-IMS, Wartsila NACOS, ABB EMMA."},
      {q:"En un ciclo SCAN PLC, ?cual es la secuencia correcta?",
        ...
        correct:1,expl:"El ciclo SCAN PLC sigue siempre: 1) Lectura entradas (sensores), 2) Ejecucion programa usuario, 3) Actualizacion salidas (actuadores), 4) Comunicacion red. Este ciclo se repite tipicamente en menos de 10ms para maquinaria critica."},
      {q:"?Cual es el rango de senal estandar para E/S analogicas en un PLC maritimo?",
        opts:["0-5V","0-10V","4-20mA","0-1A"],
        correct:2,expl:"4-20mA es el estandar industrial universal para senales analogicas. Ventaja clave: la corriente en reposo es 4mA (nunca 0), lo que permite detectar rotura de cable (senal cae a 0mA = averia). 4mA = valor min (0%), 20mA = valor max (100%)."},
      {q:"El MV El Faro (2015) se perdio principalmente porque:",
        ...
        correct:1,expl:"El El Faro se hundio porque las alertas del sistema de gestion electronica de maquinas (presion aceite baja, bomba de sentina, estabilidad) fueron repetidamente ignoradas por el mando. 33 muertos. Las alertas SCADA/PLC son senales de seguridad obligatorias."},
      {q:"En una boucle PID, ?que corrige la accion Integral (I)?",
        ...
        correct:1,expl:"La accion Integral (I) corrige el error estatico (diferencia residual entre PV y SP tras estabilizacion). P solo siempre deja un error residual. I acumula el error en el tiempo y aumenta la salida hasta eliminar la diferencia."},
      {q:"?Cual es la diferencia entre entradas DI y AI en un PLC?",
        ...
        correct:1,expl:"DI (Digital Input): senal logica 0 o 1 (ej: valvula abierta/cerrada, motor en marcha/parado). AI (Analog Input): senal continua 4-20mA representando un valor fisico (temperatura, presion, nivel)."},
      {q:"?Que protocolo de comunicacion se usa mas en sistemas PLC maritimos?",
        opts:["USB","Modbus RTU/TCP","Bluetooth","RS-232 serie"],
        correct:1,expl:"Modbus RTU (serie) y Modbus TCP (Ethernet) son los protocolos mas usados en sistemas maritimos. Simples, robustos, abiertos y estandarizados desde 1979 (Modicon). Otros protocolos maritimos: Profibus, Profinet, NMEA 2000, CANopen."},
      {q:"En la piramide de automatizacion, ?que nivel representa el DCS?",
        ...
        correct:2,expl:"Piramide ISA-95: Nivel 0 = campo, Nivel 1 = control local (PLC), Nivel 2 = control de proceso (DCS), Nivel 3 = supervision (SCADA/MES), Nivel 4 = ERP. El DCS esta en el nivel 2, entre PLC y SCADA."},
      {q:"?Que es la redundancia en un DCS maritimo?",
        ...
        correct:1,expl:"Redundancia DCS = duplicacion de componentes criticos: CPU redundante (Activo/Standby), alimentacion redundante (dos fuentes), red redundante (doble bus). Si un componente falla, el sistema conmuta automaticamente al duplicado sin interrumpir el control."},
      {q:"?Cual es el rol del OPC en sistemas SCADA maritimos?",
        ...
        correct:1,expl:"OPC (OLE for Process Control, ahora OPC-UA) es un estandar de interoperabilidad que permite a sistemas heterogeneos (PLC Siemens + DCS ABB + SCADA Kongsberg) comunicarse e intercambiar datos. Esencial para integrar sistemas de distintas marcas a bordo."},
      {q:"?Que es el tiempo de ciclo de un PLC?",
        ...
        correct:1,expl:"Tiempo de ciclo PLC = tiempo para completar un ciclo SCAN: leer entradas + ejecutar programa + actualizar salidas + comunicacion. Para maquinaria critica: 5-10ms. Para procesos no criticos: 50-200ms."},
      {q:"?Cual es la principal diferencia entre Profibus y Profinet?",
        ...
        correct:1,expl:"Profibus: comunicacion serie RS-485, hasta 12Mbps, max 125 nodos. Profinet: version Ethernet industrial (100Mbps o 1Gbps), soporta TCP/IP, tiempo real garantizado. Los nuevos buques migran a Profinet para mayor ancho de banda e integracion IoT maritima."},
      {q:"?Por que un sistema PLC maritimo usa bloques funcion certificados (ej: IEC 61511)?",
        ...
        correct:1,expl:"IEC 61511 define los niveles SIL (Safety Integrity Level) 1 a 4. Las funciones de proteccion criticas (parada urgencia ME, cierre valvulas HFO, alarmas incendio) deben implementarse en bloques certificados SIL. En VLCC: SIL 2 minimo para sistemas relacionados con la propulsion y seguridad de la carga."},
    ],
    pt:[
      {q:"O que significa PLC em automatizacao industrial?",
        opts:["Power Line Controller","Programmable Logic Controller","Process Level Control","Peripheral Logic Computer"],
        correct:1,expl:"PLC = Programmable Logic Controller. E o componente fundamental dos sistemas de controlo industrial, presente em todos os navios modernos para controlar motores principais, geradores, purificadores e sistemas auxiliares."},
      {q:"Qual e a diferenca fundamental entre um PLC e um DCS?",
        ...
        correct:1,expl:"PLC: controlo local de uma maquina unica com tempo real duro (menos de 10ms). DCS (Distributed Control System): controlo distribuido num processo industrial completo (casa das maquinas VLCC) com tempo real suave (50-500ms) e arquitectura redundante."},
      {q:"O que significa SCADA?",
        opts:["System Control And Data Analysis","Supervisory Control And Data Acquisition","Safety Control And Data Access","Systematic Control And Device Alert"],
        correct:1,expl:"SCADA = Supervisory Control And Data Acquisition. E o nivel superior da piramide de automatizacao: supervisao remota, recolha de dados, historizacao, gestao de alarmes. Em maritimo: Kongsberg K-IMS, Wartsila NACOS, ABB EMMA."},
      {q:"Num ciclo SCAN PLC, qual e a sequencia correcta?",
        ...
        correct:1,expl:"O ciclo SCAN PLC segue sempre: 1) Leitura entradas (sensores), 2) Execucao programa utilizador, 3) Actualizacao saidas (atuadores), 4) Comunicacao rede. Este ciclo repete-se tipicamente em menos de 10ms para maquinaria critica."},
      {q:"Qual e a gama de sinal padrao para E/S analogicas num PLC maritimo?",
        opts:["0-5V","0-10V","4-20mA","0-1A"],
        correct:2,expl:"4-20mA e o padrao industrial universal para sinais analogicos. Vantagem chave: a corrente em repouso e 4mA (nunca 0), permitindo detectar rotura de cabo (sinal cai a 0mA = avaria). 4mA = valor min (0%), 20mA = valor max (100%)."},
      {q:"O MV El Faro (2015) perdeu-se principalmente porque:",
        ...
        correct:1,expl:"O El Faro naufragou porque os alertas do sistema de gestao electronica das maquinas (pressao oleo baixa, bomba de porao, estabilidade) foram repetidamente ignorados pelo comando. 33 mortos. Os alertas SCADA/PLC sao sinais de seguranca obrigatorios."},
      {q:"Numa boucle PID, o que corrige a accao Integral (I)?",
        ...
        correct:1,expl:"A accao Integral (I) corrige o erro estatico (diferenca residual entre PV e SP apos estabilizacao). P sozinho deixa sempre um erro residual. I acumula o erro ao longo do tempo e aumenta a saida ate eliminar a diferenca."},
      {q:"Qual e a diferenca entre entradas DI e AI num PLC?",
        ...
        correct:1,expl:"DI (Digital Input): sinal logico 0 ou 1 (ex: valvula aberta/fechada, motor em marcha/parado). AI (Analog Input): sinal continuo 4-20mA representando um valor fisico (temperatura, pressao, nivel)."},
      {q:"Que protocolo de comunicacao e mais usado em sistemas PLC maritimos?",
        opts:["USB","Modbus RTU/TCP","Bluetooth","RS-232 serie"],
        correct:1,expl:"Modbus RTU (serie) e Modbus TCP (Ethernet) sao os protocolos mais usados em sistemas maritimos. Simples, robustos, abertos e normalizados desde 1979 (Modicon). Outros protocolos maritimos: Profibus, Profinet, NMEA 2000, CANopen."},
      {q:"Na piramide de automatizacao, que nivel representa o DCS?",
        ...
        correct:2,expl:"Piramide ISA-95: Nivel 0 = campo, Nivel 1 = controlo local (PLC), Nivel 2 = controlo de processo (DCS), Nivel 3 = supervisao (SCADA/MES), Nivel 4 = ERP. O DCS esta no nivel 2, entre PLC e SCADA."},
      {q:"O que e a redundancia num DCS maritimo?",
        ...
        correct:1,expl:"Redundancia DCS = duplicacao de componentes criticos: CPU redundante (Activo/Standby), alimentacao redundante (duas fontes), rede redundante (duplo bus). Se um componente falha, o sistema comuta automaticamente para o duplicado sem interrupcao do controlo."},
      {q:"Qual e o papel do OPC nos sistemas SCADA maritimos?",
        ...
        correct:1,expl:"OPC (OLE for Process Control, agora OPC-UA) e um padrao de interoperabilidade que permite a sistemas heterogeneos (PLC Siemens + DCS ABB + SCADA Kongsberg) comunicar e trocar dados. Essencial para integrar sistemas de diferentes fabricantes a bordo."},
      {q:"O que e o tempo de ciclo de um PLC?",
        ...
        correct:1,expl:"Tempo de ciclo PLC = tempo para completar um ciclo SCAN: ler entradas + executar programa + actualizar saidas + comunicacao. Para maquinaria critica: 5-10ms. Para processos nao criticos: 50-200ms."},
      {q:"Qual e a principal diferenca entre Profibus e Profinet?",
        ...
        correct:1,expl:"Profibus: comunicacao serie RS-485, ate 12Mbps, max 125 nos. Profinet: versao Ethernet industrial (100Mbps ou 1Gbps), suporta TCP/IP, tempo real garantido. Os novos navios migram para Profinet para maior largura de banda e integracao IoT maritima."},
      {q:"Porque e que um sistema PLC maritimo usa blocos funcao certificados (ex: IEC 61511)?",
        ...
        correct:1,expl:"IEC 61511 define os niveis SIL (Safety Integrity Level) 1 a 4. As funcoes de proteccao criticas (paragem urgencia ME, fecho valvulas HFO, alarmes incendio) devem ser implementadas em blocos certificados SIL. Em VLCC: SIL 2 minimo para sistemas de propulsao e seguranca da carga."},
    ],
  };
...
export const QUIZ={
  fr:[
    {q:"PLC signifie et est utilise pour :",opts:["Power Loop Controller — supervision flotte","Programmable Logic Controller — controle local machine","Process Level Control — gestion process","Peripheral Logic Computer — reseau embarque"],
      correct:1,expl:"PLC = Programmable Logic Controller. Controle local d'une machine unique (moteur, generateur, purificateur) avec temps reel dur sous 10ms. Differents du DCS (multi-process) et SCADA (supervision)."},
    {q:"La pyramide automatisme du bas vers le haut est :",opts:["SCADA -> DCS -> PLC -> Capteurs","Capteurs -> PLC -> DCS -> SCADA","DCS -> PLC -> SCADA -> Capteurs","PLC -> DCS -> Capteurs -> SCADA"],
      correct:1,expl:"Pyramide ISA-95 : Niveau 0 = Capteurs/actionneurs, Niveau 1 = PLC (controle local), Niveau 2 = DCS (controle process), Niveau 3 = SCADA (supervision), Niveau 4 = ERP. Chaque niveau a son role specifique."},
    {q:"Dans une boucle PID, l'action I (Integrale) corrige :",opts:["Les oscillations rapides","L'erreur statique persistante","Les perturbations exterieures","La vitesse de montee"],
      correct:1,expl:"L'action Integrale accumule l'erreur dans le temps et l'elimine entierement (erreur statique = 0 en regime permanent). P seul laisse toujours un ecart residuel. Trop de I provoque des oscillations."},
    {q:"Le standard 4-20mA pour les signaux analogiques PLC permet de :",opts:["Gagner en vitesse","Detecter les ruptures de cable (0mA = panne)","Augmenter la distance","Reduire le cout"],
      correct:1,expl:"Avec 4-20mA : en fonctionnement normal, le courant est toujours entre 4 et 20mA. Si le cable se coupe, le signal tombe a 0mA. Ce 0mA ne peut pas etre une valeur physique valide => detection automatique de panne. Avantage majeur vs 0-10V."},
    {q:"Le MV El Faro illustre que les alertes PLC/SCADA ignorees peuvent :",opts:["Reduire les performances","Entrainer la perte du navire et de l'equipage","Causer des retards commerciaux","Augmenter la consommation"],
      correct:1,expl:"El Faro (2015) : alertes systeme repetees (pression huile, stabilite) ignorees => capitaine maintient cap ouragan Joaquin => 33 morts. Le systeme SCADA/PLC avait detecte les anomalies. La decision humaine d'ignorer les alertes est la cause directe du naufrage."},
  ],
  en:[
    {q:"PLC stands for and is used for:",opts:["Power Loop Controller — fleet supervision","Programmable Logic Controller — local machine control","Process Level Control — process management","Peripheral Logic Computer — onboard network"],
      correct:1,expl:"PLC = Programmable Logic Controller. Local control of a single machine (engine, generator, purifier) with hard real-time under 10ms. Different from DCS (multi-process) and SCADA (supervision)."},
    {q:"The automation pyramid from bottom to top is:",opts:["SCADA -> DCS -> PLC -> Sensors","Sensors -> PLC -> DCS -> SCADA","DCS -> PLC -> SCADA -> Sensors","PLC -> DCS -> Sensors -> SCADA"],
      correct:1,expl:"ISA-95 pyramid: Level 0 = Sensors/actuators, Level 1 = PLC (local control), Level 2 = DCS (process control), Level 3 = SCADA (supervision), Level 4 = ERP. Each level has its specific role."},
    {q:"In a PID loop, the I (Integral) action corrects:",opts:["Rapid oscillations","Persistent steady-state error","External disturbances","Rise time"],
      correct:1,expl:"Integral action accumulates error over time and eliminates it entirely (steady-state error = 0 in permanent regime). P alone always leaves residual error. Too much I causes oscillations."},
    {q:"The 4-20mA standard for PLC analog signals allows:",opts:["Speed improvement","Cable break detection (0mA = fault)","Greater distance","Cost reduction"],
      correct:1,expl:"With 4-20mA: in normal operation, current is always between 4 and 20mA. If cable breaks, signal drops to 0mA. This 0mA cannot be a valid physical value => automatic fault detection. Major advantage vs 0-10V."},
    {q:"MV El Faro illustrates that ignored PLC/SCADA alerts can:",opts:["Reduce performance","Lead to loss of vessel and crew","Cause commercial delays","Increase consumption"],
      correct:1,expl:"El Faro (2015): repeated system alerts (oil pressure, stability) ignored => captain maintains course toward Hurricane Joaquin => 33 deaths. The SCADA/PLC system had detected anomalies. The human decision to ignore alerts is the direct cause of the sinking."},
  ],
  es:[
    {q:"PLC significa y se usa para:",opts:["Power Loop Controller — supervision flota","Programmable Logic Controller — control local maquina","Process Level Control — gestion proceso","Peripheral Logic Computer — red embarcada"],
      correct:1,expl:"PLC = Programmable Logic Controller. Control local de una maquina unica (motor, generador, purificador) con tiempo real duro inferior a 10ms. Diferente del DCS (multi-proceso) y SCADA (supervision)."},
    {q:"La piramide de automatizacion de abajo a arriba es:",opts:["SCADA -> DCS -> PLC -> Sensores","Sensores -> PLC -> DCS -> SCADA","DCS -> PLC -> SCADA -> Sensores","PLC -> DCS -> Sensores -> SCADA"],
      correct:1,expl:"Piramide ISA-95: Nivel 0 = Sensores/actuadores, Nivel 1 = PLC (control local), Nivel 2 = DCS (control proceso), Nivel 3 = SCADA (supervision), Nivel 4 = ERP."},
    {q:"En una boucle PID, la accion I (Integral) corrige:",opts:["Las oscilaciones rapidas","El error estatico persistente","Las perturbaciones externas","La velocidad de subida"],
      correct:1,expl:"La accion Integral acumula el error en el tiempo y lo elimina por completo. P solo deja siempre un error residual. Demasiada I provoca oscilaciones."},
    {q:"El estandar 4-20mA para senales analogicas PLC permite:",opts:["Ganar velocidad","Detectar roturas de cable (0mA = averia)","Aumentar la distancia","Reducir costes"],
      correct:1,expl:"Con 4-20mA: en funcionamiento normal, la corriente esta siempre entre 4 y 20mA. Si el cable se rompe, la senal cae a 0mA. Este 0mA no puede ser un valor fisico valido => deteccion automatica de averia."},
    {q:"El MV El Faro ilustra que las alertas PLC/SCADA ignoradas pueden:",opts:["Reducir el rendimiento","Provocar la perdida del buque y la tripulacion","Causar retrasos comerciales","Aumentar el consumo"],
      correct:1,expl:"El Faro (2015): alertas sistema repetidas (presion aceite, estabilidad) ignoradas => capitan mantiene rumbo huracan Joaquin => 33 muertos. El sistema SCADA/PLC habia detectado las anomalias."},
  ],
  pt:[
    {q:"PLC significa e e usado para:",opts:["Power Loop Controller — supervisao frota","Programmable Logic Controller — controlo local maquina","Process Level Control — gestao processo","Peripheral Logic Computer — rede embarcada"],
      correct:1,expl:"PLC = Programmable Logic Controller. Controlo local de uma maquina unica (motor, gerador, purificador) com tempo real duro inferior a 10ms. Diferente do DCS (multi-processo) e SCADA (supervisao)."},
    {q:"A piramide de automatizacao de baixo para cima e:",opts:["SCADA -> DCS -> PLC -> Sensores","Sensores -> PLC -> DCS -> SCADA","DCS -> PLC -> SCADA -> Sensores","PLC -> DCS -> Sensores -> SCADA"],
      correct:1,expl:"Piramide ISA-95: Nivel 0 = Sensores/atuadores, Nivel 1 = PLC (controlo local), Nivel 2 = DCS (controlo processo), Nivel 3 = SCADA (supervisao), Nivel 4 = ERP."},
    {q:"Numa boucle PID, a accao I (Integral) corrige:",opts:["As oscilacoes rapidas","O erro estatico persistente","As perturbacoes externas","A velocidade de subida"],
      correct:1,expl:"A accao Integral acumula o erro ao longo do tempo e elimina-o completamente. P sozinho deixa sempre um erro residual. Demasiada I provoca oscilacoes."},
    {q:"O padrao 4-20mA para sinais analogicos PLC permite:",opts:["Ganhar velocidade","Detectar roturas de cabo (0mA = avaria)","Aumentar a distancia","Reduzir custos"],
      correct:1,expl:"Com 4-20mA: em funcionamento normal, a corrente esta sempre entre 4 e 20mA. Se o cabo se rompe, o sinal cai a 0mA. Este 0mA nao pode ser um valor fisico valido => deteccao automatica de avaria."},
    {q:"O MV El Faro ilustra que os alertas PLC/SCADA ignorados podem:",opts:["Reduzir o desempenho","Provocar a perda do navio e da tripulacao","Causar atrasos comerciais","Aumentar o consumo"],
      correct:1,expl:"El Faro (2015): alertas sistema repetidos (pressao oleo, estabilidade) ignorados => capitao mantem rumo furacao Joaquin => 33 mortos. O sistema SCADA/PLC tinha detectado as anomalias."},
  ],
};
...
// MAIN EXPORT
// ══════════════════════════════════════
export default function LessonE7_L2({ lang="fr", onBack=()=>{}, onComplete=()=>{}, onNext=()=>{}, onQuizScored=(score:number,maxScore:number)=>{} }) {
  const t=T[lang]||T.fr;
