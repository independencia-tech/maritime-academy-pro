...
const T = {
  fr:{
    ...
    certifiedBadge:"MAP — powered by Independencia",
...
function Stars() {
  ...
  // (hydration) render, a guaranteed mismatch every time (not occasional,
  // unlike floating-point precision issues). Same fix pattern as
  // Dashboard.tsx's already-correct Stars: fixed empty initial render on
