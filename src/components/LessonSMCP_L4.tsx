...
function NavPhrasesSimSVG({ lang }) {
  ...
  const categories = {
    position:{ label:{fr:"Position & Route",en:"Position & Track",es:"Posición y Derrota",pt:"Posição e Rota"}, icon:"📍", color:C.nav, cards:[
      { q:"How do you report your present position?", a:"Our present position is Latitude [X] degrees [X] minutes North/South, Longitude [X] degrees [X] minutes East/West. Position obtained by [GPS/ECDIS/radar fix]. Last fix at [time] UTC.", fr:"Notre position actuelle est Latitude [X] degrés [X] minutes Nord/Sud, Longitude [X] degrés [X] minutes Est/Ouest. Position obtenue par [GPS/ECDIS/point radar]. Dernier point à [heure] UTC." },
      { q:"How do you report your track and ground speed?", a:"We are making good a track of [X] degrees [true/magnetic] at a speed over ground of [X] knots. Set and drift: current is setting [X] degrees, drifting [X] knots.", fr:"Nous faisons bonne route vers [X] degrés [vrai/magnétique] à une vitesse fond de [X] nœuds. Route forcée : le courant porte vers [X] degrés, dérive [X] nœuds." },
      { q:"How do you report a waypoint approach?", a:"We are approaching waypoint [name/number]. Distance to waypoint is [X] miles. ETA [time] UTC. Next waypoint is [name], course [X] degrees.", fr:"Nous approchons du point de passage [nom/numéro]. Distance au point de passage : [X] milles. ETA [heure] UTC. Point de passage suivant : [nom], cap [X] degrés." },
      { q:"How do you report a position by bearing and distance?", a:"Our position is [X] miles [bearing direction] of [landmark/buoy/light]. Bearing of [landmark] is [X] degrees [true/magnetic].", fr:"Notre position est à [X] milles [direction du relèvement] de [amer/bouée/feu]. Le relèvement de [amer] est de [X] degrés [vrai/magnétique]." },
    ]},
    collision:{ label:{fr:"Anti-abordage",en:"Collision avoidance",es:"Prevención abordajes",pt:"Prevenção abalroamentos"}, icon:"⚠️", color:C.red, cards:[
      { q:"How do you warn another vessel of collision risk?", a:"Warning! You are on a collision course. I recommend you alter course to [port/starboard] immediately. My course is [X] degrees, speed [X] knots. Over.", fr:"Attention ! Vous êtes sur une route de collision. Je vous recommande de virer immédiatement sur [bâbord/tribord]. Mon cap est [X] degrés, vitesse [X] nœuds. Terminé." },
      { q:"How do you report altering course to avoid collision?", a:"I am altering course to [starboard/port]. New course will be [X] degrees [true]. I am doing so to avoid collision with [vessel/danger]. Over.", fr:"Je vire sur [tribord/bâbord]. Le nouveau cap sera [X] degrés [vrai]. Je le fais pour éviter une collision avec [navire/danger]." },
      { q:"How do you agree on passing arrangement?", a:"I agree to pass [port to port / starboard to starboard]. I will maintain my course and speed. Please acknowledge. Over.", fr:"J'accepte de croiser [tribord sur tribord / bâbord sur bâbord]. Je maintiens mon cap et ma vitesse. Veuillez confirmer. Terminé." },
      { q:"How do you report a close-quarters situation?", a:"I am in a close-quarters situation with a vessel [bearing X degrees, range X miles]. Risk of collision exists. I am taking avoiding action to [port/starboard]. Over.", fr:"Je suis en situation de routes très rapprochées avec un navire [relèvement X degrés, distance X milles]. Risque de collision. Je prends des mesures d'évitement sur [bâbord/tribord]." },
    ]},
    restricted:{ label:{fr:"Visibilité réduite",en:"Restricted visibility",es:"Visibilidad reducida",pt:"Visibilidade reduzida"}, icon:"🌫️", color:C.weather, cards:[
      { q:"How do you report restricted visibility?", a:"Visibility is restricted. Current visibility is [X] miles/metres. I am proceeding at reduced speed of [X] knots. I am sounding fog signals in accordance with COLREG Rule 35.", fr:"Visibilité réduite. Visibilité actuelle [X] milles/mètres. Je navigue à vitesse réduite de [X] nœuds. J'émets les signaux de brouillard conformément à la Règle COLREG 35." },
      { q:"How do you report detecting a vessel in fog?", a:"I have a radar contact bearing [X] degrees, range [X] miles. CPA is [X] miles in [X] minutes. I am maintaining listening watch. I may reduce speed further.", fr:"J'ai un contact radar au relèvement [X] degrés, distance [X] milles. CPA est [X] milles dans [X] minutes. Je maintiens la veille sonore. Je pourrais réduire la vitesse davantage." },
      { q:"How do you report a fog signal heard ahead?", a:"I have heard a fog signal ahead. I am stopping my engines. I am proceeding with extreme caution. All vessels in the area please identify yourselves on channel 16.", fr:"J'ai entendu un signal de brouillard devant moi. J'arrête mes machines. Je navigue avec une extrême prudence. Tous les navires dans la zone, veuillez vous identifier sur le canal 16." },
      { q:"How do you report lifting fog?", a:"Visibility is improving. Visibility is now [X] miles. I am increasing speed to [X] knots. Fog signals are discontinued.", fr:"La visibilité s'améliore. Visibilité actuelle [X] milles. J'augmente la vitesse à [X] nœuds. Les signaux de brouillard sont arrêtés." },
    ]},
    tss:{ label:{fr:"DST & Chenaux",en:"TSS & Channels",es:"SDT y Canales",pt:"SDT e Canais"}, icon:"🗺️", color:C.maneuver, cards:[
      { q:"How do you report entering a Traffic Separation Scheme (TSS)?", a:"I am entering the [name] Traffic Separation Scheme. I am in the [northbound/southbound/inbound/outbound] lane. My course is [X] degrees. Speed [X] knots.", fr:"J'entre dans le Dispositif de Séparation du Trafic [nom]. Je suis dans la voie [nord/sud/entrée/sortie]. Mon cap est [X] degrés. Vitesse [X] nœuds." },
      { q:"How do you report crossing a TSS?", a:"I am crossing the [name] Traffic Separation Scheme at right angles. My course is [X] degrees. I am maintaining a listening watch on channel 16.", fr:"Je traverse le DST [nom] à angle droit. Mon cap est [X] degrés. Je maintiens la veille sur le canal 16." },
      { q:"How do you report a vessel going the wrong way in a TSS?", a:"[VTS/All stations]. I have sighted a vessel proceeding in the wrong direction in the [name] Traffic Separation Scheme. The vessel is on a [southbound/northbound] heading in the [northbound/southbound] lane.", fr:"[VTS/Toutes stations]. J'ai repéré un navire faisant route dans le mauvais sens dans le DST [nom]. Le navire est sur un cap [sud/nord] dans la voie [nord/sud]." },
      { q:"How do you report vessel speed in a restricted channel?", a:"I am reducing speed to [X] knots as required by port regulations. I am in [name] channel at position [X].", fr:"Je réduis la vitesse à [X] nœuds comme requis par les règlements portuaires. Je suis dans le chenal [nom] en position [X]." },
    ]},
  };
...
export default function LessonSMCP_L4({ lang="en", onBack=()=>{}, onComplete=()=>{} }) {
        ...
        <div style={{maxWidth:480,margin:"0 auto"}}>
          {phase==="content"&&<>
            ...
            <Card style={{marginBottom:14,background:"rgba(0,8,18,0.7)",border:`1px solid ${C.nav}22`}}>
              <div style={{fontSize:11,color:C.nav,letterSpacing:2,fontFamily:"'Cinzel',serif",marginBottom:10}}>📍 {lang==="fr"?"FICHES NAVIGATION SMCP":lang==="en"?"SMCP NAVIGATION FLASHCARDS":"FICHAS NAVEGACIÓN SMCP"}</div>
            ...
            <Card style={{marginBottom:14,border:`1px solid ${C.weather}22`}}>
              <div style={{fontSize:11,color:C.weather,letterSpacing:2,fontFamily:"'Cinzel',serif",marginBottom:10}}>🌦️ {lang==="fr"?"RAPPORT MÉTÉO SMCP":lang==="en"?"SMCP WEATHER REPORTING":"INFORME METEOROLÓGICO SMCP"}</div>
            ...
            <Card style={{marginBottom:14,border:`1px solid ${C.maneuver}22`}}>
              <div style={{fontSize:11,color:C.maneuver,letterSpacing:2,fontFamily:"'Cinzel',serif",marginBottom:10}}>⚙️ {lang==="fr"?"ORDRES DE MANŒUVRE SMCP":lang==="en"?"SMCP MANEUVERING ORDERS":"ÓRDENES DE MANIOBRA SMCP"}</div>
            ...
            <Card style={{marginBottom:14,border:`1px solid ${C.gold}33`}}>
              <div style={{fontSize:11,color:C.gold2,letterSpacing:2,fontFamily:"'Cinzel',serif",marginBottom:10}}>🎯 {lang==="fr"?"QUIZ NAVIGATION":lang==="en"?"NAVIGATION QUIZ":"QUIZ NAVEGACIÓN"}</div>
            ...
            <button onClick={()=>setPhase("quiz")} style={{width:"100%",padding:"17px 0",border:"none",borderRadius:16,background:`linear-gradient(135deg,${C.nav},${C.maneuver},${C.gold})`,fontFamily:"'Cinzel',serif",fontSize:15,fontWeight:700,letterSpacing:2,color:C.navy,cursor:"pointer",boxShadow:`0 10px 36px ${C.nav}33`,marginTop:8}}>{t.startQuiz}</button>
          ...
          {phase==="done"&&<div style={{paddingTop:10}}>
            ...
            <button onClick={onComplete} style={{width:"100%",padding:"16px 0",border:"none",borderRadius:16,background:`linear-gradient(135deg,${C.nav},${C.gold})`,fontFamily:"'Cinzel',serif",fontSize:14,fontWeight:700,letterSpacing:2,color:C.navy,cursor:"pointer",boxShadow:`0 8px 28px ${C.nav}33`,marginBottom:10}}>
