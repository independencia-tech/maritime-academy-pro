...
function Exercise1({ lang, t }) {
  ...
  const correct = {q1:"36",q2:"040",q3:"3",q4:"126"};
  const qs = {
    fr:[
      ...
      {id:"q4",q:"Relèvement Compas (Rc) = 128° · δ=+1°E · d=-3°W\nQuel est le Relèvement Vrai (Rv) ?"},
    ],
    en:[
      ...
      {id:"q4",q:"Compass Bearing (CB) = 128° · δ=+1°E · d=-3°W\nWhat is the True Bearing (TB)?"},
    ],
    es:[
      ...
      {id:"q4",q:"Marcación de Compás (Mc) = 128° · δ=+1°E · d=-3°O\n¿Cuál es la Marcación Verdadera (Mv)?"},
    ],
    pt:[
      ...
      {id:"q4",q:"Marcação de Bússola (Mb) = 128° · δ=+1°E · d=-3°O\nQual é a Marcação Verdadeira (Mv)?"},
    ],
  };
  ...
  return (
    <div>
      ...
      {showC&&<div style={{padding:"12px",borderRadius:12,background:"rgba(30,138,74,0.1)",border:`1px solid ${C.green}44`,fontSize:11,color:C.white,lineHeight:1.6,marginBottom:10}}>
        {lang==="fr"?"✅ Q1: D=12×3=36mn · Q2: CM=040-2=038° → CC=038+1=039° ≈ 040° · Q3: 3'-0'=3' → 3 milles nautiques · Q4: Rv=128+1-3=126°":
         lang==="en"?"✅ Q1: D=12×3=36nm · Q2: MC=040-2=038° → CC=038+1=039° ≈ 040° · Q3: 3'-0'=3' → 3 nautical miles · Q4: TB=128+1-3=126°":
         lang==="es"?"✅ Q1: D=12×3=36mn · Q2: RM=040-2=038° → RC=038+1=039° ≈ 040° · Q3: 3 millas náuticas · Q4: Mv=128+1-3=126°":
         "✅ Q1: D=12×3=36mn · Q2: RM=040-2=038° → RB=038+1=039° ≈ 040° · Q3: 3 milhas náuticas · Q4: Mv=128+1-3=126°"}
      </div>}
...
export const QUIZ = {
  fr:[
    ...
    {q:"Rc=200° · δ=-2°W · d=+5°E — Quel est le Rv ?",opts:["197°","203°","201°","205°"],correct:1,expl:"Rv = Rc + δ + d = 200 - 2 + 5 = 203°. Même formule que pour les caps (CV=CC+δ+d), appliquée ici au relèvement."},
  ],
  en:[
    ...
    {q:"CB=200° · δ=-2°W · d=+5°E — What is the TB?",opts:["197°","203°","201°","205°"],correct:1,expl:"TB = CB + δ + d = 200 - 2 + 5 = 203°. Same formula as for courses (TC=CC+δ+d), applied here to the bearing."},
  ],
  es:[
    ...
    {q:"Mc=200° · δ=-2°O · d=+5°E — ¿Cuál es la Mv?",opts:["197°","203°","201°","205°"],correct:1,expl:"Mv = Mc + δ + d = 200 - 2 + 5 = 203°. Misma fórmula que para los rumbos (RV=RC+δ+d), aplicada aquí a la marcación."},
  ],
  pt:[
    ...
    {q:"Mb=200° · δ=-2°O · d=+5°E — Qual é a Mv?",opts:["197°","203°","201°","205°"],correct:1,expl:"Mv = Mb + δ + d = 200 - 2 + 5 = 203°. Mesma fórmula dos rumos (RV=RB+δ+d), aplicada aqui à marcação."},
  ],
};
...
export const BANK = {
  ...
  {q:"Quelle est la différence entre un relèvement vrai, un relèvement compas et un relèvement relatif ?",opts:["Il n'y a aucune différence, ce sont des synonymes","Le relèvement vrai est référencé au Nord Vrai, le relèvement compas est la lecture directe du compas (affectée par δ et d), le relèvement relatif est mesuré depuis l'étrave du navire","Le relèvement relatif est utilisé uniquement pour la météo","Le relèvement compas ne s'applique qu'aux navires militaires"],correct:1,expl:"Ces trois relèvements se distinguent par leur référence : Nord Vrai (vrai), compas de bord affecté par les erreurs δ+d (compas), ou étrave du navire sans référence au nord (relatif)."},
  {q:"Le navire suit un Cap Vrai de 090°. Le relèvement relatif (Rr) d'un phare est de 045° (par tribord avant). Quel est le relèvement vrai (Rv) du phare ?",opts:["045°","090°","135°","180°"],correct:2,expl:"Rv = Cap Vrai du navire + Rr = 090 + 045 = 135°. Le relèvement relatif s'ajoute simplement au cap vrai suivi par le navire."},
  ],
  en:[
  ...
  {q:"What is the difference between a true bearing, a compass bearing, and a relative bearing?",opts:["There is no difference, they are synonyms","True bearing is referenced to True North, compass bearing is the direct compass reading (affected by δ and d), relative bearing is measured from the vessel's bow","Relative bearing is only used for weather reporting","Compass bearing only applies to military vessels"],correct:1,expl:"These three bearings differ by their reference: True North (true), the vessel's own compass affected by δ+d errors (compass), or the vessel's bow with no reference to north (relative)."},
  {q:"The vessel is on a True Course of 090°. The relative bearing (RB) of a lighthouse is 045° (on the starboard bow). What is the true bearing (TB) of the lighthouse?",opts:["045°","090°","135°","180°"],correct:2,expl:"TB = Vessel's True Course + RB = 090 + 045 = 135°. The relative bearing is simply added to the vessel's true course."},
  ],
  es:[
  ...
  {q:"¿Cuál es la diferencia entre una marcación verdadera, una marcación de compás y una marcación relativa?",opts:["No hay ninguna diferencia, son sinónimos","La marcación verdadera se refiere al Norte Verdadero, la marcación de compás es la lectura directa del compás (afectada por δ y d), la marcación relativa se mide desde la proa del buque","La marcación relativa solo se usa para el parte meteorológico","La marcación de compás solo se aplica a buques militares"],correct:1,expl:"Estas tres marcaciones se distinguen por su referencia: Norte Verdadero (verdadera), el propio compás del buque afectado por errores δ+d (compás), o la proa del buque sin referencia al norte (relativa)."},
  {q:"El buque sigue un Rumbo Verdadero de 090°. La marcación relativa (Mr) de un faro es de 045° (por la amura de estribor). ¿Cuál es la marcación verdadera (Mv) del faro?",opts:["045°","090°","135°","180°"],correct:2,expl:"Mv = Rumbo Verdadero del buque + Mr = 090 + 045 = 135°. La marcación relativa simplemente se suma al rumbo verdadero seguido por el buque."},
  ],
  pt:[
  ...
  {q:"Qual é a diferença entre uma marcação verdadeira, uma marcação de bússola e uma marcação relativa?",opts:["Não há diferença nenhuma, são sinónimos","A marcação verdadeira refere-se ao Norte Verdadeiro, a marcação de bússola é a leitura direta da bússola (afetada por δ e d), a marcação relativa é medida a partir da proa do navio","A marcação relativa só é usada para o boletim meteorológico","A marcação de bússola só se aplica a navios militares"],correct:1,expl:"Estas três marcações distinguem-se pela sua referência: Norte Verdadeiro (verdadeira), a bússola do navio afetada por erros δ+d (bússola), ou a proa do navio sem referência ao norte (relativa)."},
  {q:"O navio segue um Rumo Verdadeiro de 090°. A marcação relativa (Mr) de um farol é de 045° (pela alheta de estibordo). Qual é a marcação verdadeira (Mv) do farol?",opts:["045°","090°","135°","180°"],correct:2,expl:"Mv = Rumo Verdadeiro do navio + Mr = 090 + 045 = 135°. A marcação relativa soma-se simplesmente ao rumo verdadeiro seguido pelo navio."},
  ],
};
...
const getContent = lang => {
  const d = {
    fr:{
      ...
      p7:"📝 BANQUE DE QUESTIONS — 17 QUESTIONS PREMIUM",
      sumT:"RÉSUMÉ — LEÇON 6",
      sumP:["D=V×T · estime = cap + vitesse + temps depuis position connue","Point par 2 relèvements = intersection de 2 droites de position","Triangle d'erreur = 3 relèvements · position au centre","Relèvement vrai/compas/relatif : Rv=Rc+δ+d ou Rv=Cap Vrai+Rr","Sextant = angle astre/horizon · méthode Marcq-St-Hilaire","Crépuscule nautique = moment idéal pour observations sextant","COLREG Rule 5 = veille permanente 24h/24 tous les moyens","RADAR · AIS · ECDIS · VHF · GPS = équipements obligatoires","Costa Concordia = dévier route approuvée = infraction grave"],
    ...
    en:{
      ...
      s2:"BEARING = horizontal angle between north and direction to a landmark\n\nFIX BY 2 BEARINGS:\n• Bearing 1 on landmark A → line drawn\n• Bearing 2 on landmark B → line drawn\n• Intersection = VESSEL POSITION\n\nFIX BY 3 BEARINGS:\n• 3 lines drawn → form a triangle\n• TRIANGLE OF ERROR = 3 lines don't meet at same point\n• Position = center of triangle\n\nBEST ACCURACY: angle between lines close to 90°\n\nTHE 3 TYPES OF BEARING:\n• True Bearing (TB) — referenced to True North, the one used on the chart\n• Compass Bearing (CB) — direct reading from the vessel's compass, affected by δ (deviation) AND d (declination)\n• Relative Bearing (RB) — measured from the vessel's bow (000° to 360°), no reference to north\n\nCONVERSION CB → TB (same formula as for courses, lesson 5):\nTB = CB + δ + d\nEast = Add (+) · West = Subtract (-)\n\nCONVERSION RB → TB:\nTB = Vessel's True Course + RB\n(the relative bearing is simply added to the vessel's true course)",
      ...
      p5:"🎯 ADVANCED PREMIUM EXERCISES",p6:"⚠️ REAL MARITIME ACCIDENT CASE",p7:"📝 QUESTION BANK — 17 PREMIUM QUESTIONS",
      sumT:"SUMMARY — LESSON 6",
      sumP:["D=V×T · DR = course + speed + time from known position","Fix by 2 bearings = intersection of 2 position lines","Triangle of error = 3 bearings · position at center","True/compass/relative bearing: TB=CB+δ+d or TB=True Course+RB","Sextant = body/horizon angle · Marcq-St-Hilaire method","Nautical twilight = ideal time for sextant observations","COLREG Rule 5 = permanent watch 24/7 all means","RADAR · AIS · ECDIS · VHF · GPS = mandatory equipment","Costa Concordia = deviating from approved route = serious offence"],
    ...
    es:{
      ...
      s2:"MARCACIÓN = ángulo horizontal entre el norte y la dirección hacia un amer\n\nPUNTO POR 2 MARCACIONES:\n• Marcación 1 sobre amer A → línea trazada\n• Marcación 2 sobre amer B → línea trazada\n• Intersección = POSICIÓN DEL BUQUE\n\nTRIÁNGULO DE ERROR (3 marcaciones):\n• Posición = centro del triángulo\n\nMEJOR PRECISIÓN: ángulo entre líneas próximo a 90°\n\nLOS 3 TIPOS DE MARCACIÓN:\n• Marcación Verdadera (Mv) — referida al Norte Verdadero, la que se usa en la carta\n• Marcación de Compás (Mc) — lectura directa del compás del buque, afectada por δ (desvío) Y d (declinación)\n• Marcación Relativa (Mr) — medida desde la proa del buque (000° a 360°), sin referencia al norte\n\nCONVERSIÓN Mc → Mv (misma fórmula que para los rumbos, lección 5):\nMv = Mc + δ + d\nEste = Sumar (+) · Oeste = Restar (-)\n\nCONVERSIÓN Mr → Mv:\nMv = Rumbo Verdadero del buque + Mr\n(la marcación relativa se suma simplemente al rumbo verdadero seguido por el buque)",
      ...
      p5:"🎯 EJERCICIOS AVANZADOS PREMIUM",p6:"⚠️ CASO REAL DE ACCIDENTE MARÍTIMO",p7:"📝 BANCO DE PREGUNTAS — 17 PREGUNTAS PREMIUM",
      sumT:"RESUMEN — LECCIÓN 6",
      sumP:["D=V×T · Estima = rumbo + velocidad + tiempo","Punto = 2 marcaciones · triángulo de error = 3","Marcación verdadera/compás/relativa: Mv=Mc+δ+d o Mv=Rumbo Verdadero+Mr","Sextante = ángulo astro/horizonte · Marcq-St-Hilaire","Crepúsculo náutico = momento ideal observaciones","COLREG Regla 5 = guardia permanente 24/7","RADAR · AIS · ECDIS · VHF · GPS obligatorios","Costa Concordia = nunca desviarse de la ruta aprobada"],
    ...
    pt:{
      ...
      s2:"MARCAÇÃO = ângulo horizontal entre o norte e a direção para um amer\n\nPOSIÇÃO POR 2 MARCAÇÕES:\n• Marcação 1 sobre amer A → linha traçada\n• Marcação 2 sobre amer B → linha traçada\n• Interseção = POSIÇÃO DO NAVIO\n\nTRIÂNGULO DE ERRO (3 marcações):\n• Posição = centro do triângulo\n\nMELHOR PRECISÃO: ângulo entre linhas próximo de 90°\n\nOS 3 TIPOS DE MARCAÇÃO:\n• Marcação Verdadeira (Mv) — referida ao Norte Verdadeiro, a usada na carta\n• Marcação de Bússola (Mb) — leitura direta da bússola do navio, afetada por δ (desvio) E d (declinação)\n• Marcação Relativa (Mr) — medida a partir da proa do navio (000° a 360°), sem referência ao norte\n\nCONVERSÃO Mb → Mv (mesma fórmula dos rumos, lição 5):\nMv = Mb + δ + d\nEste = Somar (+) · Oeste = Subtrair (-)\n\nCONVERSÃO Mr → Mv:\nMv = Rumo Verdadeiro do navio + Mr\n(a marcação relativa soma-se simplesmente ao rumo verdadeiro seguido pelo navio)",
      ...
      p5:"🎯 EXERCÍCIOS AVANÇADOS PREMIUM",p6:"⚠️ CASO REAL DE ACIDENTE MARÍTIMO",p7:"📝 BANCO DE QUESTÕES — 17 QUESTÕES PREMIUM",
      sumT:"RESUMO — LIÇÃO 6",
      sumP:["D=V×T · Estima = rumo + velocidade + tempo","Posição = 2 marcações · triângulo erro = 3","Marcação verdadeira/bússola/relativa: Mv=Mb+δ+d ou Mv=Rumo Verdadeiro+Mr","Sextante = ângulo astro/horizonte · Marcq-St-Hilaire","Crepúsculo náutico = momento ideal observações","COLREG Regra 5 = vigia permanente 24/7","RADAR · AIS · ECDIS · VHF · GPS obrigatórios","Costa Concordia = nunca desviar da rota aprovada"],
      learnedP:["D=V×T · Estima","Posição 2 marcações · triângulo erro","Mv/Mb/Mr: Mv=Mb+δ+d ou Mv=Rumo Verdadeiro+Mr","Sextante · Marcq-St-Hilaire · crepúsculo","COLREG Regra 5 · RADAR · AIS · ECDIS","Costa Concordia = não desviar"],
    },
  };
  return d[lang]||d.fr;
};
        ...
        <div style={{maxWidth:480,margin:"0 auto"}}>
          ...
          {phase==="quiz"&&<>
            <div style={{textAlign:"center",marginBottom:20}}>
              ...
              <div style={{fontSize:12,color:C.muted}}>6 {lang==="fr"?"questions · Leçon 6":lang==="en"?"questions · Lesson 6":lang==="es"?"preguntas · Lección 6":"perguntas · Lição 6"}</div>
            </div>
          ...
          {phase==="done"&&<div style={{paddingTop:10}}>
            <div style={{textAlign:"center",marginBottom:20}}>
              ...
              <div style={{display:"inline-flex",alignItems:"center",gap:8,padding:"8px 20px",borderRadius:20,background:"rgba(201,146,42,0.15)",border:`1px solid ${C.gold}55`,fontSize:14,color:C.gold2,fontWeight:700}}>+{(quizScore/quiz.length*100)>=80?200:(quizScore/quiz.length*100)>=60?120:60} {t.xp} ⭐</div>
            </div>
