...
// ══════════════════════════════════════
  export const BANK = {
    fr:[
      {q:"Que signifie l'acronyme COW ?",opts:["Crude Oil Washing","Cargo Oil Winch","Crude On Water","Cargo Operations Workflow"],correct:0,expl:"COW = Crude Oil Washing (lavage au petrole brut). Le systeme utilise le brut chaud charge comme solvant pour dissoudre et eliminer les residus paraffines colles aux parois des citernes."},
      {q:"Quel fluide est utilise comme solvant dans le systeme COW ?",opts:["Eau de mer chauffee","Eau douce sous pression","Le brut chaud lui-meme","Solvant chimique special"],correct:2,expl:"Le COW utilise le brut cargo lui-meme comme solvant. Les buses projettent le brut chaud (50-60°C) sur les parois. Le brut chaud dissout les residus de paraffines et wax qui restent colles lors du deballastage normal."},
      {q:"Quelle est la pression nominale de fonctionnement des buses COW ?",opts:["2 a 4 bar","8 a 12 bar","20 a 30 bar","50 a 60 bar"],correct:1,expl:"La pression nominale COW est de 8 a 12 bar (typiquement 9-10 bar). Sous 8 bar, le jet n'est pas assez puissant pour decoller les residus. Au-dessus de 12 bar, risque de deterioration des buses et de la structure."},
      {q:"A quelle temperature le brut doit-il etre chauffe pour le COW ?",opts:["20 a 30°C","35 a 45°C","50 a 65°C","75 a 90°C"],correct:2,expl:"Le brut doit etre chauffe a 50-65°C pour le COW. A cette temperature, la viscosite du brut diminue fortement, permettant aux jets de penetrer et dissoudre efficacement les residus paraffines (wax) qui fondent entre 40 et 60°C selon la provenance."},
      {q:"Sur quels navires le COW est-il obligatoire selon MARPOL Annexe I ?",opts:["Tous les petroliers","Petroliers > 5 000 tdw","VLCC > 20 000 tdw","Petroliers > 100 000 tdw"],correct:2,expl:"MARPOL Annexe I Regulation 33 : COW obligatoire sur tous les VLCC (Very Large Crude Carriers) de plus de 20 000 tdw construits apres 1980. Sur les petits petroliers, le COW est recommande mais pas obligatoire."},
      {q:"Ou sont envoyes les residus COW apres lavage des citernes ?",opts:["Rejetes en mer directement","Vers la citerne slop","Vers les citernes de ballast","Vers le double fond"],correct:1,expl:"Les residus COW (brut + paraffines dissoutes) sont pompes vers la citerne slop, specifiquement dediee a cet usage. Le slop est ensuite traite a terre ou decante avant rejet conforme MARPOL (moins de 15 ppm en mer)."},
      {q:"Quelle est la reduction de residus en citerne apres COW par rapport a un dechargement normal ?",opts:["20 a 30%","40 a 50%","60 a 70%","90 a 95%"],correct:2,expl:"Le COW reduit les residus en citerne de 60 a 70% par rapport a un simple dechargement standard. Sans COW, un VLCC peut laisser 800 a 1500 tonnes de boues. Avec COW, ce chiffre tombe a 250-450 tonnes, soit une reduction majeure de la pollution potentielle."},
      {q:"Quelle est la duree typique d'un lavage COW complet d'une citerne ?",opts:["30 a 60 minutes","2 a 4 heures","8 a 12 heures","24 heures"],correct:1,expl:"Un lavage COW complet d'une citerne dure typiquement 2 a 4 heures. La buse tourne lentement (1-4 tr/min) pour couvrir toutes les surfaces. Les grandes citernes de VLCC (50 000 m3) peuvent necessiter jusqu'a 6 heures."},
      {q:"Qu'est-ce que le 'slop tank' dans le contexte du COW ?",opts:["Citerne de combustible residuel","Citerne de reception des residus de lavage","Citerne de ballast de secours","Citerne de decantation de brut"],correct:1,expl:"Le slop tank est une citerne dediee a la reception et au stockage temporaire des residus de lavage COW (melange brut + eau + paraffines). Il permet la decantation avant transfert a terre ou rejet controle. Obligatoire sur tous les petroliers MARPOL."},
      {q:"Quelle convention internationale a rendu le COW obligatoire ?",opts:["SOLAS 1974","MARPOL 73/78","BWM 2004","ISM Code 1994"],correct:1,expl:"MARPOL 73/78 (Convention internationale pour la prevention de la pollution par les navires) Annexe I Regulation 33 a rendu le COW obligatoire sur les VLCC > 20 000 tdw. Adoptee en 1973, modifiee en 1978 apres les grandes marees noires des annees 70."},
      {q:"Pendant le COW, l'IGS (gaz inerte) doit etre maintenu parce que :",opts:["Les jets COW creent de l'electricite statique","Le brut chaud projete libere des vapeurs inflammables","La temperature eleve le point d'eclair","Les buses chauffent les gaz"],correct:1,expl:"Le brut chaud projete par les buses COW libere d'importantes quantites de vapeurs d'hydrocarbures. Sans IGS maintenant O2 < 8% dans la citerne, ces vapeurs en presence d'air formeraient un melange explosif. IGS et COW sont indissociables en securite."},
      {q:"L'Amoco Cadiz (1978) a demontre que sans COW adequat :",opts:["Le dechargement est plus lent","Les residus de paraffines persistent et aggravent les deversements","La stabilite du navire diminue","Les pompes s'usent plus vite"],correct:1,expl:"L'Amoco Cadiz a deverle 230 000 t de brut avec d'importants residus paraffines dans les citernes. L'enquete a montre que sans COW operationnel, les paraffines collees aux parois restent dans le navire et sont liberees en cas d'avarie, aggravant considerablement la pollution."},
      {q:"Quel est le seuil de residus maximum autorise par MARPOL apres COW ?",opts:["0,1% du volume de la citerne","0,4% du volume de la citerne","1% du volume de la citerne","2% du volume de la citerne"],correct:1,expl:"MARPOL Annexe I fixe le seuil maximum a 0,4% du volume total de la citerne apres COW. Pour une citerne de 10 000 m3, cela represente 40 m3 de residus maximum. En dessous de ce seuil, la citerne est considered propre pour MARPOL."},
      {q:"Quelle est la vitesse de rotation typique des buses COW ?",opts:["10 a 20 tr/min","30 a 60 tr/min","1 a 4 tr/min","0,1 a 0,5 tr/min"],correct:2,expl:"Les buses COW tournent lentement : 1 a 4 tours par minute. Cette vitesse lente est necessaire pour permettre aux jets de projeter suffisamment longtemps sur chaque zone de la paroi et dissoudre efficacement les residus. Une rotation trop rapide reduirait l'efficacite du lavage."},
      {q:"La citerne de slop doit etre traitee avant tout rejet en mer. Le seuil MARPOL est de :",opts:["100 ppm d'hydrocarbures","15 ppm d'hydrocarbures","5 ppm d'hydrocarbures","0 ppm (rejet interdit)"],correct:1,expl:"MARPOL Annexe I : rejet en mer autorise uniquement si la teneur en hydrocarbures est inferieure a 15 ppm (parties par million). Au-dela, le slop doit etre traite a terre ou reste a bord. Le Oil Record Book doit enregistrer toutes ces operations."},
    ],
    en:[
      {q:"What does the acronym COW stand for?",opts:["Crude Oil Washing","Cargo Oil Winch","Crude On Water","Cargo Operations Workflow"],correct:0,expl:"COW = Crude Oil Washing. The system uses the hot loaded crude itself as a solvent to dissolve and remove paraffin residues stuck to the tank walls."},
      {q:"What fluid is used as solvent in the COW system?",opts:["Heated seawater","Pressurized fresh water","The hot crude itself","Special chemical solvent"],correct:2,expl:"COW uses the cargo crude itself as solvent. Nozzles spray hot crude (50-60°C) on the walls. Hot crude dissolves paraffin and wax residues that stick to tanks during normal discharge."},
      {q:"What is the nominal operating pressure of COW nozzles?",opts:["2 to 4 bar","8 to 12 bar","20 to 30 bar","50 to 60 bar"],correct:1,expl:"Nominal COW pressure is 8 to 12 bar (typically 9-10 bar). Below 8 bar, the jet is not powerful enough to remove residues. Above 12 bar, risk of nozzle and structural damage."},
      {q:"At what temperature must crude be heated for COW?",opts:["20 to 30°C","35 to 45°C","50 to 65°C","75 to 90°C"],correct:2,expl:"Crude must be heated to 50-65°C for COW. At this temperature, crude viscosity drops significantly, allowing jets to penetrate and effectively dissolve paraffin (wax) residues that melt between 40-60°C depending on origin."},
      {q:"On which vessels is COW mandatory under MARPOL Annex I?",opts:["All tankers","Tankers > 5,000 DWT","VLCCs > 20,000 DWT","Tankers > 100,000 DWT"],correct:2,expl:"MARPOL Annex I Regulation 33: COW mandatory on all VLCCs (Very Large Crude Carriers) over 20,000 DWT built after 1980. On smaller tankers, COW is recommended but not mandatory."},
      {q:"Where are COW residues sent after tank washing?",opts:["Directly discharged to sea","To the slop tank","To ballast tanks","To the double bottom"],correct:1,expl:"COW residues (crude + dissolved paraffins) are pumped to the slop tank, specifically dedicated to this purpose. The slop is then processed ashore or decanted before MARPOL-compliant discharge (less than 15 ppm at sea)."},
      {q:"What is the residue reduction after COW compared to normal discharge?",opts:["20 to 30%","40 to 50%","60 to 70%","90 to 95%"],correct:2,expl:"COW reduces tank residues by 60-70% compared to standard discharge. Without COW, a VLCC can leave 800-1500 tonnes of sludge. With COW, this drops to 250-450 tonnes - a major reduction in potential pollution."},
      {q:"What is the typical duration of a complete COW wash of one tank?",opts:["30 to 60 minutes","2 to 4 hours","8 to 12 hours","24 hours"],correct:1,expl:"A complete COW wash of one tank typically takes 2 to 4 hours. The nozzle rotates slowly (1-4 rpm) to cover all surfaces. Large VLCC tanks (50,000 m3) may require up to 6 hours."},
      {q:"What is the slop tank in the COW context?",opts:["Residual fuel tank","Washing residue reception tank","Emergency ballast tank","Crude decantation tank"],correct:1,expl:"The slop tank is a dedicated tank for receiving and temporarily storing COW washing residues (crude + water + paraffins mix). It allows decantation before shore transfer or controlled discharge. Mandatory on all MARPOL tankers."},
      {q:"Which international convention made COW mandatory?",opts:["SOLAS 1974","MARPOL 73/78","BWM 2004","ISM Code 1994"],correct:1,expl:"MARPOL 73/78 Annex I Regulation 33 made COW mandatory on VLCCs > 20,000 DWT. Adopted in 1973, amended in 1978 following the major oil spills of the 1970s."},
      {q:"During COW, IGS must be maintained because:",opts:["COW jets create static electricity","Hot sprayed crude releases flammable vapors","Temperature raises the flash point","Nozzles heat the gases"],correct:1,expl:"Hot crude sprayed by COW nozzles releases large quantities of hydrocarbon vapors. Without IGS maintaining O2 < 8% in the tank, these vapors mixed with air would form an explosive mixture. IGS and COW are inseparable for safety."},
      {q:"The Amoco Cadiz (1978) demonstrated that without adequate COW:",opts:["Discharge is slower","Paraffin residues persist and worsen spills","Vessel stability decreases","Pumps wear out faster"],correct:1,expl:"Amoco Cadiz spilled 230,000 t of crude with significant paraffin residues in tanks. The inquiry showed that without operational COW, paraffins stuck to walls remain in the vessel and are released in case of accident, greatly worsening pollution."},
      {q:"What is the maximum residue threshold allowed by MARPOL after COW?",opts:["0.1% of tank volume","0.4% of tank volume","1% of tank volume","2% of tank volume"],correct:1,expl:"MARPOL Annex I sets the maximum threshold at 0.4% of total tank volume after COW. For a 10,000 m3 tank, this represents 40 m3 of maximum residues. Below this threshold, the tank is considered clean for MARPOL."},
      {q:"What is the typical rotation speed of COW nozzles?",opts:["10 to 20 rpm","30 to 60 rpm","1 to 4 rpm","0.1 to 0.5 rpm"],correct:2,expl:"COW nozzles rotate slowly: 1 to 4 revolutions per minute. This slow speed is necessary to allow jets to spray sufficiently long on each area of the wall and effectively dissolve residues. Too fast rotation would reduce washing efficiency."},
      {q:"The slop tank must be treated before any sea discharge. The MARPOL threshold is:",opts:["100 ppm hydrocarbons","15 ppm hydrocarbons","5 ppm hydrocarbons","0 ppm (discharge prohibited)"],correct:1,expl:"MARPOL Annex I: sea discharge only permitted if hydrocarbon content is below 15 ppm. Above this, slop must be processed ashore or kept on board. The Oil Record Book must record all these operations."},
    ],
    es:[
      {q:"?Que significa el acronimo COW?",opts:["Crude Oil Washing","Cargo Oil Winch","Crude On Water","Cargo Operations Workflow"],correct:0,expl:"COW = Crude Oil Washing (lavado con petroleo crudo). El sistema usa el propio crudo caliente como solvente para disolver y eliminar los residuos de parafinas adheridos a las paredes de los tanques."},
      {q:"?Que fluido se usa como solvente en el sistema COW?",opts:["Agua de mar calentada","Agua dulce a presion","El propio crudo caliente","Solvente quimico especial"],correct:2,expl:"El COW usa el propio crudo de carga como solvente. Las boquillas proyectan crudo caliente (50-60°C) sobre las paredes. El crudo caliente disuelve los residuos de parafinas y ceras que quedan adheridos en la descarga normal."},
      {q:"?Cual es la presion nominal de funcionamiento de las boquillas COW?",opts:["2 a 4 bar","8 a 12 bar","20 a 30 bar","50 a 60 bar"],correct:1,expl:"La presion nominal COW es de 8 a 12 bar (tipicamente 9-10 bar). Por debajo de 8 bar, el chorro no es suficientemente potente. Por encima de 12 bar, riesgo de deterioro de las boquillas y la estructura."},
      {q:"?A que temperatura debe calentarse el crudo para el COW?",opts:["20 a 30°C","35 a 45°C","50 a 65°C","75 a 90°C"],correct:2,expl:"El crudo debe calentarse a 50-65°C para el COW. A esta temperatura, la viscosidad del crudo disminuye notablemente, permitiendo que los chorros penetren y disuelvan eficazmente los residuos de parafinas."},
      {q:"?En que buques es obligatorio el COW segun MARPOL Anexo I?",opts:["Todos los petroleros","Petroleros > 5.000 TPM","VLCC > 20.000 TPM","Petroleros > 100.000 TPM"],correct:2,expl:"MARPOL Anexo I Regulacion 33: COW obligatorio en todos los VLCC de mas de 20.000 TPM construidos despues de 1980."},
      {q:"?Adonde se envian los residuos COW tras el lavado?",opts:["Vertidos directamente al mar","Al tanque slop","A los tanques de lastre","Al doble fondo"],correct:1,expl:"Los residuos COW se bombean al tanque slop, especificamente dedicado a este uso. El slop se trata en tierra o se decanta antes del vertido conforme MARPOL (menos de 15 ppm en el mar)."},
      {q:"?Cual es la reduccion de residuos tras COW respecto a una descarga normal?",opts:["20 a 30%","40 a 50%","60 a 70%","90 a 95%"],correct:2,expl:"El COW reduce los residuos en tanque un 60-70% respecto a la descarga normal. Sin COW, un VLCC puede dejar 800-1500 toneladas de lodos. Con COW, baja a 250-450 toneladas."},
      {q:"?Cual es la duracion tipica de un lavado COW completo de un tanque?",opts:["30 a 60 minutos","2 a 4 horas","8 a 12 horas","24 horas"],correct:1,expl:"Un lavado COW completo de un tanque dura tipicamente 2 a 4 horas. La boquilla gira lentamente (1-4 rpm) para cubrir todas las superficies."},
      {q:"?Que es el tanque slop en el contexto del COW?",opts:["Tanque de combustible residual","Tanque de recepcion de residuos de lavado","Tanque de lastre de emergencia","Tanque de decantacion de crudo"],correct:1,expl:"El slop tank es un tanque dedicado a la recepcion y almacenamiento temporal de los residuos de lavado COW. Permite la decantacion antes del traslado en tierra o vertido controlado."},
      {q:"?Que convenio internacional hizo obligatorio el COW?",opts:["SOLAS 1974","MARPOL 73/78","BWM 2004","Codigo ISM 1994"],correct:1,expl:"MARPOL 73/78 Anexo I Regulacion 33 hizo obligatorio el COW en VLCC > 20.000 TPM. Adoptado en 1973, modificado en 1978 tras los grandes vertidos de los anos 70."},
      {q:"Durante el COW, el IGS debe mantenerse porque:",opts:["Los chorros COW crean electricidad estatica","El crudo caliente proyectado libera vapores inflamables","La temperatura eleva el punto de inflamacion","Las boquillas calientan los gases"],correct:1,expl:"El crudo caliente proyectado por las boquillas COW libera grandes cantidades de vapores de hidrocarburos. Sin IGS manteniendo O2 < 8%, estos vapores con el aire formarian una mezcla explosiva."},
      {q:"El Amoco Cadiz (1978) demostro que sin COW adecuado:",opts:["La descarga es mas lenta","Los residuos de parafina persisten y agravan los vertidos","La estabilidad del buque disminuye","Las bombas se desgastan mas rapido"],correct:1,expl:"El Amoco Cadiz derramo 230.000 t de crudo con importantes residuos de parafina en los tanques. Sin COW operativo, las parafinas adheridas a las paredes se liberan en caso de averia."},
      {q:"?Cual es el umbral maximo de residuos permitido por MARPOL tras el COW?",opts:["0,1% del volumen del tanque","0,4% del volumen del tanque","1% del volumen del tanque","2% del volumen del tanque"],correct:1,expl:"MARPOL Anexo I fija el maximo en 0,4% del volumen total del tanque tras el COW."},
      {q:"?Cual es la velocidad de rotacion tipica de las boquillas COW?",opts:["10 a 20 rpm","30 a 60 rpm","1 a 4 rpm","0,1 a 0,5 rpm"],correct:2,expl:"Las boquillas COW giran lentamente: 1 a 4 revoluciones por minuto. Esta velocidad lenta permite que los chorros actuen suficientemente sobre cada zona de la pared."},
      {q:"El tanque slop debe tratarse antes de cualquier vertido al mar. El umbral MARPOL es:",opts:["100 ppm de hidrocarburos","15 ppm de hidrocarburos","5 ppm de hidrocarburos","0 ppm (vertido prohibido)"],correct:1,expl:"MARPOL Anexo I: vertido al mar solo permitido si el contenido en hidrocarburos es inferior a 15 ppm. El Libro de Registro de Hidrocarburos debe registrar todas estas operaciones."},
    ],
    pt:[
      {q:"O que significa a sigla COW?",opts:["Crude Oil Washing","Cargo Oil Winch","Crude On Water","Cargo Operations Workflow"],correct:0,expl:"COW = Crude Oil Washing (lavagem com petroleo bruto). O sistema usa o proprio crude quente como solvente para dissolver e eliminar os residuos de parafinas aderidos as paredes dos tanques."},
      {q:"Que fluido e usado como solvente no sistema COW?",opts:["Agua do mar aquecida","Agua doce sob pressao","O proprio crude quente","Solvente quimico especial"],correct:2,expl:"O COW usa o proprio crude de carga como solvente. Os bocais projectam crude quente (50-60°C) sobre as paredes. O crude quente dissolve os residuos de parafinas e ceras que ficam aderidos na descarga normal."},
      {q:"Qual e a pressao nominal de funcionamento dos bocais COW?",opts:["2 a 4 bar","8 a 12 bar","20 a 30 bar","50 a 60 bar"],correct:1,expl:"A pressao nominal COW e de 8 a 12 bar (tipicamente 9-10 bar). Abaixo de 8 bar, o jacto nao e suficientemente potente. Acima de 12 bar, risco de deterioracao dos bocais e da estrutura."},
      {q:"A que temperatura deve ser aquecido o crude para o COW?",opts:["20 a 30°C","35 a 45°C","50 a 65°C","75 a 90°C"],correct:2,expl:"O crude deve ser aquecido a 50-65°C para o COW. A esta temperatura, a viscosidade do crude diminui significativamente, permitindo que os jactos penetrem e dissolvam eficazmente os residuos de parafinas."},
      {q:"Em que navios e o COW obrigatorio segundo MARPOL Anexo I?",opts:["Todos os petroleiros","Petroleiros > 5.000 TPB","VLCC > 20.000 TPB","Petroleiros > 100.000 TPB"],correct:2,expl:"MARPOL Anexo I Regulacao 33: COW obrigatorio em todos os VLCC de mais de 20.000 TPB construidos apos 1980."},
      {q:"Para onde sao enviados os residuos COW apos a lavagem?",opts:["Descarregados directamente no mar","Para o tanque slop","Para os tanques de lastro","Para o duplo fundo"],correct:1,expl:"Os residuos COW sao bombeados para o slop tank, especificamente dedicado a este uso. O slop e tratado em terra ou decantado antes do descarte conforme MARPOL (menos de 15 ppm no mar)."},
      {q:"Qual e a reducao de residuos apos COW em relacao a uma descarga normal?",opts:["20 a 30%","40 a 50%","60 a 70%","90 a 95%"],correct:2,expl:"O COW reduz os residuos no tanque em 60-70% em relacao a descarga normal. Sem COW, um VLCC pode deixar 800-1500 toneladas de lamas. Com COW, desce para 250-450 toneladas."},
      {q:"Qual e a duracao tipica de uma lavagem COW completa de um tanque?",opts:["30 a 60 minutos","2 a 4 horas","8 a 12 horas","24 horas"],correct:1,expl:"Uma lavagem COW completa de um tanque demora tipicamente 2 a 4 horas. O bocal roda lentamente (1-4 rpm) para cobrir todas as superficies."},
      {q:"O que e o slop tank no contexto do COW?",opts:["Tanque de combustivel residual","Tanque de recepcao de residuos de lavagem","Tanque de lastro de emergencia","Tanque de decantacao de crude"],correct:1,expl:"O slop tank e um tanque dedicado a recepcao e armazenamento temporario dos residuos de lavagem COW. Permite a decantacao antes da transferencia para terra ou descarte controlado."},
      {q:"Qual convencao internacional tornou o COW obrigatorio?",opts:["SOLAS 1974","MARPOL 73/78","BWM 2004","Codigo ISM 1994"],correct:1,expl:"MARPOL 73/78 Anexo I Regulacao 33 tornou o COW obrigatorio em VLCC > 20.000 TPB. Adoptado em 1973, alterado em 1978 apos os grandes derrames dos anos 70."},
      {q:"Durante o COW, o IGS deve ser mantido porque:",opts:["Os jactos COW criam electricidade estatica","O crude quente projectado liberta vapores inflamaveis","A temperatura eleva o ponto de inflamacao","Os bocais aquecem os gases"],correct:1,expl:"O crude quente projectado pelos bocais COW liberta grandes quantidades de vapores de hidrocarbonetos. Sem IGS mantendo O2 < 8%, estes vapores com o ar formariam uma mistura explosiva."},
      {q:"O Amoco Cadiz (1978) demonstrou que sem COW adequado:",opts:["A descarga e mais lenta","Os residuos de parafina persistem e agravam os derrames","A estabilidade do navio diminui","As bombas desgastam-se mais rapidamente"],correct:1,expl:"O Amoco Cadiz derramou 230.000 t de crude com importantes residuos de parafina nos tanques. Sem COW operacional, as parafinas aderidas as paredes ficam no navio e sao libertadas em caso de acidente."},
      {q:"Qual e o limite maximo de residuos permitido pelo MARPOL apos COW?",opts:["0,1% do volume do tanque","0,4% do volume do tanque","1% do volume do tanque","2% do volume do tanque"],correct:1,expl:"MARPOL Anexo I fixa o maximo em 0,4% do volume total do tanque apos COW."},
      {q:"Qual e a velocidade de rotacao tipica dos bocais COW?",opts:["10 a 20 rpm","30 a 60 rpm","1 a 4 rpm","0,1 a 0,5 rpm"],correct:2,expl:"Os bocais COW rodam lentamente: 1 a 4 rotacoes por minuto. Esta velocidade lenta e necessaria para permitir que os jactos actuem suficientemente sobre cada zona da parede."},
      {q:"O slop tank deve ser tratado antes de qualquer descarga no mar. O limite MARPOL e:",opts:["100 ppm de hidrocarbonetos","15 ppm de hidrocarbonetos","5 ppm de hidrocarbonetos","0 ppm (descarga proibida)"],correct:1,expl:"MARPOL Anexo I: descarga no mar so permitida se o teor de hidrocarbonetos for inferior a 15 ppm. O Livro de Registo de Hidrocarbonetos deve registar todas estas operacoes."},
    ],
  };
...
export const QUIZ = {
  fr:[
    {q:"Que signifie COW et quel fluide sert de solvant ?",opts:["Crude Oil Washing - brut chaud","Cargo Oil Winch - eau chaude","Crude On Water - solvant chimique","Cleaning Oil Work - eau douce"],correct:0,expl:"COW = Crude Oil Washing. Le brut cargo lui-meme, chauffe a 50-65°C, est utilise comme solvant pour dissoudre les paraffines et residus colles aux parois des citernes."},
    {q:"Quelle est la pression nominale des buses COW et la temperature du brut ?",opts:["4-6 bar / 30-40°C","8-12 bar / 50-65°C","15-20 bar / 70-80°C","25-30 bar / 90°C+"],correct:1,expl:"Pression nominale : 8-12 bar (typiquement 9-10 bar). Temperature brut : 50-65°C. Ces parametres optimaux permettent une dissolution efficace des paraffines et un rendement COW > 85%."},
    {q:"Selon MARPOL Annexe I, le COW est obligatoire sur :",opts:["Tous les petroliers","VLCC > 20 000 tdw","Chimiquiers > 8 000 tdw","Petroliers > 5 000 tdw"],correct:1,expl:"MARPOL 73/78 Annexe I Regulation 33 : COW obligatoire sur tous les VLCC de plus de 20 000 tdw construits apres 1980. Cette obligation est directement liee aux grandes marees noires des annees 70 dont l'Amoco Cadiz."},
    {q:"Le seuil de residus MARPOL apres COW est de :",opts:["0,1% du volume","0,4% du volume","1% du volume","5% du volume"],correct:1,expl:"MARPOL fixe la limite a 0,4% du volume de la citerne. En dessous, la citerne est considered clean. Le COW reduit les residus de 60-70% par rapport a un dechargement sans lavage."},
    {q:"L'Amoco Cadiz (1978) a renforce l'obligation COW car :",opts:["Le navire etait trop vieux","Les residus paraffines aggravent la pollution lors d'un deversement","Le capitaine n'avait pas de certificat","Le brut iranien etait interdit"],correct:1,expl:"L'enquete Amoco Cadiz a montre que les residus de paraffines restes dans les citernes non lavees au COW ont considerablement aggrave la maree noire. MARPOL 73/78 a ete renforce directement suite a cette catastrophe."},
  ],
  en:[
    {q:"What does COW mean and what fluid serves as solvent?",opts:["Crude Oil Washing - hot crude","Cargo Oil Winch - hot water","Crude On Water - chemical solvent","Cleaning Oil Work - fresh water"],correct:0,expl:"COW = Crude Oil Washing. The cargo crude itself, heated to 50-65°C, is used as solvent to dissolve paraffins and residues stuck to tank walls."},
    {q:"What is the nominal COW nozzle pressure and crude temperature?",opts:["4-6 bar / 30-40°C","8-12 bar / 50-65°C","15-20 bar / 70-80°C","25-30 bar / 90°C+"],correct:1,expl:"Nominal pressure: 8-12 bar (typically 9-10 bar). Crude temperature: 50-65°C. These optimal parameters allow effective paraffin dissolution and COW efficiency > 85%."},
    {q:"Under MARPOL Annex I, COW is mandatory on:",opts:["All tankers","VLCCs > 20,000 DWT","Chemical tankers > 8,000 DWT","Tankers > 5,000 DWT"],correct:1,expl:"MARPOL 73/78 Annex I Regulation 33: COW mandatory on all VLCCs over 20,000 DWT built after 1980. This requirement is directly linked to the major oil spills of the 1970s including Amoco Cadiz."},
    {q:"The MARPOL residue threshold after COW is:",opts:["0.1% of volume","0.4% of volume","1% of volume","5% of volume"],correct:1,expl:"MARPOL sets the limit at 0.4% of tank volume. Below this, the tank is considered clean. COW reduces residues by 60-70% compared to discharge without washing."},
    {q:"The Amoco Cadiz (1978) reinforced COW requirements because:",opts:["The vessel was too old","Paraffin residues worsen pollution during spills","The captain had no certificate","Iranian crude was prohibited"],correct:1,expl:"The Amoco Cadiz inquiry showed that paraffin residues remaining in unwashed tanks considerably worsened the oil spill. MARPOL 73/78 was directly strengthened following this disaster."},
  ],
  es:[
    {q:"?Que significa COW y que fluido sirve de solvente?",opts:["Crude Oil Washing - crudo caliente","Cargo Oil Winch - agua caliente","Crude On Water - solvente quimico","Cleaning Oil Work - agua dulce"],correct:0,expl:"COW = Crude Oil Washing. El propio crudo de carga, calentado a 50-65°C, se usa como solvente para disolver las parafinas y residuos adheridos a las paredes de los tanques."},
    {q:"?Cual es la presion nominal de las boquillas COW y la temperatura del crudo?",opts:["4-6 bar / 30-40°C","8-12 bar / 50-65°C","15-20 bar / 70-80°C","25-30 bar / 90°C+"],correct:1,expl:"Presion nominal: 8-12 bar (tipicamente 9-10 bar). Temperatura crudo: 50-65°C. Estos parametros optimos permiten una disolucion eficaz de las parafinas."},
    {q:"Segun MARPOL Anexo I, el COW es obligatorio en:",opts:["Todos los petroleros","VLCC > 20.000 TPM","Quimiqueros > 8.000 TPM","Petroleros > 5.000 TPM"],correct:1,expl:"MARPOL 73/78 Anexo I Regulacion 33: COW obligatorio en todos los VLCC de mas de 20.000 TPM construidos despues de 1980."},
    {q:"El umbral de residuos MARPOL tras COW es de:",opts:["0,1% del volumen","0,4% del volumen","1% del volumen","5% del volumen"],correct:1,expl:"MARPOL fija el limite en 0,4% del volumen del tanque. El COW reduce los residuos un 60-70% respecto a la descarga sin lavado."},
    {q:"El Amoco Cadiz (1978) reforzo la obligacion COW porque:",opts:["El buque era demasiado viejo","Los residuos de parafina agravan la contaminacion","El capitan no tenia certificado","El crudo irani estaba prohibido"],correct:1,expl:"La investigacion del Amoco Cadiz mostro que los residuos de parafinas en los tanques sin lavar agravaron considerablemente el vertido. MARPOL 73/78 se reforzo directamente tras esta catastrofe."},
  ],
  pt:[
    {q:"O que significa COW e que fluido serve de solvente?",opts:["Crude Oil Washing - crude quente","Cargo Oil Winch - agua quente","Crude On Water - solvente quimico","Cleaning Oil Work - agua doce"],correct:0,expl:"COW = Crude Oil Washing. O proprio crude de carga, aquecido a 50-65°C, e usado como solvente para dissolver as parafinas e residuos aderidos as paredes dos tanques."},
    {q:"Qual e a pressao nominal dos bocais COW e a temperatura do crude?",opts:["4-6 bar / 30-40°C","8-12 bar / 50-65°C","15-20 bar / 70-80°C","25-30 bar / 90°C+"],correct:1,expl:"Pressao nominal: 8-12 bar (tipicamente 9-10 bar). Temperatura crude: 50-65°C. Estes parametros optimos permitem uma dissolucao eficaz das parafinas."},
    {q:"Segundo MARPOL Anexo I, o COW e obrigatorio em:",opts:["Todos os petroleiros","VLCC > 20.000 TPB","Quimiqueiros > 8.000 TPB","Petroleiros > 5.000 TPB"],correct:1,expl:"MARPOL 73/78 Anexo I Regulacao 33: COW obrigatorio em todos os VLCC de mais de 20.000 TPB construidos apos 1980."},
    {q:"O limite de residuos MARPOL apos COW e de:",opts:["0,1% do volume","0,4% do volume","1% do volume","5% do volume"],correct:1,expl:"MARPOL fixa o limite em 0,4% do volume do tanque. O COW reduz os residuos em 60-70% em relacao a descarga sem lavagem."},
    {q:"O Amoco Cadiz (1978) reforcou a obrigacao COW porque:",opts:["O navio era demasiado velho","Os residuos de parafina agravam a poluicao","O capitao nao tinha certificado","O crude iraniano estava proibido"],correct:1,expl:"A investigacao do Amoco Cadiz mostrou que os residuos de parafinas nos tanques sem lavagem agravaram consideravelmente o derrame. MARPOL 73/78 foi directamente reforcado apos esta catastrofe."},
  ],
};
...
// MAIN EXPORT
// ══════════════════════════════════════
export default function LessonE6_L4({ lang="fr", onBack=()=>{}, onComplete=()=>{}, onNext=()=>{}, onQuizScored=(score:number,maxScore:number)=>{} }) {
  const t = T[lang]||T.fr;
        ...
        <div style={{maxWidth:480,margin:"0 auto"}}>
          ...
          {phase==="content"&&<>
            ...
            <button disabled={!bankDone} onClick={()=>{if(bankDone)setPhase("quiz");}}
              style={{opacity:bankDone?1:0.45,cursor:bankDone?"pointer":"not-allowed",width:"100%",padding:"17px 0",border:"none",borderRadius:16,background:`linear-gradient(135deg,${C.brown},${C.gold})`,fontFamily:"'Cinzel',serif",fontSize:15,fontWeight:700,letterSpacing:2,color:C.white,boxShadow:"0 10px 36px rgba(121,85,72,0.4)",marginTop:8}}>
              {t.startQuiz}
            </button>
