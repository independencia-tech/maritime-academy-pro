...
const getContent = lang => {
  const d={
    en:{
      badge:"🚨 Engine · Lesson 7/7 · ⭐ Premium · 200 XP",
    ...
    fr:{
      badge:"🚨 Engine · Lecon 7/7 · ⭐ Premium · 200 XP",
    ...
    es:{
      badge:"🚨 Engine · Leccion 7/7 · ⭐ Premium · 200 XP",
    ...
    pt:{
      badge:"🚨 Engine · Licao 7/7 · ⭐ Premium · 200 XP",
      title:"Sistemas de emergencia",
