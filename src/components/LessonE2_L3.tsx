...
const T: any = {
  fr: {
    ...
    quiz: [
      { q: "A quelle temperature faut-il chauffer le HFO pour optimiser la separation dans un purificateur ?", opts: ["40-50 degC", "60-70 degC", "85-98 degC", "110-120 degC"], correct: 2, expl: "Le HFO doit etre chauffe a 85-98 degC pour reduire sa viscosite a 10-20 cSt, permettant une separation efficace. En dessous de cette temperature, la viscosite est trop elevee et les performances de separation chutent drastiquement." },
      { q: "Qu'est-ce que le gravity disc dans un purificateur ?", opts: ["Un filtre a particules", "Un anneau qui determine la position de l'interface huile-eau", "Un regulateur de debit", "Un amortisseur de vibrations"], correct: 1, expl: "Le gravity disc est un anneau en acier inox qui cree un deversoir a l'extremite du bol. Son diametre interieur determine la position de l'interface huile-eau. Un diametre trop grand laisse passer l'eau dans l'huile ; trop petit, l'huile passe dans l'eau." },
      { q: "Un purificateur a 3 sorties. Quelles sont-elles ?", opts: ["Huile, eau, air", "Huile propre, eau + impuretes, boues", "Huile chaude, huile froide, boues", "Entree, sortie, recirculation"], correct: 1, expl: "Un purificateur a 3 sorties : l'huile propre (sortie principale), l'eau avec les impuretes (effluent eau), et les boues (ejectees periodiquement par les orifices peripheriques du bol)." },
      { q: "Quelle est la teneur maximale en huile autorisee par MARPOL pour le rejet des eaux de cale en mer ?", opts: ["5 ppm", "15 ppm", "100 ppm", "1000 ppm"], correct: 1, expl: "MARPOL Annexe I limite la teneur en huile des eaux de cale rejetees en mer a 15 ppm maximum (a plus de 12 milles nautiques des cotes). Au-dela, ou dans les zones speciales, le rejet est totalement interdit." },
      { q: "Que se passe-t-il si le gravity disc est trop grand dans un purificateur ?", opts: ["Les boues ne sont pas ejectees", "L'eau passe dans la sortie huile", "L'huile passe dans la sortie eau", "La vitesse du bol augmente"], correct: 1, expl: "Si le gravity disc est trop grand, l'interface huile-eau se deplace trop loin vers le centre du bol. L'eau atteint la zone huile et sort avec l'huile propre → eau dans la sortie huile. Solution : remplacer par un gravity disc de plus petit diametre." },
    ],
  },
  ...
  en: {
    ...
    quiz: [
      { q: "At what temperature should HFO be heated to optimise purifier separation?", opts: ["40-50 degC", "60-70 degC", "85-98 degC", "110-120 degC"], correct: 2, expl: "HFO must be heated to 85-98 degC to reduce viscosity to 10-20 cSt, enabling effective separation. Below this temperature, viscosity is too high and separation performance drops drastically." },
      { q: "What is the gravity disc in a purifier?", opts: ["A particle filter", "A ring determining the oil-water interface position", "A flow regulator", "A vibration damper"], correct: 1, expl: "The gravity disc is a stainless steel ring creating a weir at the bowl top. Its bore diameter determines the oil-water interface position. Too large a bore allows water into the oil; too small, oil passes into the water." },
      { q: "A purifier has 3 outlets. What are they?", opts: ["Oil, water, air", "Clean oil, water + impurities, sludge", "Hot oil, cold oil, sludge", "Inlet, outlet, recirculation"], correct: 1, expl: "A purifier has 3 outlets: clean oil (main outlet), water with impurities (water effluent), and sludge (periodically ejected through bowl peripheral ports)." },
      { q: "What is the maximum oil content allowed by MARPOL for bilge water discharge at sea?", opts: ["5 ppm", "15 ppm", "100 ppm", "1000 ppm"], correct: 1, expl: "MARPOL Annex I limits oil content of bilge water discharged at sea to 15 ppm maximum (more than 12 nautical miles from coast). Beyond this, or in special areas, discharge is totally prohibited." },
      { q: "What happens if the gravity disc is too large in a purifier?", opts: ["Sludge is not ejected", "Water passes into the oil outlet", "Oil passes into the water outlet", "Bowl speed increases"], correct: 1, expl: "If the gravity disc is too large, the oil-water interface moves too far toward the bowl centre. Water reaches the oil zone and exits with clean oil → water in oil outlet. Solution: replace with smaller bore gravity disc." },
    ],
  },
  ...
  es: {
    ...
    quiz: [
      { q: "A que temperatura hay que calentar el HFO para optimizar la separacion en un purificador?", opts: ["40-50 degC", "60-70 degC", "85-98 degC", "110-120 degC"], correct: 2, expl: "El HFO debe calentarse a 85-98 degC para reducir su viscosidad a 10-20 cSt. Por debajo de esta temperatura, la viscosidad es demasiado alta y el rendimiento de separacion cae drasticamente." },
      { q: "Que es el disco de gravedad en un purificador?", opts: ["Un filtro de particulas", "Un anillo que determina la posicion de la interfaz aceite-agua", "Un regulador de caudal", "Un amortiguador de vibraciones"], correct: 1, expl: "El disco de gravedad es un anillo de acero inox que crea un vertedero en el cuenco. Su diametro interior determina la posicion de la interfaz aceite-agua." },
      { q: "Un purificador tiene 3 salidas. Cuales son?", opts: ["Aceite, agua, aire", "Aceite limpio, agua + impurezas, lodos", "Aceite caliente, aceite frio, lodos", "Entrada, salida, recirculacion"], correct: 1, expl: "Un purificador tiene 3 salidas: aceite limpio (salida principal), agua con impurezas (efluente agua) y lodos (eyectados periodicamente por los orificios perifericos del cuenco)." },
      { q: "Cual es el contenido maximo de aceite permitido por MARPOL para el vertido de aguas de sentina al mar?", opts: ["5 ppm", "15 ppm", "100 ppm", "1000 ppm"], correct: 1, expl: "MARPOL Anexo I limita el contenido de aceite de las aguas de sentina a 15 ppm maximo (a mas de 12 millas nauticas de la costa). En zonas especiales, el vertido esta totalmente prohibido." },
      { q: "Que ocurre si el disco de gravedad es demasiado grande?", opts: ["Los lodos no se eyectan", "El agua pasa a la salida de aceite", "El aceite pasa a la salida de agua", "La velocidad del cuenco aumenta"], correct: 1, expl: "Si el disco de gravedad es demasiado grande, la interfaz aceite-agua se desplaza demasiado hacia el centro. El agua llega a la zona de aceite y sale con el aceite limpio → agua en la salida de aceite." },
    ],
  },
  ...
  pt: {
    ...
    quiz: [
      { q: "A que temperatura deve ser aquecido o HFO para otimizar a separacao num purificador?", opts: ["40-50 degC", "60-70 degC", "85-98 degC", "110-120 degC"], correct: 2, expl: "O HFO deve ser aquecido a 85-98 degC para reduzir a viscosidade a 10-20 cSt. Abaixo desta temperatura, a viscosidade e demasiado alta e o desempenho de separacao cai drasticamente." },
      { q: "O que e o disco de gravidade num purificador?", opts: ["Um filtro de particulas", "Um anel que determina a posicao da interface oleo-agua", "Um regulador de caudal", "Um amortecedor de vibracoes"], correct: 1, expl: "O disco de gravidade e um anel de aco inox que cria um descarregador na tigela. O seu diametro interior determina a posicao da interface oleo-agua." },
      { q: "Um purificador tem 3 saidas. Quais sao?", opts: ["Oleo, agua, ar", "Oleo limpo, agua + impurezas, lamas", "Oleo quente, oleo frio, lamas", "Entrada, saida, recirculacao"], correct: 1, expl: "Um purificador tem 3 saidas: oleo limpo (saida principal), agua com impurezas (efluente agua) e lamas (ejetadas periodicamente pelos orificios perifericos da tigela)." },
      { q: "Qual e o teor maximo de oleo permitido pelo MARPOL para a descarga de aguas de sentina no mar?", opts: ["5 ppm", "15 ppm", "100 ppm", "1000 ppm"], correct: 1, expl: "O MARPOL Anexo I limita o teor de oleo das aguas de sentina a 15 ppm maximo (a mais de 12 milhas nauticas da costa). Nas zonas especiais, a descarga e totalmente proibida." },
      { q: "O que acontece se o disco de gravidade for demasiado grande?", opts: ["As lamas nao sao ejetadas", "A agua passa para a saida de oleo", "O oleo passa para a saida de agua", "A velocidade da tigela aumenta"], correct: 1, expl: "Se o disco de gravidade for demasiado grande, a interface oleo-agua desloca-se demasiado para o centro. A agua atinge a zona de oleo e sai com o oleo limpo → agua na saida de oleo." },
    ],
  },
};
