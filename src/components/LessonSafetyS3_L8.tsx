...
const BANK = {
  fr:[
    ...
    {q:"Quelle est la toute première étape de la préparation du pont pour un hélicoptère ?",opts:["Hisser la manche à air uniquement","Sécuriser la zone entière : objets mobiles, personnel, communications, vent, obstacles","Attendre les instructions du pilote sans rien faire","Éteindre toutes les lumières du pont"],correct:1,expl:"Secure the Landing Zone est le point de départ de toute la préparation, pas une étape isolée."},
    {q:"Pourquoi le souffle du rotor est-il dangereux sur le pont ?",opts:["Il ne l'est pas vraiment","Il peut déplacer des objets légers comme une caisse, une bâche ou un seau, créant un danger soudain","Il n'affecte que les vêtements","Il concerne uniquement l'hélicoptère lui-même"],correct:1,expl:"Le cas d'étude illustre directement comment des objets non arrimés deviennent dangereux sous le souffle du rotor."},
  ...
  en:[
    ...
    {q:"What is the very first step in preparing the deck for a helicopter?",opts:["Only hoisting the windsock","Securing the entire zone: loose objects, personnel, communications, wind, obstacles","Waiting for the pilot's instructions without doing anything","Turning off all deck lights"],correct:1,expl:"Secure the Landing Zone is the starting point of all preparation, not an isolated step."},
    {q:"Why is rotor downwash dangerous on deck?",opts:["It isn't really","It can move light objects like a crate, a tarp, or a bucket, creating a sudden hazard","It only affects clothing","It only concerns the helicopter itself"],correct:1,expl:"The case study directly illustrates how unsecured objects become dangerous under rotor downwash."},
  ...
  es:[
    ...
    {q:"¿Cuál es el primerísimo paso en la preparación de la cubierta para un helicóptero?",opts:["Solo izar la manga de viento","Asegurar toda la zona: objetos móviles, personal, comunicaciones, viento, obstáculos","Esperar las instrucciones del piloto sin hacer nada","Apagar todas las luces de la cubierta"],correct:1,expl:"Secure the Landing Zone es el punto de partida de toda la preparación, no un paso aislado."},
    {q:"¿Por qué es peligroso el soplo del rotor en la cubierta?",opts:["No lo es realmente","Puede desplazar objetos ligeros como una caja, una lona o un cubo, creando un peligro repentino","Solo afecta a la ropa","Solo concierne al propio helicóptero"],correct:1,expl:"El caso de estudio ilustra directamente cómo los objetos no asegurados se vuelven peligrosos bajo el soplo del rotor."},
...
const QUIZ = {
  ...
  en:[
    {q:"What is the very first step in preparing the deck for a helicopter?",opts:["Only hoisting the windsock","Securing the entire zone: objects, personnel, communications, wind, obstacles","Waiting for instructions without doing anything","Turning off the lights"],correct:1,expl:"Secure the Landing Zone is the starting point of all preparation."},
  ...
  es:[
    {q:"¿Cuál es el primerísimo paso en la preparación de la cubierta para un helicóptero?",opts:["Solo izar la manga de viento","Asegurar toda la zona: objetos, personal, comunicaciones, viento, obstáculos","Esperar instrucciones sin hacer nada","Apagar las luces"],correct:1,expl:"Secure the Landing Zone es el punto de partida de toda la preparación."},
...
// MAIN
export default function LessonSafetyS3_L8({ lang="fr", onBack=()=>{}, onComplete=()=>{}, onNext=()=>{} }) {
  const t = T[lang]||T.fr;
