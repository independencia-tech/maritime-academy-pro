...
export const BANK = {
  ...
  pt: [
    ...
    {q:"Por que a posidonia e uma especie protegida no Mediterraneo?",opts:["E uma alga decorativa","Planta com flores endemica: producao O2, viveiro peixes, sequestro CO2, protegida lei 88-1261","E perigosa para os navios","Indica um fundo rochoso"],correct:1,expl:"A posidonia (Posidonia oceanica) e uma planta com flores (nao uma alga) endemica do Mediterraneo. Produz 20L de O2/m2/dia, serve de viveiro para peixes e crustaceos, fixa os fundos e capta CO2. Protegida desde 1988. Multa ate 150 000 euros se se fundear sobre ela."},
    {q:"Qual e o papel da garra do diabo?",opts:["Travar o molinete","Bloquear mecanicamente a corrente independentemente do molinete — seguranca em navegacao","Contar as manilhas","Guiar a corrente no escovem"],correct:1,expl:"A garra do diabo e um gancho metalico que se bloqueia num elo da corrente. Suporta o peso da corrente independentemente do travao do molinete. Essencial: se o molinete falhar, a garra do diabo retem a corrente. Engatar sempre depois de fundear."},
    {q:"O que significa 'corrente apique'?",opts:["A corrente esta no pocete","A corrente e vertical sob o navio — a ancora esta diretamente abaixo, pronta para agarrar","A corrente e curta demais","A ancora esta a bordo"],correct:1,expl:"'Corrente apique' = a corrente esta tensa verticalmente sob o escovem, indicando que o navio esta diretamente sobre a ancora. E o sinal de que a ancora vai desprender. O oficial de conves anuncia-o a ponte, que pode entao usar a maquina para ajudar a alagem."},
    {q:"Quais sao os metodos de detecao do arrasto?",opts:["Olhar apenas para o mar","Marcacoes repetidas sobre marcas fixas + alarme GPS + vibracoes corrente + vigiar embarcacoes vizinhas","Contar as manilhas","Observar a cor da agua"],correct:1,expl:"Metodos de detecao de arrasto: (1) Marcar amers fixos a cada 30 min — se as marcacoes mudarem, o navio esta a derivar. (2) Alarme GPS configurado em circulo a volta do ponto de fundeio. (3) Vibracoes ou solavancos na corrente. (4) Comparar a posicao com os navios vizinhos. Varios metodos em simultaneo."},
    {q:"Qual fundo oferece a melhor retencao para uma ancora Hall?",opts:["Rocha","Areia ou vasa — melhor penetracao e aderencia","Calhaus","Ervas"],correct:1,expl:"A areia e a vasa sao os melhores fundos para uma ancora Hall. Em areia: a ancora penetra rapidamente e desenvolve uma excelente resistencia por friccao. Em vasa: boa retencao mas atencao a succao ao levantar. A rocha, os calhaus e as ervas devem ser evitados."},
    {q:"A que correspondem os simbolos S, M, R, Wd numa carta nautica?",opts:["Sinais, Marca, Rocha, Vento","Sand (areia), Mud (vasa), Rock (rocha), Weed (ervas) — natureza do fundo","Seguranca, Fundeadouro, Rada, Vento dominante","Sondagem, Marcha, Rapido, Deriva"],correct:1,expl:"Nas cartas nauticas (SHOM/IHO): S = Sand (areia), M = Mud (vasa/lodo), R = Rock (rocha), Cy = Clay (argila), G = Gravel (cascalho), Sh = Shells (conchas), Wd = Weed (ervas/algas). Estas anotacoes permitem escolher o melhor local de fundeio."},
    {q:"O que e o fundeio com duas ancoras?",opts:["Um procedimento de emergencia apenas","Tecnica para reduzir circulo de evolucao, aguentar em corrente alternada ou reforcar retencao com mau tempo","Obrigatorio no porto","Usada apenas por veleiros"],correct:1,expl:"O fundeio com duas ancoras e usado para: (1) Limitar o circulo de evolucao em espaco confinado — as duas ancoras em V. (2) Aguentar em corrente alternada (mare) — ancoras no eixo da corrente. (3) Reforcar a retencao com mau tempo. Configuracao comum: ancoras dispostas em V (30-60 graus entre as duas correntes)."},
    {q:"Qual e o procedimento recomendado se suspeitar de arrasto?",opts:["Esperar que o tempo melhore","Verificar arrasto, filar mais corrente, arrancar maquinas em espera, preparar para zarpar se necessario","Parar o motor do molinete","Chamar socorro imediatamente"],correct:1,expl:"Procedimento de arrasto: (1) Confirmar o arrasto por marcacao e GPS. (2) Alertar o comandante. (3) Filar mais corrente para aumentar a retencao. (4) Ligar as maquinas para aliviar a tracao sobre a ancora. (5) Se o arrasto continuar: levantar a ancora e navegar ou mudar de posicao. Nunca esperar que a situacao se torne critica."},
    {q:"O que significa 'corrente em catenaria'?",opts:["A corrente esta reta e tensa","A corrente forma uma curva natural para baixo — absorve choques e assegura tracao horizontal sobre a ancora","A corrente esta enrolada","A corrente e curta"],correct:1,expl:"A catenaria e a curva natural que a corrente forma entre o escovem e o fundo sob o seu proprio peso. Funciona como amortecedor: absorve os choques das ondas e do vento. Assegura um angulo de tracao proximo da horizontal sobre a ancora (melhor retencao). Corrente tensa = sem catenaria = ma retencao = possivel sinal de arrasto."},
    {q:"Que criterios para escolher um bom local de fundeio?",opts:["Apenas a profundidade","Protecao meteorologica, tipo fundo, profundidade, circulo evolucao, cabos submarinos, regulamentacao local","A proximidade ao porto","Apenas a cor da agua"],correct:1,expl:"Criterios de escolha de um fundeadouro: (1) Protecao meteorologica — abrigo natural vento/ondulacao. (2) Fundo S ou M preferencial. (3) Profundidade adaptada ao calado + scope. (4) Espaco suficiente para o circulo de evolucao (corrente+comprimento do navio). (5) Ausencia de cabos submarinos (consultar a carta). (6) Zonas de fundeio autorizadas (regulamentacao local, zonas protegidas)."},
    {q:"O que e um fundeio em rada aberta?",opts:["Fundeio protegido num porto","Fundeio em mar aberto sem abrigo natural — precaucoes maximas necessarias","Fundeio com duas ancoras","Fundeio permanente"],correct:1,expl:"A rada aberta e um fundeio em zona exposta sem protecao natural. Usada para: transbordo no mar, espera de porto, abastecimento fundeado. Precaucoes: scope minimo 5:1, vigia permanente, maquinas em espera, pronto a zarpar a qualquer momento. Proibido com ventos fortes se houver alternativa disponivel."},
    {q:"Que ordem da ponte para iniciar o fundeio?",opts:["'Para maquina'","'Fundeiem!' ou 'Let go!' — ordem definitiva para largar a ancora","'Preparados para fundeiar'","'Molinete pronto'"],correct:1,expl:"O procedimento e sequencial: (1) 'Preparados para fundeiar' = posicionamento e espera. (2) 'Prontos' do conves = ancora sobre a agua. (3) 'FUNDEIEM!' = ordem definitiva — a ancora e largada. O timoneiro/contramestre confirma 'Ancora na agua'. A ponte anuncia previamente a profundidade e o numero de manilhas a filar."},
  ],
};
