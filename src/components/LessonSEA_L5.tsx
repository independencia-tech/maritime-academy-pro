...
export const BANK = {
  fr: [
    ...
    {q:"Qu'est-ce que le bras de levier GZ ?",opts:["Le poids de G","Distance horizontale entre G et la verticale de B quand le navire gite. Si GZ > 0 : couple redressant. Si GZ < 0 : couple chavirant. GZ max IMO >= 0,20 m a >= 30.","La profondeur d'immersion","La distance KM"],correct:1,expl:"GZ est le bras du couple redressant (ou chavirant). Plus GZ est grand, plus la force redressante est importante. La courbe GZ en fonction de la gite donne toute l'information de stabilite : GM initial (pente a l'origine), GZ maximum, angle de chavirement. IMO exige GZ max >= 0,20 m a un angle >= 30 degres."},
    {q:"Quels sont les criteres minimaux IMO IS Code 2008 pour la stabilite initiale ?",opts:["GM >= 1 m uniquement","GM >= 0,15 m, GZ max >= 0,20 m a >= 30 deg, angle chavirement >= 25 apres max, aires 0-30 >= 0,055 / 0-40 >= 0,090 / 30-40 >= 0,030 m.rad","GZ max >= 0,50 m uniquement","GM >= 0,50 m et GZ >= 0,30 m"],correct:1,expl:"IS Code IMO 2008 (MSC.267(85)) : (1) GM initial >= 0,15 m. (2) GZ max >= 0,20 m a angle >= 30. (3) Angle de chavirement >= 25 apres le max GZ. (4) Aire 0-30 >= 0,055 m.rad. (5) Aire 0-40 >= 0,090 m.rad. (6) Aire 30-40 >= 0,030 m.rad. Tous ces criteres doivent etre satisfaits dans toutes les conditions de chargement prevues."},
    ...
    {q:"Qu'est-ce que l'angle de chavirement (vanishing stability) et quel est le critere IMO ?",opts:["L'angle maximal autorise de navigation","Angle au-dela duquel GZ redevient nul et le navire ne peut plus se redresser. IMO IS Code : angle >= 25 degres apres le maximum de GZ. Angle de chavirement faible (< 40 deg) = navire dangereusement instable.","L'angle de gite permanent","L'angle d'assiette maximale"],correct:1,expl:"L'angle de chavirement (vanishing stability angle) est l'angle de gite auquel GZ redevient nul apres son maximum positif. Au-dela, le navire ne peut plus se redresser seul - il chavire. Pour un navire de charge conventionnel, l'IMO IS Code 2008 exige que cet angle soit d'au moins 25 degres apres le maximum de GZ. Un angle de chavirement eleve (> 60-70 deg) indique un navire tres sur, avec une grande reserve de stabilite. La courbe GZ et cet angle sont calcules par le logiciel de stabilite pour chaque condition de chargement."},
  ],
  en: [
    ...
    {q:"What is the righting lever GZ?",opts:["Weight of G","Horizontal distance between G and vertical through B when heeled. If GZ > 0: righting couple. If GZ < 0: capsizing couple. IMO max GZ >= 0.20 m at >= 30 deg.","The draught","The KM distance"],correct:1,expl:"GZ is the righting (or capsizing) couple arm. Larger GZ = greater righting force. The GZ curve vs heel gives all stability info: initial GM (slope at origin), max GZ, angle of vanishing stability. IMO requires max GZ >= 0.20 m at angle >= 30 deg."},
    {q:"What are the IMO IS Code 2008 minimum criteria for initial stability?",opts:["GM >= 1 m only","GM >= 0.15 m, max GZ >= 0.20 m at >= 30 deg, vanishing angle >= 25 past max, areas 0-30 >= 0.055 / 0-40 >= 0.090 / 30-40 >= 0.030 m.rad","Max GZ >= 0.50 m only","GM >= 0.50 m and GZ >= 0.30 m"],correct:1,expl:"IS Code IMO 2008 (MSC.267(85)): (1) Initial GM >= 0.15 m. (2) Max GZ >= 0.20 m at >= 30 deg. (3) Vanishing angle >= 25 past GZ max. (4) Area 0-30 >= 0.055 m.rad. (5) Area 0-40 >= 0.090 m.rad. (6) Area 30-40 >= 0.030 m.rad. All criteria must be met in all planned loading conditions."},
    ...
    {q:"What is ballast and its role in stability?",opts:["Paying cargo","Seawater pumped into dedicated tanks to adjust draught, trim and stability. Fill low tanks -> lowers G -> increases GM. MARPOL regulates ballast water (invasive species).","The fuel","Deck wash water"],correct:1,expl:"Ballast is seawater pumped into dedicated tanks when vessel is in ballast (no cargo) or when stability needs improving. Filling low ballast tanks lowers G -> increases GM -> improves stability. Note: MARPOL Annex V and IMO Ballast Water Convention 2004: ballast water must be treated before discharge to prevent invasive species introduction."},
    ...
    {q:"What is dynamical stability and how is it measured?",opts:["GM at launch","Total righting energy = area under GZ curve from 0 to vanishing angle (m.rad). Represents capacity to resist dynamic disturbances (waves, gusts). Larger area = safer vessel.","Vessel rotation speed","Wave height"],correct:1,expl:"Dynamical stability is the total available righting energy, equal to the area under the GZ curve from 0 to the vanishing angle (m.rad). This energy represents the work the vessel can do against destabilising forces (beam seas, wind gusts). IMO IS Code specifies minimum areas: 0-30 >= 0.055 m.rad, 0-40 >= 0.090 m.rad, 30-40 >= 0.030 m.rad. A vessel with large GZ curve area resists severe weather better."},
  ...
  es: [
    ...
    {q:"Que es el brazo adrizante GZ?",opts:["El peso de G","Distancia horizontal entre G y la vertical de B al escorar. Si GZ > 0: par adrizante. Si GZ < 0: par zozobrante.","El calado","La distancia KM"],correct:1,expl:"GZ es el brazo del par adrizante (o zozobrante). La curva GZ da toda la informacion de estabilidad. OMI exige GZ max >= 0,20 m a un angulo >= 30 grados."},
    {q:"Cuales son los criterios minimos del IS Code OMI 2008 para la estabilidad inicial?",opts:["Solo GM >= 1 m","GM >= 0,15 m, GZ max >= 0,20 m a >= 30 deg, angulo zozobra >= 25 tras max, areas 0-30 >= 0,055 / 0-40 >= 0,090 m.rad","Solo GZ max >= 0,50 m","GM >= 0,50 m y GZ >= 0,30 m"],correct:1,expl:"IS Code OMI 2008: (1) GM >= 0,15 m. (2) GZ max >= 0,20 m a >= 30. (3) Angulo zozobra >= 25 tras max. (4) Areas 0-30 >= 0,055 / 0-40 >= 0,090 / 30-40 >= 0,030 m.rad."},
    ...
    {q:"Que es el angulo de zozobra y cual es el criterio de la OMI?",opts:["El angulo maximo autorizado de navegacion","Angulo mas alla del cual GZ vuelve a cero y el buque no puede adrizar. IS Code OMI: angulo >= 25 grados tras el maximo GZ. Angulo de zozobra bajo (< 40 grados) = buque inestable.","El angulo de escora permanente","El angulo de asiento maximo"],correct:1,expl:"El angulo de zozobra es el angulo al que GZ vuelve a cero. Mas alla, el buque no puede adrizar. IS Code OMI: angulo >= 25 grados tras el maximo GZ. Angulo alto (> 60-70 grados) = buque muy seguro."},
  ],
  pt: [
    ...
    {q:"O que e o braco de endireitamento GZ?",opts:["O peso de G","Distancia horizontal entre G e a vertical de B ao adornar. Se GZ > 0: binas de endireitamento. Se GZ < 0: binas de tombamento.","O calado","A distancia KM"],correct:1,expl:"GZ e o braco das binas de endireitamento (ou tombamento). A curva GZ da toda a informacao de estabilidade. IMO exige GZ max >= 0,20 m a angulo >= 30 graus."},
    {q:"Quais sao os criterios minimos do IS Code IMO 2008 para a estabilidade inicial?",opts:["Apenas GM >= 1 m","GM >= 0,15 m, GZ max >= 0,20 m a >= 30 graus, angulo tombamento >= 25 apos max, areas 0-30 >= 0,055 / 0-40 >= 0,090 m.rad","Apenas GZ max >= 0,50 m","GM >= 0,50 m e GZ >= 0,30 m"],correct:1,expl:"IS Code IMO 2008: (1) GM >= 0,15 m. (2) GZ max >= 0,20 m a >= 30. (3) Angulo tombamento >= 25 apos max. (4) Areas 0-30 >= 0,055 / 0-40 >= 0,090 / 30-40 >= 0,030 m.rad."},
    ...
    {q:"O que e a estabilidade dinamica e como se mede?",opts:["O GM no momento do lancamento","Energia total de endireitamento = area sob curva GZ de 0 ao angulo de tombamento (m.rad). Representa a capacidade de resistir perturbacoes dinamicas.","A velocidade de rotacao do navio","A altura da onda"],correct:1,expl:"A estabilidade dinamica e a energia total disponivel para o endireitamento = area sob a curva GZ. IMO: areas 0-30 >= 0,055 / 0-40 >= 0,090 / 30-40 >= 0,030 m.rad."},
    ...
    {q:"O que e o angulo de tombamento e qual e o criterio da IMO?",opts:["O angulo maximo autorizado de navegacao","Angulo alem do qual GZ volta a zero e o navio nao pode mais endireitar. IS Code IMO: angulo >= 25 graus apos o maximo GZ. Angulo de tombamento baixo (< 40 graus) = navio instavel.","O angulo de banda permanente","O angulo de assentamento maximo"],correct:1,expl:"O angulo de tombamento e o angulo em que GZ volta a zero. Alem disto, o navio nao pode mais endireitar. IS Code IMO: angulo >= 25 graus apos o maximo GZ. Angulo alto (> 60-70 graus) = navio muito seguro."},
  ],
};
...
export const QUIZ={
  fr:[
    {q:"Un navire a KG = 7,8 m et KM = 8,3 m. Quelle est la valeur de GM et l'etat de stabilite ?",
      ...
      correct:0,expl:"GM = KM - KG = 8,3 - 7,8 = 0,5 m. GM positif = G sous M = STABLE. Valeur de 0,5 m : navire stable mais relativement mou. IMO minimum = 0,15 m — critere satisfait. Un GM entre 0,5 et 1,5 m est generalement considere comme acceptable pour un navire de charge."},
  ...
  en:[
    {q:"A vessel has KG = 7.8 m and KM = 8.3 m. What is GM and the stability state?",
      ...
      correct:0,expl:"GM = KM - KG = 8.3 - 7.8 = 0.5 m. Positive GM = G below M = STABLE. Value of 0.5 m: stable but relatively tender. IMO minimum = 0.15 m — criterion satisfied. A GM between 0.5 and 1.5 m is generally considered acceptable for a cargo vessel."},
    ...
    {q:"What is the minimum GM required by IMO IS Code 2008?",
      opts:["0.50 m","0.15 m","1.00 m","0.30 m"],
      correct:1,expl:"IMO IS Code 2008 (MSC.267(85)) requires a minimum initial GM of 0.15 m in all planned loading conditions. This criterion must be met accounting for free surface corrections. Additional criteria: max GZ >= 0.20 m at >= 30 deg, vanishing angle >= 25 deg past GZ max, and GZ curve area requirements."},
  ...
  es:[
    {q:"Un buque tiene KG = 7,8 m y KM = 8,3 m. ?Cual es el GM y el estado de estabilidad?",
      ...
      correct:0,expl:"GM = KM - KG = 8,3 - 7,8 = 0,5 m. GM positivo = G bajo M = ESTABLE. Valor de 0,5 m: estable pero relativamente blando. OMI minimo = 0,15 m — criterio satisfecho. Un GM entre 0,5 y 1,5 m es generalmente aceptable para un buque de carga."},
    ...
    {q:"?Cual es el GM minimo exigido por el IS Code OMI 2008?",
      opts:["0,50 m","0,15 m","1,00 m","0,30 m"],
      correct:1,expl:"IS Code OMI 2008 (MSC.267(85)) exige un GM inicial minimo de 0,15 m en todas las condiciones de carga previstas. Criterios adicionales: GZ max >= 0,20 m a >= 30 grados, angulo de zozobra >= 25 grados tras max GZ, y requisitos de areas bajo la curva GZ."},
  ...
  pt:[
    {q:"Um navio tem KG = 7,8 m e KM = 8,3 m. Qual e o GM e o estado de estabilidade?",
      ...
      correct:0,expl:"GM = KM - KG = 8,3 - 7,8 = 0,5 m. GM positivo = G abaixo de M = ESTAVEL. Valor de 0,5 m: estavel mas relativamente mole. IMO minimo = 0,15 m — criterio satisfeito. Um GM entre 0,5 e 1,5 m e geralmente aceitavel para um navio de carga."},
    ...
    {q:"Qual e o GM minimo exigido pelo IS Code IMO 2008?",
      opts:["0,50 m","0,15 m","1,00 m","0,30 m"],
      correct:1,expl:"IS Code IMO 2008 (MSC.267(85)) exige um GM inicial minimo de 0,15 m em todas as condicoes de carga previstas. Criterios adicionais: GZ max >= 0,20 m a >= 30 graus, angulo de tombamento >= 25 graus apos max GZ, e requisitos de areas sob a curva GZ."},
