...
export const BANK_NAV3 = {
  fr:[
    ...
    {q:"Combien de minutes contient 1 degré d'angle ?",opts:["10","60","100","360"],correct:1,expl:"1 degré = 60 minutes d'arc, chaque minute pouvant elle-même être divisée en secondes ou en dixièmes."},
    {q:"Le format DMS (Degrés Minutes Secondes) est-il utilisé sur les cartes marines traditionnelles ?",opts:["Non, jamais","Oui, c'est le format traditionnel des cartes marines","Non, uniquement sur les GPS","Oui, mais seulement en zone polaire"],correct:1,expl:"Le format DMS (Degrés, Minutes, Secondes) est le format historique et traditionnel utilisé sur les cartes marines."},
    {q:"Le format DD (Degrés Décimaux) est-il couramment utilisé par les systèmes informatiques ?",opts:["Non, jamais","Oui, c'est le format standard des systèmes informatiques et GPS","Non, uniquement sur papier","Oui, mais uniquement pour la longitude"],correct:1,expl:"Le format DD (Degrés Décimaux) est largement utilisé par les logiciels et systèmes GPS modernes car il facilite les calculs informatiques."},
    {q:"Que signifie l'acronyme GMDSS ?",opts:["Global Maritime Distress and Safety System","General Marine Data Storage System","Global Marine Direction Sensor System","General Maritime Distance Signal System"],correct:0,expl:"GMDSS signifie Global Maritime Distress and Safety System - le système mondial de détresse et de sécurité en mer."},
    {q:"Quelle zone GMDSS correspond à la couverture VHF côtière ?",opts:["Zone A1","Zone A2","Zone A3","Zone A4"],correct:0,expl:"La zone A1 correspond à la couverture VHF côtière, la plus proche des terres."},
    {q:"Quelle zone GMDSS correspond à la couverture MF (jusqu'à environ 400 milles) ?",opts:["Zone A1","Zone A2","Zone A3","Zone A4"],correct:1,expl:"La zone A2 correspond à la couverture MF (Moyenne Fréquence), s'étendant jusqu'à environ 400 milles nautiques des côtes."},
    {q:"Quelle zone GMDSS correspond à la couverture satellite INMARSAT en haute mer ?",opts:["Zone A1","Zone A2","Zone A3","Zone A4"],correct:2,expl:"La zone A3 correspond à la couverture par satellite INMARSAT, en dehors de la couverture MF, hors zones polaires."},
    {q:"Quelle zone GMDSS correspond aux zones polaires (HF uniquement) ?",opts:["Zone A1","Zone A2","Zone A3","Zone A4"],correct:3,expl:"La zone A4 correspond aux zones polaires, non couvertes par satellite, où seule la HF (Haute Fréquence) permet la communication."},
    {q:"En cliquant sur le globe interactif de la leçon, quel type d'information est affiché ?",opts:["La météo locale","Les coordonnées géographiques du point cliqué","Le nom du port le plus proche","La profondeur de l'eau"],correct:1,expl:"L'outil interactif du globe affiche les coordonnées géographiques (latitude/longitude) du point sélectionné."},
    {q:"Le convertisseur DMS ↔ DD de la leçon permet-il de passer d'un format à l'autre instantanément ?",opts:["Non, il faut calculer à la main","Oui, c'est exactement sa fonction","Non, il ne fait que le DMS vers DM","Oui, mais uniquement pour la latitude"],correct:1,expl:"Le convertisseur interactif permet justement de passer instantanément entre les formats DMS, DD et DM."},
    {q:"Le format DM (Degrés Minutes décimales) est-il utilisé par certains GPS et ECDIS ?",opts:["Non, jamais","Oui, c'est un format courant sur GPS et ECDIS","Non, uniquement sur les cartes papier","Oui, mais uniquement en zone A4"],correct:1,expl:"Le format DM (Degrés et Minutes décimales) est couramment utilisé par de nombreux récepteurs GPS et systèmes ECDIS."},
    {q:"Une fois hors de la couverture MF, quel moyen de communication devient essentiel en haute mer ?",opts:["Le talkie-walkie","Le satellite INMARSAT (zone A3)","Le porte-voix","Les signaux de fumée"],correct:1,expl:"Une fois hors de la zone A2 (MF), le satellite INMARSAT (zone A3) devient le moyen de communication essentiel en haute mer."},
    {q:"Pourquoi est-il important de connaître la zone GMDSS dans laquelle navigue le navire ?",opts:["Ce n'est pas important","Pour savoir quel équipement de communication utiliser en cas de détresse","Uniquement pour le confort de l'équipage","Pour calculer la vitesse du navire"],correct:1,expl:"Connaître sa zone GMDSS permet de savoir quel équipement de communication (VHF, MF, satellite, HF) reste disponible en cas de détresse."},
  ],
  en:[
    {q:"What does latitude measure on the globe?",opts:["Distance East/West of Greenwich","Distance North/South of the equator","Altitude above sea level","Distance traveled since the departure port"],correct:1,expl:"Latitude measures the North or South position relative to the equator (0°), from 0° to 90°."},
    {q:"What does longitude measure on the globe?",opts:["Distance North/South of the equator","East/West distance relative to the Greenwich meridian","Water depth","Vessel speed"],correct:1,expl:"Longitude measures the East or West position relative to the Greenwich reference meridian (0°), from 0° to 180°."},
    {q:"How many minutes are in 1 degree of angle?",opts:["10","60","100","360"],correct:1,expl:"1 degree = 60 minutes of arc, each minute can itself be divided into seconds or tenths."},
    {q:"Is the DMS (Degrees Minutes Seconds) format used on traditional nautical charts?",opts:["No, never","Yes, it's the traditional nautical chart format","No, only on GPS","Yes, but only in polar zones"],correct:1,expl:"The DMS (Degrees, Minutes, Seconds) format is the historical and traditional format used on nautical charts."},
    {q:"Is the DD (Decimal Degrees) format commonly used by computer systems?",opts:["No, never","Yes, it's the standard format for computer systems and GPS","No, only on paper","Yes, but only for longitude"],correct:1,expl:"The DD (Decimal Degrees) format is widely used by modern software and GPS systems as it facilitates computer calculations."},
    {q:"What does the acronym GMDSS stand for?",opts:["Global Maritime Distress and Safety System","General Marine Data Storage System","Global Marine Direction Sensor System","General Maritime Distance Signal System"],correct:0,expl:"GMDSS stands for Global Maritime Distress and Safety System - the worldwide distress and safety system at sea."},
    {q:"Which GMDSS zone corresponds to coastal VHF coverage?",opts:["Zone A1","Zone A2","Zone A3","Zone A4"],correct:0,expl:"Zone A1 corresponds to coastal VHF coverage, the closest to land."},
    {q:"Which GMDSS zone corresponds to MF coverage (up to about 400 miles)?",opts:["Zone A1","Zone A2","Zone A3","Zone A4"],correct:1,expl:"Zone A2 corresponds to MF (Medium Frequency) coverage, extending to about 400 nautical miles from shore."},
    {q:"Which GMDSS zone corresponds to INMARSAT satellite coverage offshore?",opts:["Zone A1","Zone A2","Zone A3","Zone A4"],correct:2,expl:"Zone A3 corresponds to INMARSAT satellite coverage, outside MF coverage, excluding polar zones."},
    {q:"Which GMDSS zone corresponds to polar zones (HF only)?",opts:["Zone A1","Zone A2","Zone A3","Zone A4"],correct:3,expl:"Zone A4 corresponds to polar zones, not covered by satellite, where only HF (High Frequency) allows communication."},
    {q:"When clicking on the lesson's interactive globe, what information is displayed?",opts:["Local weather","The geographic coordinates of the clicked point","The nearest port's name","Water depth"],correct:1,expl:"The interactive globe tool displays the geographic coordinates (latitude/longitude) of the selected point."},
    {q:"Does the lesson's DMS ↔ DD converter allow instant conversion between formats?",opts:["No, must be calculated by hand","Yes, that's exactly its function","No, it only converts DMS to DM","Yes, but only for latitude"],correct:1,expl:"The interactive converter allows precisely this: instant conversion between DMS, DD and DM formats."},
    {q:"Is the DM (Decimal Minutes) format used by some GPS and ECDIS?",opts:["No, never","Yes, it's a common format on GPS and ECDIS","No, only on paper charts","Yes, but only in zone A4"],correct:1,expl:"The DM (Degrees and decimal Minutes) format is commonly used by many GPS receivers and ECDIS systems."},
    {q:"Once out of MF coverage, which communication means becomes essential offshore?",opts:["Walkie-talkie","INMARSAT satellite (zone A3)","Megaphone","Smoke signals"],correct:1,expl:"Once out of zone A2 (MF), the INMARSAT satellite (zone A3) becomes the essential communication means offshore."},
    {q:"Why is it important to know which GMDSS zone the vessel is navigating in?",opts:["It's not important","To know which communication equipment to use in distress","Only for crew comfort","To calculate the vessel's speed"],correct:1,expl:"Knowing your GMDSS zone tells you which communication equipment (VHF, MF, satellite, HF) remains available in a distress situation."},
  ],
  es:[
    {q:"¿Qué mide la latitud en el globo?",opts:["La distancia Este/Oeste de Greenwich","La distancia Norte/Sur del ecuador","La altitud sobre el nivel del mar","La distancia recorrida desde el puerto de salida"],correct:1,expl:"La latitud mide la posición Norte o Sur respecto al ecuador (0°), de 0° a 90°."},
    {q:"¿Qué mide la longitud en el globo?",opts:["La distancia Norte/Sur del ecuador","La distancia Este/Oeste respecto al meridiano de Greenwich","La profundidad del agua","La velocidad del buque"],correct:1,expl:"La longitud mide la posición Este u Oeste respecto al meridiano de referencia de Greenwich (0°), de 0° a 180°."},
    {q:"¿Cuántos minutos contiene 1 grado de ángulo?",opts:["10","60","100","360"],correct:1,expl:"1 grado = 60 minutos de arco, cada minuto puede a su vez dividirse en segundos o décimas."},
    {q:"¿Se usa el formato DMS (Grados Minutos Segundos) en las cartas náuticas tradicionales?",opts:["No, nunca","Sí, es el formato tradicional de las cartas náuticas","No, solo en GPS","Sí, pero solo en zonas polares"],correct:1,expl:"El formato DMS (Grados, Minutos, Segundos) es el formato histórico y tradicional usado en las cartas náuticas."},
    {q:"¿Se usa comúnmente el formato DD (Grados Decimales) en sistemas informáticos?",opts:["No, nunca","Sí, es el formato estándar de sistemas informáticos y GPS","No, solo en papel","Sí, pero solo para la longitud"],correct:1,expl:"El formato DD (Grados Decimales) es ampliamente usado por software moderno y sistemas GPS porque facilita los cálculos informáticos."},
    {q:"¿Qué significa el acrónimo GMDSS?",opts:["Global Maritime Distress and Safety System","General Marine Data Storage System","Global Marine Direction Sensor System","General Maritime Distance Signal System"],correct:0,expl:"GMDSS significa Global Maritime Distress and Safety System - el sistema mundial de socorro y seguridad marítima."},
    {q:"¿Qué zona GMDSS corresponde a la cobertura VHF costera?",opts:["Zona A1","Zona A2","Zona A3","Zona A4"],correct:0,expl:"La zona A1 corresponde a la cobertura VHF costera, la más cercana a tierra."},
    {q:"¿Qué zona GMDSS corresponde a la cobertura MF (hasta unas 400 millas)?",opts:["Zona A1","Zona A2","Zona A3","Zona A4"],correct:1,expl:"La zona A2 corresponde a la cobertura MF (Media Frecuencia), extendiéndose hasta unas 400 millas náuticas de la costa."},
    {q:"¿Qué zona GMDSS corresponde a la cobertura satelital INMARSAT en alta mar?",opts:["Zona A1","Zona A2","Zona A3","Zona A4"],correct:2,expl:"La zona A3 corresponde a la cobertura por satélite INMARSAT, fuera de la cobertura MF, excluyendo zonas polares."},
    {q:"¿Qué zona GMDSS corresponde a las zonas polares (solo HF)?",opts:["Zona A1","Zona A2","Zona A3","Zona A4"],correct:3,expl:"La zona A4 corresponde a las zonas polares, sin cobertura satelital, donde solo la HF (Alta Frecuencia) permite la comunicación."},
    {q:"Al hacer clic en el globo interactivo de la lección, ¿qué información se muestra?",opts:["El clima local","Las coordenadas geográficas del punto seleccionado","El nombre del puerto más cercano","La profundidad del agua"],correct:1,expl:"La herramienta interactiva del globo muestra las coordenadas geográficas (latitud/longitud) del punto seleccionado."},
    {q:"¿El conversor DMS ↔ DD de la lección permite pasar de un formato a otro instantáneamente?",opts:["No, hay que calcularlo a mano","Sí, es exactamente su función","No, solo convierte DMS a DM","Sí, pero solo para la latitud"],correct:1,expl:"El conversor interactivo permite precisamente esto: conversión instantánea entre los formatos DMS, DD y DM."},
    {q:"¿Se usa el formato DM (Minutos Decimales) en algunos GPS y ECDIS?",opts:["No, nunca","Sí, es un formato común en GPS y ECDIS","No, solo en cartas de papel","Sí, pero solo en zona A4"],correct:1,expl:"El formato DM (Grados y Minutos decimales) es comúnmente usado por muchos receptores GPS y sistemas ECDIS."},
    {q:"Una vez fuera de la cobertura MF, ¿qué medio de comunicación se vuelve esencial en alta mar?",opts:["El walkie-talkie","El satélite INMARSAT (zona A3)","El megáfono","Las señales de humo"],correct:1,expl:"Una vez fuera de la zona A2 (MF), el satélite INMARSAT (zona A3) se vuelve el medio de comunicación esencial en alta mar."},
    {q:"¿Por qué es importante conocer la zona GMDSS en la que navega el buque?",opts:["No es importante","Para saber qué equipo de comunicación usar en caso de socorro","Solo para la comodidad de la tripulación","Para calcular la velocidad del buque"],correct:1,expl:"Conocer tu zona GMDSS permite saber qué equipo de comunicación (VHF, MF, satélite, HF) sigue disponible en una situación de socorro."},
  ],
  pt:[
    {q:"O que a latitude mede no globo?",opts:["A distância Leste/Oeste de Greenwich","A distância Norte/Sul do equador","A altitude acima do nível do mar","A distância percorrida desde o porto de partida"],correct:1,expl:"A latitude mede a posição Norte ou Sul em relação ao equador (0°), de 0° a 90°."},
    {q:"O que a longitude mede no globo?",opts:["A distância Norte/Sul do equador","A distância Leste/Oeste em relação ao meridiano de Greenwich","A profundidade da água","A velocidade do navio"],correct:1,expl:"A longitude mede a posição Leste ou Oeste em relação ao meridiano de referência de Greenwich (0°), de 0° a 180°."},
    {q:"Quantos minutos há em 1 grau de ângulo?",opts:["10","60","100","360"],correct:1,expl:"1 grau = 60 minutos de arco, cada minuto podendo ser dividido em segundos ou décimos."},
    {q:"O formato DMS (Graus Minutos Segundos) é usado nas cartas náuticas tradicionais?",opts:["Não, nunca","Sim, é o formato tradicional das cartas náuticas","Não, apenas em GPS","Sim, mas apenas em zonas polares"],correct:1,expl:"O formato DMS (Graus, Minutos, Segundos) é o formato histórico e tradicional usado nas cartas náuticas."},
    {q:"O formato DD (Graus Decimais) é comumente usado por sistemas informáticos?",opts:["Não, nunca","Sim, é o formato padrão de sistemas informáticos e GPS","Não, apenas em papel","Sim, mas apenas para a longitude"],correct:1,expl:"O formato DD (Graus Decimais) é amplamente usado por software moderno e sistemas GPS porque facilita os cálculos informáticos."},
    {q:"O que significa a sigla GMDSS?",opts:["Global Maritime Distress and Safety System","General Marine Data Storage System","Global Marine Direction Sensor System","General Maritime Distance Signal System"],correct:0,expl:"GMDSS significa Global Maritime Distress and Safety System - o sistema mundial de socorro e segurança marítima."},
    {q:"Que zona GMDSS corresponde à cobertura VHF costeira?",opts:["Zona A1","Zona A2","Zona A3","Zona A4"],correct:0,expl:"A zona A1 corresponde à cobertura VHF costeira, a mais próxima da terra."},
    {q:"Que zona GMDSS corresponde à cobertura MF (até cerca de 400 milhas)?",opts:["Zona A1","Zona A2","Zona A3","Zona A4"],correct:1,expl:"A zona A2 corresponde à cobertura MF (Média Frequência), estendendo-se até cerca de 400 milhas náuticas da costa."},
    {q:"Que zona GMDSS corresponde à cobertura por satélite INMARSAT em alto mar?",opts:["Zona A1","Zona A2","Zona A3","Zona A4"],correct:2,expl:"A zona A3 corresponde à cobertura por satélite INMARSAT, fora da cobertura MF, excluindo zonas polares."},
    {q:"Que zona GMDSS corresponde às zonas polares (apenas HF)?",opts:["Zona A1","Zona A2","Zona A3","Zona A4"],correct:3,expl:"A zona A4 corresponde às zonas polares, sem cobertura por satélite, onde apenas a HF (Alta Frequência) permite a comunicação."},
    {q:"Ao clicar no globo interativo da lição, que informação é exibida?",opts:["O clima local","As coordenadas geográficas do ponto selecionado","O nome do porto mais próximo","A profundidade da água"],correct:1,expl:"A ferramenta interativa do globo exibe as coordenadas geográficas (latitude/longitude) do ponto selecionado."},
    {q:"O conversor DMS ↔ DD da lição permite passar de um formato para outro instantaneamente?",opts:["Não, é preciso calcular à mão","Sim, é exatamente essa a sua função","Não, converte apenas DMS para DM","Sim, mas apenas para a latitude"],correct:1,expl:"O conversor interativo permite precisamente isso: conversão instantânea entre os formatos DMS, DD e DM."},
    {q:"O formato DM (Minutos Decimais) é usado por alguns GPS e ECDIS?",opts:["Não, nunca","Sim, é um formato comum em GPS e ECDIS","Não, apenas em cartas de papel","Sim, mas apenas na zona A4"],correct:1,expl:"O formato DM (Graus e Minutos decimais) é comumente usado por muitos recetores GPS e sistemas ECDIS."},
    {q:"Uma vez fora da cobertura MF, que meio de comunicação se torna essencial em alto mar?",opts:["O walkie-talkie","O satélite INMARSAT (zona A3)","O megafone","Sinais de fumo"],correct:1,expl:"Uma vez fora da zona A2 (MF), o satélite INMARSAT (zona A3) torna-se o meio de comunicação essencial em alto mar."},
    {q:"Por que é importante conhecer a zona GMDSS em que o navio navega?",opts:["Não é importante","Para saber que equipamento de comunicação usar em caso de socorro","Apenas para o conforto da tripulação","Para calcular a velocidade do navio"],correct:1,expl:"Conhecer a sua zona GMDSS permite saber que equipamento de comunicação (VHF, MF, satélite, HF) permanece disponível numa situação de socorro."},
  ],
};
...
function ExerciseScenario3({ lang }) {
  const [ans, setAns] = useState({ q1: "", q2: "", q3: "" });
  const [showC, setShowC] = useState(false);
  const chk = (id, val) => {
    const v = val.trim().toLowerCase();
    if (id === "q1") return v.includes("dd") || v.includes("decimal");
    if (id === "q2") return v === "a3" || v.includes("a3");
    if (id === "q3") return v.includes("inmarsat") || v.includes("satellite") || v.includes("satelite") || v.includes("satélite");
    return false;
  };
  const d = {
    fr: { title: "🌐 Scénario — Sortie de couverture VHF", scenario: "Vous êtes Officier de quart. Le GPS affiche 42.3601, -71.0589. Votre navire s'éloigne progressivement de la côte et va bientôt quitter la zone A1.",
      qs: [
        { id: "q1", q: "1. Sous quel format sont exprimées ces coordonnées GPS (DMS, DD ou DM) ?" },
        { id: "q2", q: "2. Une fois sorti de la couverture MF (zone A2), dans quelle zone GMDSS entrez-vous en pleine mer, hors zones polaires ? (A1/A2/A3/A4)" },
        { id: "q3", q: "3. Quel moyen de communication devient votre principal recours dans cette zone ?" },
      ],
      expl: "✅ Q1 : format DD (Decimal Degrees), utilisé par les systèmes informatiques et GPS grand public\n✅ Q2 : la zone A3, couverte par satellite\n✅ Q3 : le satellite INMARSAT devient le principal moyen de communication en zone A3" },
    en: { title: "🌐 Scenario — Leaving VHF coverage", scenario: "You are Officer of the Watch. The GPS shows 42.3601, -71.0589. Your vessel is gradually moving away from the coast and will soon leave zone A1.",
      qs: [
        { id: "q1", q: "1. In which format are these GPS coordinates expressed (DMS, DD or DM)?" },
        { id: "q2", q: "2. Once out of MF coverage (zone A2), which GMDSS zone do you enter offshore, outside polar zones? (A1/A2/A3/A4)" },
        { id: "q3", q: "3. Which communication means becomes your primary resource in this zone?" },
      ],
      expl: "✅ Q1: DD format (Decimal Degrees), used by computer systems and consumer GPS\n✅ Q2: zone A3, covered by satellite\n✅ Q3: INMARSAT satellite becomes the primary communication means in zone A3" },
    es: { title: "🌐 Escenario — Saliendo de cobertura VHF", scenario: "Eres Oficial de guardia. El GPS muestra 42.3601, -71.0589. Tu buque se aleja progresivamente de la costa y pronto saldrá de la zona A1.",
      qs: [
        { id: "q1", q: "1. ¿En qué formato están expresadas estas coordenadas GPS (DMS, DD o DM)?" },
        { id: "q2", q: "2. Al salir de la cobertura MF (zona A2), ¿a qué zona GMDSS entras en alta mar, fuera de zonas polares? (A1/A2/A3/A4)" },
        { id: "q3", q: "3. ¿Qué medio de comunicación se vuelve tu principal recurso en esa zona?" },
      ],
      expl: "✅ Q1: formato DD (Grados Decimales), usado por sistemas informáticos y GPS de consumo\n✅ Q2: la zona A3, cubierta por satélite\n✅ Q3: el satélite INMARSAT se vuelve el principal medio de comunicación en zona A3" },
    pt: { title: "🌐 Cenário — Saindo da cobertura VHF", scenario: "Você é Oficial de quarto. O GPS mostra 42.3601, -71.0589. O seu navio afasta-se progressivamente da costa e em breve deixará a zona A1.",
      qs: [
        { id: "q1", q: "1. Em que formato estão expressas estas coordenadas GPS (DMS, DD ou DM)?" },
        { id: "q2", q: "2. Ao saír da cobertura MF (zona A2), em que zona GMDSS entra em alto mar, fora de zonas polares? (A1/A2/A3/A4)" },
        { id: "q3", q: "3. Que meio de comunicação se torna o seu principal recurso nessa zona?" },
      ],
      expl: "✅ Q1: formato DD (Graus Decimais), usado por sistemas informáticos e GPS de consumo\n✅ Q2: a zona A3, coberta por satélite\n✅ Q3: o satélite INMARSAT torna-se o principal meio de comunicação na zona A3" },
  };
  const c = d[lang] || d.fr;
  return (
    <Card style={{ marginBottom: 12, border: `1px solid ${C.gold}44`, background: "linear-gradient(135deg,rgba(201,146,42,0.08),rgba(13,31,60,0.8))" }}>
...
const SECTIONS = {
  fr:[
    ...
    { type:"section_title", icon:"📡", text:"PARTIE 5 — ZONES GMDSS" },
    { type:"zones_svg" },
  ...
  en:[
    ...
    { type:"section_title", icon:"📡", text:"PART 5 — GMDSS ZONES" },
    { type:"zones_svg" },
  ...
  es:[
    ...
    { type:"section_title", icon:"📡", text:"PARTE 5 — ZONAS SMSSM" },
    { type:"zones_svg" },
  ...
  pt:[
    ...
    { type:"section_title", icon:"📡", text:"PARTE 5 — ZONAS GMDSS" },
    { type:"zones_svg" },
...
export default function LessonCoord({ lang="fr", onBack=()=>{}, onComplete=()=>{}, onNext=()=>{}, onQuizScored=(score:number,maxScore:number)=>{} }) {
  const t=T[lang]||T.fr;
            ...
            <div style={{paddingTop:10}}>
              <div style={{textAlign:"center",marginBottom:20}}>
                ...
                <div style={{marginTop:14,fontSize:12,color:C.gold2,fontStyle:"italic",lineHeight:1.6,maxWidth:320,marginLeft:"auto",marginRight:"auto"}}>
                  {lang==="fr"?"Savoir se situer, c'est déjà savoir décider. Continue, futur officier de quart.":lang==="en"?"Knowing your position is the first step to good decisions. Keep going, future watchkeeping officer.":lang==="es"?"Saber tu posición es el primer paso para decidir bien. Sigue así, futuro oficial de guardia.":"Saber a sua posição é o primeiro passo para decidir bem. Continue, futuro oficial de quarto."}
                </div>
              </div>
