  ...
  return (
    <div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:5,marginTop:6}}>
        {[{c:C.cool,l:lbl("< 45°C Froid","< 45°C Cold","< 45°C Frio","< 45°C Frio")},{c:C.green,l:lbl("55-60°C OK","55-60°C OK","55-60°C OK","55-60°C OK")},{c:C.hot,l:lbl("> 62°C Max",""> 62°C Max","> 62°C Max","> 62°C Max")}].map((item,i)=>(
...
// MAIN EXPORT
// ══════════════════════════════════════
export default function LessonE6_L5({ lang="fr", onBack=()=>{}, onComplete=()=>{} }) {
  const t = T[lang]||T.fr;
