...
export const QUIZ = {
  fr:[
    {q:"Quelle est la temperature cible pour chauffer un brut lourd avant pompage ?",opts:["25-35°C","40-50°C","50-65°C","75-90°C"],correct:2,expl:"50-65°C est la plage cible pour les bruts lourds. Elle permet d'atteindre une viscosite < 600 cSt, seuil de fonctionnement des pompes cargo centrifuges, tout en restant sous la limite de cokefaction (65°C)."},
    {q:"Quelle est la viscosite maximale pour qu'une pompe centrifuge cargo fonctionne ?",opts:["100 cSt","600 cSt","2000 cSt","5000 cSt"],correct:1,expl:"600 cSt est le seuil critique. Au-dela, la pompe centrifuge cavite et risque de se bloquer. Le chauffage est donc la condition prealable indispensable pour tout brut lourd (API < 20-22)."},
    {q:"Le circuit vapeur-condensats sur un petrolier fonctionne comme suit :",opts:["Vapeur => serpentins => mer","Vapeur => serpentins => hot well => chaudiere","Vapeur => pompes => citernes => mer","Vapeur => scrubber => serpentins"],correct:1,expl:"Le circuit est ferme : la vapeur (7-8 bar) chauffe le cargo via les serpentins, se condense, et les condensats sont recuperes dans le hot well puis pompes vers la chaudiere pour regeneration. Economie d'eau et d'energie."},
    {q:"Le MT Prestige (2002) a illustre le danger du fioul No.6 non chauffe car il :",opts:["A explose en mer","S'est solidifie sur les plages de Galice","A pollue les eaux souterraines","A produit des gaz toxiques"],correct:1,expl:"Le fuel No.6 du Prestige (viscosite > 6000 cSt a temperature ambiante) s'est solidifie en atteignant les plages galiciennes. Ce 'mazout concret' etait quasi-impossible a nettoyer. Cet accident a renforce les exigences MARPOL sur les temperatures minimales de transport."},
    {q:"Quelle propriete du brut determine sa fluidite a temperature ambiante ?",opts:["La temperature flash","L'API gravity (densite)","La pression de vapeur","Le nombre d'octane"],correct:1,expl:"L'API gravity est l'indicateur cle. Brut leger (API > 31) = fluide a temperature ambiante. Brut lourd (API < 22) = visqueux et difficile a pomper sans chauffage. Brut extra-lourd (API < 10) = solide ou semi-solide a temperature ambiante."},
  ],
  en:[
    {q:"What is the target temperature for heating heavy crude before pumping?",opts:["25-35°C","40-50°C","50-65°C","75-90°C"],correct:2,expl:"50-65°C is the target range for heavy crudes. This achieves viscosity < 600 cSt, the operating threshold for centrifugal cargo pumps, while staying below the coking limit (65°C)."},
    {q:"What is the maximum viscosity for a centrifugal cargo pump to work?",opts:["100 cSt","600 cSt","2000 cSt","5000 cSt"],correct:1,expl:"600 cSt is the critical threshold. Beyond this, the centrifugal pump cavitates and risks seizure. Heating is therefore the indispensable prerequisite for any heavy crude (API < 20-22)."},
    {q:"The steam-condensate circuit on a tanker works as follows:",opts:["Steam => coils => sea","Steam => coils => hot well => boiler","Steam => pumps => tanks => sea","Steam => scrubber => coils"],correct:1,expl:"The circuit is closed: steam (7-8 bar) heats cargo via coils, condenses, and condensates are recovered in the hot well then pumped to the boiler for regeneration. Water and energy savings."},
    {q:"The MT Prestige (2002) illustrated the danger of unheated No.6 fuel oil because it:",opts:["Exploded at sea","Solidified on Galician beaches","Polluted groundwater","Produced toxic gases"],correct:1,expl:"The Prestige's No.6 fuel oil (viscosity > 6,000 cSt at ambient temperature) solidified on reaching the Galician beaches. This 'concrete tar' was near-impossible to clean up. This accident strengthened MARPOL requirements on minimum transport temperatures."},
    {q:"Which crude property determines its fluidity at ambient temperature?",opts:["Flash temperature","API gravity (density)","Vapor pressure","Octane number"],correct:1,expl:"API gravity is the key indicator. Light crude (API > 31) = fluid at ambient temperature. Heavy crude (API < 22) = viscous and hard to pump without heating. Extra-heavy (API < 10) = solid or semi-solid at ambient temperature."},
  ],
  es:[
    {q:"?Cual es la temperatura objetivo para calentar un crudo pesado antes del bombeo?",opts:["25-35°C","40-50°C","50-65°C","75-90°C"],correct:2,expl:"50-65°C es el rango objetivo para crudos pesados. Permite alcanzar una viscosidad < 600 cSt, umbral de funcionamiento de las bombas centrifugas, sin superar el limite de coquizacion (65°C)."},
    {q:"?Cual es la viscosidad maxima para que una bomba centrifuga de carga funcione?",opts:["100 cSt","600 cSt","2000 cSt","5000 cSt"],correct:1,expl:"600 cSt es el umbral critico. Por encima, la bomba centrifuga cavita y puede bloquearse. El calentamiento es la condicion previa indispensable para cualquier crudo pesado (API < 20-22)."},
    {q:"El circuito vapor-condensados en un petrolero funciona asi:",opts:["Vapor => serpentines => mar","Vapor => serpentines => hot well => caldera","Vapor => bombas => tanques => mar","Vapor => depurador => serpentines"],correct:1,expl:"El circuito es cerrado: el vapor (7-8 bar) calienta la carga via los serpentines, se condensa, y los condensados se recuperan en el hot well y se bombean de vuelta a la caldera. Ahorro de agua y energia."},
    {q:"El MT Prestige (2002) ilustro el peligro del fuel No.6 sin calentar porque:",opts:["Exploto en el mar","Se solidifico en las playas de Galicia","Contamino las aguas subterraneas","Produjo gases toxicos"],correct:1,expl:"El fuel No.6 del Prestige (viscosidad > 6.000 cSt a temperatura ambiente) se solidifico al llegar a las playas gallegas. Este 'chapapote' era casi imposible de limpiar. Este accidente reforzo las exigencias MARPOL sobre temperaturas minimas de transporte."},
    {q:"?Que propiedad del crudo determina su fluidez a temperatura ambiente?",opts:["Temperatura flash","Gravedad API (densidad)","Presion de vapor","Numero de octano"],correct:1,expl:"La gravedad API es el indicador clave. Crudo ligero (API > 31) = fluido a temperatura ambiente. Crudo pesado (API < 22) = viscoso sin calentamiento. Crudo extra-pesado (API < 10) = solido o semis-solido a temperatura ambiente."},
  ],
  pt:[
    {q:"Qual e a temperatura alvo para aquecer um crude pesado antes da bombagem?",opts:["25-35°C","40-50°C","50-65°C","75-90°C"],correct:2,expl:"50-65°C e a gama alvo para crudes pesados. Permite atingir uma viscosidade < 600 cSt, limiar de funcionamento das bombas centrifugas, sem ultrapassar o limite de coquificacao (65°C)."},
    {q:"Qual e a viscosidade maxima para uma bomba centrifuga de carga funcionar?",opts:["100 cSt","600 cSt","2000 cSt","5000 cSt"],correct:1,expl:"600 cSt e o limiar critico. Acima deste valor, a bomba centrifuga cavia e pode bloquear. O aquecimento e a condicao previa indispensavel para qualquer crude pesado (API < 20-22)."},
    {q:"O circuito vapor-condensados num petroleiro funciona assim:",opts:["Vapor => serpentinas => mar","Vapor => serpentinas => hot well => caldeira","Vapor => bombas => tanques => mar","Vapor => scrubber => serpentinas"],correct:1,expl:"O circuito e fechado: o vapor (7-8 bar) aquece a carga via as serpentinas, condensa-se, e os condensados sao recuperados no hot well e bombeados de volta a caldeira. Poupanca de agua e energia."},
    {q:"O MT Prestige (2002) ilustrou o perigo do fuel No.6 nao aquecido porque:",opts:["Explodiu no mar","Solidificou nas praias da Galiza","Contaminou as aguas subterraneas","Produziu gases toxicos"],correct:1,expl:"O fuel No.6 do Prestige (viscosidade > 6.000 cSt a temperatura ambiente) solidificou ao atingir as praias galegas. Este 'alcatrao concreto' era quase impossivel de limpar. Este acidente reforcou as exigencias MARPOL sobre temperaturas minimas de transporte."},
    {q:"Que propriedade do crude determina a sua fluidez a temperatura ambiente?",opts:["Temperatura flash","API gravity (densidade)","Pressao de vapor","Numero de octano"],correct:1,expl:"A API gravity e o indicador chave. Crude ligeiro (API > 31) = fluido a temperatura ambiente. Crude pesado (API < 22) = viscoso sem aquecimento. Crude extra-pesado (API < 10) = solido ou semi-solido a temperatura ambiente."},
  ],
};
...
// MAIN EXPORT
// ══════════════════════════════════════
export default function LessonE6_L5({ lang="fr", onBack=()=>{}, onComplete=()=>{}, onNext=()=>{}, onQuizScored=(score:number,maxScore:number)=>{} }) {
  const t = T[lang]||T.fr;
