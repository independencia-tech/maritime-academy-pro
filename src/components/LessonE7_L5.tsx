...
function buildBank(lang) {
  ...
  const qs=[
      ...
      {q:lbl("Que signifie DMZ dans un reseau maritime securise ?","What does DMZ mean in a secure maritime network?","Que significa DMZ en una red maritima segura?","O que significa DMZ numa rede maritima segura?"),
        ...
        correct:1,expl:lbl("La DMZ (Demilitarized Zone) est une zone reseau intermediaire entre IT et OT protegee par des firewalls des deux cotes. Elle empeche qu'une compromission du reseau IT atteigne directement les systemes OT critiques.","The DMZ (Demilitarized Zone) is an intermediate network zone between IT and OT protected by firewalls on both sides. It prevents an IT network compromise from directly reaching critical OT systems.","La DMZ es una zona de red intermedia entre IT y OT protegida por firewalls en ambos lados.","A DMZ e uma zona de rede intermediaria entre IT e OT protegida por firewalls dos dois lados.")},
  ...
  return (
    <div>
      ...
      {q.opts.map((opt,i)=>{
        ...
        if(answered){
          if(i===q.correct){bg="rgba(0,230,118,0.12)";brd=C.green;col=C.green;}
...
export const QUIZ={
  fr:[
    {q:"Quelle circulaire IMO definit le cadre cyber maritime obligatoire depuis 2021 ?",
      ...
      correct:0,expl:"IMO MSC-FAL.1/Circ.3 (2017) : directives gestion risques cyber. Resolution IMO MSC-428(98) : depuis le 1er janvier 2021, le Cyber SMS doit etre integre dans le Document de conformite ISM de toute compagnie maritime. Verifie par PSC."},
    {q:"Quelle est la difference critique entre IT et OT en securite maritime ?",
      ...
      correct:1,expl:"IT (Information Technology) = systemes administratifs (emails, cartes, serveurs). OT (Operational Technology) = systemes de controle industriels critiques : AMS, SCADA, governor, telegraph, ballast. Une attaque OT peut mettre le navire en danger physique immediat."},
    {q:"NotPetya 2017 a infecte Maersk via :",
      ...
      correct:1,expl:"NotPetya s'est propage via une mise a jour compromise du logiciel MeDoc (comptabilite ukrainien). Maersk : 45 000 PC detruits, 300M$ pertes, 17 ports paralyses. Supply chain attack = vecteur majeur a surveiller."},
    {q:"Qu'est-ce que le GPS spoofing et quel est son risque principal ?",
      ...
      correct:1,expl:"Le GPS spoofing emet des signaux GPS falsifies plus puissants que le signal reel. Le navire croit etre a une fausse position. Risques : collision, echouage, derivation dans zone dangereuse. Cas documentes en Mer Noire (2017) et Golfe Persique."},
    {q:"Un audit PSC cyber depuis 2021 verifie principalement :",
      ...
      correct:1,expl:"Depuis 2021, les inspecteurs PSC verifient que la gestion des risques cyber est integree dans le Cyber SMS (partie du Document de conformite ISM). Ils examinent : politiques cyber, procedures incident, formation equipage, backups, audit annuel. Non conforme = retenue."},
  ],
  en:[
    {q:"Which IMO circular defines the mandatory maritime cyber framework since 2021?",
      ...
      correct:0,expl:"IMO MSC-FAL.1/Circ.3 (2017): cyber risk management guidelines. IMO Resolution MSC-428(98): since January 1, 2021, Cyber SMS must be integrated in the ISM compliance document of any shipping company. Verified by PSC."},
    {q:"What is the critical difference between IT and OT in maritime security?",
      ...
      correct:1,expl:"IT (Information Technology) = administrative systems (emails, charts, servers). OT (Operational Technology) = critical industrial control systems: AMS, SCADA, governor, telegraph, ballast. An OT attack can put the vessel in immediate physical danger."},
    {q:"NotPetya 2017 infected Maersk via:",
      opts:["Phishing email","Compromised third-party software update (MeDoc)","USB key","Port WiFi"],
      correct:1,expl:"NotPetya spread via a compromised MeDoc software update (Ukrainian accounting). Maersk: 45,000 PCs destroyed, $300M losses, 17 ports paralyzed. Supply chain attack = major vector to monitor."},
    {q:"What is GPS spoofing and its main risk?",
      ...
      correct:1,expl:"GPS spoofing emits falsified GPS signals stronger than the real signal. The vessel believes it is at a false position. Risks: collision, grounding, deviation into dangerous area. Documented cases in Black Sea (2017) and Persian Gulf."},
    {q:"A PSC cyber audit since 2021 mainly verifies:",
      ...
      correct:1,expl:"Since 2021, PSC inspectors verify that cyber risk management is integrated in the Cyber SMS (part of ISM compliance document). They review: cyber policies, incident procedures, crew training, backups, annual audit. Non-compliant = detention."},
  ],
  es:[
    {q:"?Que circular IMO define el marco cyber maritimo obligatorio desde 2021?",
      ...
      correct:0,expl:"IMO MSC-FAL.1/Circ.3 (2017): directrices gestion riesgos cyber. Resolucion IMO MSC-428(98): desde el 1 enero 2021, el Cyber SMS debe integrarse en el Documento de conformidad ISM. Verificado por PSC."},
    {q:"?Cual es la diferencia critica entre IT y OT en seguridad maritima?",
      ...
      correct:1,expl:"IT = sistemas administrativos. OT = sistemas de control industrial criticos: AMS, SCADA, governor, telegrafo, lastre. Un ataque OT puede poner el buque en peligro fisico inmediato."},
    {q:"NotPetya 2017 infecto Maersk via:",
      ...
      correct:1,expl:"NotPetya se propago via una actualizacion comprometida de MeDoc. Maersk: 45.000 PC destruidos, 300M$ perdidas, 17 puertos paralizados."},
    {q:"?Que es el GPS spoofing y cual es su riesgo principal?",
      ...
      correct:1,expl:"El GPS spoofing emite senales GPS falsificadas mas fuertes. El buque cree estar en una posicion falsa. Riesgos: colision, varada. Casos documentados en Mar Negro (2017) y Golfo Persico."},
    {q:"Una auditoria PSC cyber desde 2021 verifica principalmente:",
      ...
      correct:1,expl:"Desde 2021, los inspectores PSC verifican que la gestion cyber esta integrada en el Cyber SMS (parte del Documento de conformidad ISM). No conforme = retencion del buque."},
  ],
  pt:[
    {q:"Qual circular IMO define o quadro cyber maritimo obrigatorio desde 2021?",
      ...
      correct:0,expl:"IMO MSC-FAL.1/Circ.3 (2017): diretrizes gestao riscos cyber. Resolucao IMO MSC-428(98): desde 1 janeiro 2021, o Cyber SMS deve integrar o Documento de conformidade ISM. Verificado pelo PSC."},
    {q:"Qual e a diferenca critica entre IT e OT em seguranca maritima?",
      ...
      correct:1,expl:"IT = sistemas administrativos. OT = sistemas de controlo industrial criticos: AMS, SCADA, governor, telegrafo, lastro. Um ataque OT pode colocar o navio em perigo fisico imediato."},
    {q:"NotPetya 2017 infetou a Maersk via:",
      ...
      correct:1,expl:"NotPetya propagou-se via atualizacao comprometida do MeDoc. Maersk: 45.000 PC destruidos, 300M$ perdas, 17 portos paralisados."},
    {q:"O que e o GPS spoofing e qual o seu risco principal?",
      ...
      correct:1,expl:"O GPS spoofing emite sinais GPS falsificados mais fortes. O navio acredita estar numa posicao falsa. Riscos: colisao, encalhe. Casos documentados no Mar Negro (2017) e Golfo Persico."},
    {q:"Uma auditoria PSC cyber desde 2021 verifica principalmente:",
      ...
      correct:1,expl:"Desde 2021, os inspetores PSC verificam que a gestao cyber esta integrada no Cyber SMS (parte do Documento de conformidade ISM). Nao conforme = detencao do navio."},
  ],
};
...
// ══════════════════════════════════════
export default function LessonE7_L5({ lang="fr", onBack=()=>{}, onComplete=()=>{}, onNext=()=>{}, onQuizScored=(score:number,maxScore:number)=>{} }) {
