...
export const BANK = {
  fr:[
    { q:"Quelle est la définition réglementaire de l'eau de ballast selon la Convention BWM 2004 ?", opts:["L'eau de mer utilisée exclusivement pour le refroidissement des machines","L'eau embarquée pour contrôler l'assiette, la gîte, le tirant d'eau, la stabilité ou les contraintes du navire, y compris ses sédiments","L'eau douce potable stockée pour l'équipage","L'eau résiduelle issue du nettoyage des citernes cargo"], correct:1, expl:"L'eau embarquée à bord d'un navire pour contrôler l'assiette, la gîte, le tirant d'eau, la stabilité ou les contraintes d'un navire, y compris les sédiments qui y sont contenus. (Article 1, Convention BWM 2004)" },
    { q:"Quand la Convention BWM 2004 est-elle entrée en vigueur ?", opts:["2004, date de son adoption","2010","8 septembre 2017, après ratification par 52 États (35% de la jauge brute mondiale)","2020"], correct:2, expl:"Le 8 septembre 2017, après ratification par 52 États représentant 35% de la jauge brute mondiale." },
    { q:"Quelle est la différence entre D-1 et D-2 dans la Convention BWM ?", opts:["D-1 = norme de traitement, D-2 = échange en haute mer (inversé)","D-1 = échange en haute mer (>95% du volume) ; D-2 = norme de traitement (<10 organismes/m³ ≥50µm, limites bactériennes)","Ce sont deux méthodes équivalentes d'échange d'eau","D-1 concerne le carburant, D-2 le ballast"], correct:1, expl:"D-1 = échange d'eau de ballast en haute mer (remplacement > 95% du volume). D-2 = norme de traitement : < 10 organismes viables/m³ de taille ≥ 50µm, < 10 organismes/mL de taille 10-50µm, et limites pour Vibrio cholerae, E. coli, entérocoques." },
    { q:"Pourquoi un pétrolier en lège (ballast voyage) est-il plus vulnérable structurellement ?", opts:["La coque est plus fine sans cargaison","La vitesse de navigation est plus élevée en lège","Le navire flotte haut avec des porte-à-faux excessifs ; les contraintes longitudinales (hogging/sagging) peuvent dépasser les limites si le ballast ne compense pas","Le centre de gravité est anormalement bas"], correct:2, expl:"Sans cargaison, le navire flotte haut, avec des porte-à-faux excessifs entre les zones remplies (machines) et vides. Les contraintes longitudinales (hogging/sagging) peuvent dépasser les limites admissibles si le ballast ne les compense pas." },
    { q:"Qu'est-ce que le 'sagging' et le 'hogging' dans le contexte du ballastage ?", opts:["Hogging = flexion en arc (milieu vers le haut, extrémités surchargées) ; Sagging = flexion en creux (milieu vers le bas, milieu surchargé)","L'inverse : hogging = creux, sagging = arc","Deux termes désignant la même flexion","Des termes relatifs uniquement à la gîte, pas à la flexion longitudinale"], correct:0, expl:"Hogging = flexion en arc (milieu du navire poussé vers le haut) — risque quand les extrémités sont trop chargées. Sagging = flexion en creux (milieu vers le bas) — risque quand le milieu est trop chargé. Les plans de ballastage doivent maintenir ces contraintes dans les limites admissibles de la courbe SF/BM." },
    { q:"Quelles sont les 3 méthodes de traitement BWMS homologuées par l'OMI ?", opts:["Distillation, filtration seule, chloration au chlore libre","Physiques (UV, électromagnétique, cavitation acoustique), chimiques (biocides), hybrides (filtration+UV ou filtration+électrolyse)","Osmose inverse, ébullition, décantation","Une seule méthode homologuée : l'UV"], correct:1, expl:"1. Systèmes physiques : UV, rayonnement électromagnétique, cavitation acoustique. 2. Systèmes chimiques : injection de biocides (chlore actif, ozone, dioxyde de chlore). 3. Systèmes hybrides : filtration + UV ou filtration + électrolyse. Tous doivent être approuvés selon BWMS Code 2016." },
    { q:"Qu'est-ce que l'échange de ballast 'séquentiel' vs 'flux continu' ?", opts:["Séquentiel = vider puis remplir la citerne ; flux continu = pomper 3x le volume en débordant par le haut","L'inverse : séquentiel déborde, flux continu vide puis remplit","Le flux continu ne nécessite qu'1x le volume de la citerne","Ce sont deux noms pour la même procédure"], correct:0, expl:"Séquentiel : vider complètement la citerne puis la remplir avec eau de mer. Flux continu : pomper 3 fois le volume de la citerne tout en débordant par le haut — maintient la stabilité. Les deux doivent se faire à > 200 milles des terres, profondeur > 200m." },
    { q:"Quel est le rôle du Ballast Water Record Book (BWRB) ?", opts:["Registre de la cargaison transportée","Rapport rédigé uniquement en cas d'incident","Journal obligatoire enregistrant chaque opération de ballastage/déballastage, échanges, traitements BWMS ; disponible 2 ans pour inspection PSC","Registre de consommation de carburant"], correct:2, expl:"Journal obligatoire (Convention BWM Règle B-2) enregistrant : chaque opération de ballastage/déballastage, les échanges effectués (date, position, volume, méthode), les traitements BWMS, les circonstances exceptionnelles. Doit être disponible à l'inspection PSC pendant 2 ans." },
    { q:"Pourquoi les citernes de pic avant et arrière (FP/AP) sont-elles particulièrement importantes en ballast ?", opts:["Elles contrôlent uniquement la gîte, pas l'assiette","Elles contrôlent l'assiette : FP plein = piqué avant, AP plein = piqué arrière ; l'assiette optimale en ballast est légèrement sur l'arrière pour l'immersion de l'hélice","Elles ne servent qu'en cas de ballastage d'urgence","Elles n'ont aucun effet sur l'assiette du navire"], correct:1, expl:"Elles contrôlent l'assiette (trim) du navire. FP plein = piqué sur l'avant (by head). AP plein = piqué sur l'arrière (by stern). L'assiette optimale en ballast est légèrement piquée sur l'arrière pour assurer l'immersion de l'hélice et la manœuvrabilité." },
    { q:"Qu'est-ce que la condition 'light ballast' et quand est-elle acceptable ?", opts:["Une condition recommandée en toutes circonstances","Elle concerne uniquement les citernes de carburant","Ballast minimum (<30% des citernes), acceptable seulement en mer calme sur trajet court ; risques : GM faible, contraintes élevées, hélice partiellement émergée","Utilisée pour augmenter la vitesse du navire"], correct:2, expl:"Navigation avec ballast minimum (< 30% des citernes) — acceptable uniquement en mer calme et trajet court. Interdit par certains ports. Risque : GM faible, contraintes structurelles élevées, hélice partiellement émergée = vibrations." },
    { q:"Comment le BWMS Code 2016 diffère-t-il des anciennes directives G8 et G9 ?", opts:["Il assouplit les exigences de G8/G9","Il ne concerne que les navires neufs","Il remplace G8/G9, unifie les procédures d'approbation de type, renforce les essais en conditions réelles, exige une efficacité maintenue sur toute la durée de vie du système","Il supprime l'obligation d'homologation OMI"], correct:2, expl:"BWMS Code 2016 remplace les directives G8 (systèmes de traitement) et G9 (systèmes utilisant substances actives). Il unifie les procédures d'approbation de type, renforce les essais en conditions réelles, exige une efficacité maintenue sur toute la durée de vie du système." },
    { q:"Quelle zone géographique impose les restrictions de ballastage les plus strictes ?", opts:["L'Union européenne","La Chine","Les États-Unis (USCG), norme D-2 obligatoire depuis 2012/2016, certains États comme la Californie encore plus stricts","La zone Arctique uniquement"], correct:2, expl:"Les États-Unis (USCG 33 CFR Part 151 & 46 CFR Part 162) : norme D-2 applicable à tous les navires dans les eaux US depuis 2012 pour les navires neufs, 2016 pour les anciens. Certains États (Californie) ont des exigences encore plus strictes." },
    { q:"Qu'est-ce qu'un 'sounding' de citerne ballast et quelle est la procédure standard ?", opts:["Un test d'étanchéité de la citerne","Une mesure de la densité de l'eau embarquée","Mesure du niveau d'eau (sonde manuelle ou jauge électronique), corrigée pour gîte/assiette via table de capacité, enregistrée au BWRB avant/après opération","Une mesure de température de la citerne"], correct:2, expl:"Mesure du niveau d'eau dans la citerne par sonde manuelle (ullage rod/tape) ou jauge électronique. Procédure : corriger pour la gîte et l'assiette, utiliser la table de capacité/jauge du navire, enregistrer dans le BWRB. Effectué avant et après chaque opération." },
    { q:"Quelle est la relation entre l'effet de carène liquide et le ballastage partiel ?", opts:["Il n'y a aucune relation entre les deux","Le ballastage partiel améliore toujours la stabilité","Une citerne à moitié pleine crée une surface libre maximale, réduisant le GM (ΔGM=ρ×i/Δ) ; il faut remplir ou vider complètement, jamais laisser plusieurs citernes à 50% simultanément","Cela ne concerne que les citernes de carburant"], correct:2, expl:"Une citerne à moitié pleine crée une surface libre maximale → réduction de GM = ΔGM = ρ×i/Δ où i est le moment d'inertie de la surface libre. En pratique : remplir ou vider complètement les citernes, ne jamais laisser plusieurs citernes à 50% simultanément — risque de GM négatif." },
    { q:"Quelles espèces invasives ont été transportées via l'eau de ballast et ont causé des dommages économiques majeurs ?", opts:["Moule zébrée (Amérique du Nord, >1Md$/an), cténophore (Mer Noire, effondrement pêcherie anchois), étoile de mer du Pacifique Nord (Australie), Vibrio cholerae (épidémies choléra, Amérique du Sud, années 1990)","Uniquement des espèces de poissons commerciaux","Aucune espèce invasive documentée à ce jour","Des espèces uniquement présentes en eau douce"], correct:0, expl:"Dreissena polymorpha (moule zébrée) : Amérique du Nord, dégâts > 1 Md$/an. Mnemiopsis leidyi (cténophore) : Mer Noire, effondrement pêcherie anchois. Asterias amurensis (étoile de mer du Pacifique Nord) : Australie. Vibrio cholerae : épidémies de choléra Amérique du Sud années 1990. Ces cas ont motivé la Convention BWM 2004." },
  ],
  en:[
    { q:"What is the regulatory definition of ballast water under the BWM Convention 2004?", opts:["Seawater used exclusively for cooling machinery","Water taken on board to control trim, list, draught, stability or stresses of the ship, including its sediments","Fresh potable water stored for the crew","Residual water from cleaning cargo tanks"], correct:1, expl:"Water taken on board a ship to control trim, list, draught, stability or stresses of the ship, including the sediments suspended therein. (Article 1, BWM Convention 2004)" },
    { q:"When did the BWM Convention 2004 enter into force?", opts:["2004, the year it was adopted","2010","September 8, 2017, after ratification by 52 States (35% of world gross tonnage)","2020"], correct:2, expl:"September 8, 2017, after ratification by 52 States representing 35% of world gross tonnage." },
    { q:"What is the difference between D-1 and D-2 in the BWM Convention?", opts:["D-1 = treatment standard, D-2 = exchange at sea (reversed)","D-1 = ballast water exchange at sea (>95% of volume); D-2 = treatment standard (<10 viable organisms/m³ ≥50µm, bacterial limits)","They are two equivalent exchange methods","D-1 concerns fuel, D-2 concerns ballast"], correct:1, expl:"D-1 = ballast water exchange at sea (replacement > 95% of volume). D-2 = treatment standard: < 10 viable organisms/m³ ≥ 50µm, < 10 organisms/mL of 10-50µm, plus limits for Vibrio cholerae, E. coli, enterococci." },
    { q:"Why is a tanker in ballast voyage structurally more vulnerable?", opts:["The hull is thinner without cargo","Sailing speed is higher when in ballast","The vessel floats high with excessive overhangs; longitudinal stresses (hogging/sagging) can exceed limits if ballast does not compensate","The center of gravity is abnormally low"], correct:2, expl:"Without cargo, the vessel floats high with excessive overhangs between loaded (machinery) and empty sections. Longitudinal stresses (hogging/sagging) can exceed permissible limits if ballast does not compensate." },
    { q:"What are 'sagging' and 'hogging' in the context of ballasting?", opts:["Hogging = arch deflection (midship pushed up, ends overloaded); Sagging = hollow deflection (midship down, midship overloaded)","The reverse: hogging = hollow, sagging = arch","Two terms for the same deflection","Terms relating only to list, not longitudinal bending"], correct:0, expl:"Hogging = arch deflection (midship pushed upward) — risk when ends are overloaded. Sagging = hollow deflection (midship downward) — risk when midship is overloaded. Ballast plans must maintain these stresses within the SF/BM curve limits." },
    { q:"What are the 3 IMO-approved BWMS treatment methods?", opts:["Distillation, filtration alone, free chlorine dosing","Physical (UV, electromagnetic, acoustic cavitation), chemical (biocides), hybrid (filtration+UV or filtration+electrolysis)","Reverse osmosis, boiling, settling","Only one approved method: UV"], correct:1, expl:"1. Physical systems: UV, electromagnetic radiation, acoustic cavitation. 2. Chemical systems: biocide injection (active chlorine, ozone, chlorine dioxide). 3. Hybrid systems: filtration + UV or filtration + electrolysis. All must be approved under BWMS Code 2016." },
    { q:"What is 'sequential' vs 'flow-through' ballast exchange?", opts:["Sequential = empty then refill the tank; flow-through = pump 3x the tank volume while overflowing from the top","The reverse: sequential overflows, flow-through empties then refills","Flow-through only requires 1x the tank volume","These are two names for the same procedure"], correct:0, expl:"Sequential: completely empty the tank then refill with seawater. Flow-through: pump 3 times the tank volume while overflowing from top — maintains stability. Both must be done > 200 nm from land, depth > 200m." },
    { q:"What is the role of the Ballast Water Record Book (BWRB)?", opts:["Log of cargo carried","Report written only in case of an incident","Mandatory log recording each ballasting/deballasting operation, exchanges, BWMS treatments; available 2 years for PSC inspection","Fuel consumption log"], correct:2, expl:"Mandatory log (BWM Convention Rule B-2) recording: each ballasting/deballasting operation, exchanges performed (date, position, volume, method), BWMS treatments, exceptional circumstances. Must be available for PSC inspection for 2 years." },
    { q:"Why are fore peak (FP) and aft peak (AP) tanks particularly important in ballast?", opts:["They control only list, not trim","They control trim: full FP = trimmed by head, full AP = trimmed by stern; optimal ballast trim is slightly by stern for propeller immersion","They are only used for emergency ballasting","They have no effect on the vessel's trim"], correct:1, expl:"They control the vessel's trim. Full FP = trimmed by head. Full AP = trimmed by stern. Optimal trim in ballast is slightly by stern to ensure propeller immersion and maneuverability." },
    { q:"What is the 'light ballast' condition and when is it acceptable?", opts:["A condition recommended in all circumstances","It concerns only fuel tanks","Minimum ballast (<30% of tanks), acceptable only in calm seas on short voyages; risks: low GM, high stresses, partially emerged propeller","Used to increase the vessel's speed"], correct:2, expl:"Navigation with minimum ballast (< 30% of tanks) — acceptable only in calm seas and short voyages. Prohibited by some ports. Risk: low GM, high structural stresses, partially emerged propeller = vibrations." },
    { q:"How does BWMS Code 2016 differ from old G8 and G9 guidelines?", opts:["It relaxes the G8/G9 requirements","It only concerns new vessels","It replaces G8/G9, unifies type approval procedures, strengthens tests under real conditions, requires maintained efficiency over the system's lifetime","It removes the IMO type-approval requirement"], correct:2, expl:"BWMS Code 2016 replaces G8 (treatment systems) and G9 (systems using active substances). It unifies type approval procedures, strengthens tests under real conditions, requires maintained efficiency over system lifetime." },
    { q:"Which geographic zone imposes the strictest ballasting restrictions?", opts:["The European Union","China","The United States (USCG), D-2 standard mandatory since 2012/2016, some states like California even stricter","The Arctic zone only"], correct:2, expl:"United States (USCG 33 CFR Part 151 & 46 CFR Part 162): D-2 standard applicable to all vessels in US waters since 2012 for new ships, 2016 for existing. Some states (California) have even stricter requirements." },
    { q:"What is a ballast tank 'sounding' and what is the standard procedure?", opts:["A tightness test of the tank","A measurement of the density of the water taken on board","Measurement of water level (manual sounding rod or electronic gauge), corrected for list/trim via capacity table, recorded in the BWRB before/after the operation","A temperature measurement of the tank"], correct:2, expl:"Measurement of water level in tank by manual sounding rod (ullage tape) or electronic gauge. Procedure: correct for list and trim, use ship's capacity/gauge table, record in BWRB. Performed before and after each operation." },
    { q:"What is the relationship between free surface effect and partial ballasting?", opts:["There is no relationship between the two","Partial ballasting always improves stability","A half-full tank creates maximum free surface, reducing GM (ΔGM=ρ×i/Δ); tanks must be filled or emptied completely, never leaving several tanks at 50% simultaneously","This only concerns fuel tanks"], correct:2, expl:"A half-full tank creates maximum free surface → GM reduction = ΔGM = ρ×i/Δ where i is the free surface moment of inertia. In practice: fill or empty tanks completely, never leave multiple tanks at 50% simultaneously — risk of negative GM." },
    { q:"Which invasive species transported via ballast water caused major economic damage?", opts:["Zebra mussel (North America, >$1bn/year), ctenophore (Black Sea, anchovy fishery collapse), North Pacific sea star (Australia), Vibrio cholerae (cholera epidemics, South America, 1990s)","Only commercial fish species","No invasive species documented to date","Species found only in fresh water"], correct:0, expl:"Dreissena polymorpha (zebra mussel): North America, damages > $1 billion/year. Mnemiopsis leidyi (ctenophore): Black Sea, anchovy fishery collapse. Asterias amurensis (North Pacific sea star): Australia. Vibrio cholerae: cholera epidemics South America 1990s. These cases motivated the BWM Convention 2004." },
  ],
  es:[
    { q:"¿Cuál es la definición reglamentaria del agua de lastre según el Convenio BWM 2004?", opts:["Agua de mar usada exclusivamente para refrigerar la maquinaria","Agua embarcada para controlar el asiento, la escora, el calado, la estabilidad o los esfuerzos del buque, incluidos sus sedimentos","Agua dulce potable almacenada para la tripulación","Agua residual de la limpieza de los tanques de carga"], correct:1, expl:"Agua embarcada en un buque para controlar el asiento, la escora, el calado, la estabilidad o los esfuerzos del buque, incluidos los sedimentos en suspensión. (Artículo 1, Convenio BWM 2004)" },
    { q:"¿Cuándo entró en vigor el Convenio BWM 2004?", opts:["2004, año de su adopción","2010","8 de septiembre de 2017, tras la ratificación por 52 Estados (35% del arqueo bruto mundial)","2020"], correct:2, expl:"El 8 de septiembre de 2017, tras la ratificación por 52 Estados que representan el 35% del arqueo bruto mundial." },
    { q:"¿Cuál es la diferencia entre D-1 y D-2 en el Convenio BWM?", opts:["D-1 = norma de tratamiento, D-2 = intercambio en alta mar (invertido)","D-1 = intercambio de agua de lastre en alta mar (>95% del volumen); D-2 = norma de tratamiento (<10 organismos viables/m³ ≥50µm, límites bacterianos)","Son dos métodos equivalentes de intercambio de agua","D-1 se refiere al combustible, D-2 al lastre"], correct:1, expl:"D-1 = intercambio de agua de lastre en alta mar (sustitución > 95% del volumen). D-2 = norma de tratamiento: < 10 organismos viables/m³ ≥ 50µm, < 10 organismos/mL de 10-50µm, más límites para Vibrio cholerae, E. coli, enterococos." },
    { q:"¿Por qué un petrolero en lastre es más vulnerable estructuralmente?", opts:["El casco es más fino sin carga","La velocidad de navegación es mayor en lastre","El buque flota alto con voladizos excesivos; los esfuerzos longitudinales (hogging/sagging) pueden superar los límites si el lastre no compensa","El centro de gravedad es anormalmente bajo"], correct:2, expl:"Sin carga, el buque flota alto con voladizos excesivos entre secciones cargadas (máquinas) y vacías. Los esfuerzos longitudinales (hogging/sagging) pueden superar los límites admisibles si el lastre no los compensa." },
    { q:"¿Qué son el 'sagging' y el 'hogging' en el contexto del lastraje?", opts:["Hogging = flexión en arco (centro hacia arriba, extremos sobrecargados); Sagging = flexión cóncava (centro hacia abajo, centro sobrecargado)","Lo contrario: hogging = cóncavo, sagging = arco","Dos términos para la misma flexión","Términos relativos solo a la escora, no a la flexión longitudinal"], correct:0, expl:"Hogging = flexión en arco (centro del buque empujado hacia arriba). Sagging = flexión en cóncavo (centro hacia abajo). Los planes de lastraje deben mantener estos esfuerzos dentro de los límites de la curva SF/BM." },
    { q:"¿Cuáles son los 3 métodos de tratamiento BWMS homologados por la OMI?", opts:["Destilación, filtración sola, cloración con cloro libre","Físicos (UV, electromagnético, cavitación acústica), químicos (biocidas), híbridos (filtración+UV o filtración+electrólisis)","Ósmosis inversa, ebullición, decantación","Un único método homologado: UV"], correct:1, expl:"1. Sistemas físicos: UV, radiación electromagnética, cavitación acústica. 2. Sistemas químicos: inyección de biocidas. 3. Sistemas híbridos: filtración + UV o filtración + electrólisis. Todos deben ser aprobados según BWMS Code 2016." },
    { q:"¿Qué es el intercambio de lastre 'secuencial' vs 'flujo continuo'?", opts:["Secuencial = vaciar y luego llenar el tanque; flujo continuo = bombear 3x el volumen del tanque mientras rebosa por arriba","Lo contrario: secuencial rebosa, flujo continuo vacía y llena","El flujo continuo solo requiere 1x el volumen del tanque","Son dos nombres para el mismo procedimiento"], correct:0, expl:"Secuencial: vaciar completamente el tanque y rellenarlo con agua de mar. Flujo continuo: bombear 3 veces el volumen del tanque mientras rebosa por la parte superior. Ambos a > 200 mn de tierra, profundidad > 200m." },
    { q:"¿Cuál es el papel del Libro de Registro de Agua de Lastre (BWRB)?", opts:["Registro de la carga transportada","Informe redactado solo en caso de incidente","Diario obligatorio que registra cada operación de lastraje/deslastraje, intercambios, tratamientos BWMS; disponible 2 años para inspección PSC","Registro de consumo de combustible"], correct:2, expl:"Diario obligatorio (Regla B-2) que registra: cada operación de lastraje/deslastraje, intercambios realizados, tratamientos BWMS, circunstancias excepcionales. Disponible para inspección PSC durante 2 años." },
    { q:"¿Por qué los piques de proa (FP) y popa (AP) son especialmente importantes en lastre?", opts:["Controlan solo la escora, no el asiento","Controlan el asiento: FP lleno = aprocado, AP lleno = apopado; el asiento óptimo en lastre es ligeramente apopado para la inmersión de la hélice","Solo se usan en lastraje de emergencia","No tienen ningún efecto sobre el asiento del buque"], correct:1, expl:"Controlan el asiento del buque. FP lleno = aprocado. AP lleno = apopado. El asiento óptimo en lastre es ligeramente apopado para asegurar la inmersión de la hélice." },
    { q:"¿Qué es la condición 'lastre mínimo' y cuándo es aceptable?", opts:["Una condición recomendada en todas las circunstancias","Se refiere solo a los tanques de combustible","Lastre mínimo (<30% de los tanques), aceptable solo en mar calmado y trayecto corto; riesgos: GM bajo, esfuerzos altos, hélice parcialmente emergida","Se usa para aumentar la velocidad del buque"], correct:2, expl:"Navegación con lastre mínimo (< 30% de los tanques) — aceptable solo en mar calmado y trayecto corto. Riesgos: GM bajo, esfuerzos estructurales altos, hélice parcialmente emergida." },
    { q:"¿Cómo difiere el BWMS Code 2016 de las antiguas directrices G8 y G9?", opts:["Relaja los requisitos de G8/G9","Solo se aplica a buques nuevos","Reemplaza G8/G9, unifica los procedimientos de aprobación de tipo, refuerza las pruebas en condiciones reales, exige eficiencia mantenida durante toda la vida útil del sistema","Elimina la obligación de homologación de la OMI"], correct:2, expl:"BWMS Code 2016 reemplaza G8 y G9, unifica procedimientos de aprobación de tipo, refuerza pruebas en condiciones reales, exige eficiencia mantenida durante toda la vida útil del sistema." },
    { q:"¿Qué zona geográfica impone las restricciones de lastraje más estrictas?", opts:["La Unión Europea","China","Estados Unidos (USCG), norma D-2 obligatoria desde 2012/2016, algunos estados como California aún más estrictos","Solo la zona Ártica"], correct:2, expl:"Estados Unidos (USCG 33 CFR Part 151 & 46 CFR Part 162): norma D-2 para todos los buques en aguas estadounidenses. California tiene requisitos aún más estrictos." },
    { q:"¿Qué es un 'sounding' de tanque de lastre y cuál es el procedimiento estándar?", opts:["Una prueba de estanqueidad del tanque","Una medición de la densidad del agua embarcada","Medición del nivel de agua (sonda manual o manómetro electrónico), corregida por escora/asiento mediante tabla de capacidad, registrada en el BWRB antes/después de la operación","Una medición de temperatura del tanque"], correct:2, expl:"Medición del nivel de agua en el tanque mediante sonda manual o manómetro electrónico. Corregir por escora y asiento, usar tabla de capacidad del buque, registrar en BWRB." },
    { q:"¿Cuál es la relación entre el efecto de superficie libre y el lastraje parcial?", opts:["No hay relación entre ambos","El lastraje parcial siempre mejora la estabilidad","Un tanque a mitad lleno crea superficie libre máxima, reduciendo el GM (ΔGM=ρ×i/Δ); hay que llenar o vaciar completamente, nunca dejar varios tanques al 50% simultáneamente","Esto solo concierne a los tanques de combustible"], correct:2, expl:"Un tanque a mitad lleno crea superficie libre máxima → reducción GM = ΔGM = ρ×i/Δ. En la práctica: llenar o vaciar completamente los tanques, nunca dejar varios tanques al 50% simultáneamente." },
    { q:"¿Qué especies invasoras transportadas por el agua de lastre causaron daños económicos mayores?", opts:["Mejillón cebra (Norteamérica, >1.000M$/año), cténoforo (Mar Negro, colapso pesquero de anchoa), estrella de mar del Pacífico Norte (Australia), Vibrio cholerae (epidemias de cólera, Sudamérica, años 90)","Solo especies de peces comerciales","Ninguna especie invasora documentada hasta la fecha","Especies presentes solo en agua dulce"], correct:0, expl:"Dreissena polymorpha (mejillón cebra): daños > 1.000 M$/año en Norteamérica. Mnemiopsis leidyi: colapso pesquero en el Mar Negro. Vibrio cholerae: epidemias de cólera en Sudamérica en los 90. Estos casos motivaron el Convenio BWM 2004." },
  ],
  pt:[
    { q:"Qual é a definição regulamentar de água de lastro segundo a Convenção BWM 2004?", opts:["Água do mar usada exclusivamente para arrefecer a maquinaria","Água tomada a bordo para controlar o trim, a escora, o calado, a estabilidade ou os esforços do navio, incluindo os seus sedimentos","Água doce potável armazenada para a tripulação","Água residual da limpeza dos tanques de carga"], correct:1, expl:"Água tomada a bordo de um navio para controlar o trim, a escora, o calado, a estabilidade ou os esforços do navio, incluindo os sedimentos em suspensão. (Artigo 1, Convenção BWM 2004)" },
    { q:"Quando entrou em vigor a Convenção BWM 2004?", opts:["2004, ano da sua adoção","2010","8 de setembro de 2017, após ratificação por 52 Estados (35% da arqueação bruta mundial)","2020"], correct:2, expl:"A 8 de setembro de 2017, após ratificação por 52 Estados representando 35% da arqueação bruta mundial." },
    { q:"Qual é a diferença entre D-1 e D-2 na Convenção BWM?", opts:["D-1 = norma de tratamento, D-2 = troca em alto mar (invertido)","D-1 = troca de água de lastro em alto mar (>95% do volume); D-2 = norma de tratamento (<10 organismos viáveis/m³ ≥50µm, limites bacterianos)","São dois métodos equivalentes de troca de água","D-1 refere-se ao combustível, D-2 ao lastro"], correct:1, expl:"D-1 = troca de água de lastro em alto mar (substituição > 95% do volume). D-2 = norma de tratamento: < 10 organismos viáveis/m³ ≥ 50µm, < 10 organismos/mL de 10-50µm, mais limites para Vibrio cholerae, E. coli, enterococos." },
    { q:"Por que um petroleiro em lastro é mais vulnerável estruturalmente?", opts:["O casco é mais fino sem carga","A velocidade de navegação é maior em lastro","O navio flutua alto com balanços excessivos; os esforços longitudinais (hogging/sagging) podem exceder os limites se o lastro não compensar","O centro de gravidade é anormalmente baixo"], correct:2, expl:"Sem carga, o navio flutua alto com balanços excessivos entre secções carregadas (máquinas) e vazias. Os esforços longitudinais (hogging/sagging) podem exceder os limites admissíveis se o lastro não os compensar." },
    { q:"O que são 'sagging' e 'hogging' no contexto do lastro?", opts:["Hogging = flexão em arco (centro para cima, extremidades sobrecarregadas); Sagging = flexão côncava (centro para baixo, centro sobrecarregado)","O contrário: hogging = côncavo, sagging = arco","Dois termos para a mesma flexão","Termos relativos apenas à escora, não à flexão longitudinal"], correct:0, expl:"Hogging = flexão em arco (meia-nau empurrada para cima). Sagging = flexão côncava (meia-nau para baixo). Os planos de lastro devem manter estes esforços dentro dos limites da curva SF/BM." },
    { q:"Quais são os 3 métodos de tratamento BWMS aprovados pela OMI?", opts:["Destilação, filtração isolada, cloração com cloro livre","Físicos (UV, eletromagnético, cavitação acústica), químicos (biocidas), híbridos (filtração+UV ou filtração+eletrólise)","Osmose inversa, ebulição, decantação","Um único método aprovado: UV"], correct:1, expl:"1. Sistemas físicos: UV, radiação eletromagnética, cavitação acústica. 2. Sistemas químicos: injeção de biocidas. 3. Sistemas híbridos: filtração + UV ou filtração + eletrólise. Todos aprovados pelo BWMS Code 2016." },
    { q:"O que é a troca de lastro 'sequencial' vs 'fluxo contínuo'?", opts:["Sequencial = esvaziar e depois encher o tanque; fluxo contínuo = bombear 3x o volume do tanque enquanto transborda pelo topo","O contrário: sequencial transborda, fluxo contínuo esvazia e enche","O fluxo contínuo requer apenas 1x o volume do tanque","São dois nomes para o mesmo procedimento"], correct:0, expl:"Sequencial: esvaziar completamente o tanque e enchê-lo com água do mar. Fluxo contínuo: bombear 3 vezes o volume do tanque enquanto transborda pelo topo. Ambos a > 200 mn de terra, profundidade > 200m." },
    { q:"Qual é o papel do Livro de Registro de Água de Lastro (BWRB)?", opts:["Registo da carga transportada","Relatório redigido apenas em caso de incidente","Diário obrigatório que regista cada operação de lastro/deslastro, trocas, tratamentos BWMS; disponível 2 anos para inspeção PSC","Registo de consumo de combustível"], correct:2, expl:"Diário obrigatório (Regra B-2) registando: cada operação de lastro/deslastro, trocas efetuadas, tratamentos BWMS, circunstâncias excecionais. Disponível para inspeção PSC durante 2 anos." },
    { q:"Por que os piques de vante (FP) e ré (AP) são especialmente importantes em lastro?", opts:["Controlam apenas a escora, não o trim","Controlam o trim: FP cheio = apruado, AP cheio = apopado; o trim ótimo em lastro é ligeiramente apopado para a imersão da hélice","Só são usados em lastro de emergência","Não têm qualquer efeito sobre o trim do navio"], correct:1, expl:"Controlam o trim do navio. FP cheio = apruado. AP cheio = apopado. O trim ótimo em lastro é ligeiramente apopado para assegurar a imersão da hélice." },
    { q:"O que é a condição 'lastro mínimo' e quando é aceitável?", opts:["Uma condição recomendada em todas as circunstâncias","Refere-se apenas aos tanques de combustível","Lastro mínimo (<30% dos tanques), aceitável apenas em mar calmo e trajeto curto; riscos: GM baixo, esforços elevados, hélice parcialmente emergida","Usada para aumentar a velocidade do navio"], correct:2, expl:"Navegação com lastro mínimo (< 30% dos tanques) — aceitável apenas em mar calmo e trajeto curto. Riscos: GM baixo, esforços estruturais elevados, hélice parcialmente emergida." },
    { q:"Como o BWMS Code 2016 difere das antigas diretrizes G8 e G9?", opts:["Flexibiliza os requisitos de G8/G9","Aplica-se apenas a navios novos","Substitui G8/G9, unifica os procedimentos de aprovação de tipo, reforça os testes em condições reais, exige eficiência mantida durante toda a vida útil do sistema","Elimina a obrigação de homologação da OMI"], correct:2, expl:"BWMS Code 2016 substitui G8 e G9, unifica procedimentos de aprovação de tipo, reforça testes em condições reais, exige eficiência mantida durante toda a vida útil do sistema." },
    { q:"Que zona geográfica impõe restrições de lastro mais estritas?", opts:["A União Europeia","A China","Os Estados Unidos (USCG), norma D-2 obrigatória desde 2012/2016, alguns estados como a Califórnia ainda mais estritos","Apenas a zona Ártica"], correct:2, expl:"Estados Unidos (USCG 33 CFR Part 151 & 46 CFR Part 162): norma D-2 para todos os navios nas águas americanas. Califórnia tem requisitos ainda mais estritos." },
    { q:"O que é um 'sounding' de tanque de lastro e qual é o procedimento padrão?", opts:["Um teste de estanquidade do tanque","Uma medição da densidade da água embarcada","Medição do nível de água (sonda manual ou manómetro eletrónico), corrigida para escora/trim através da tabela de capacidade, registada no BWRB antes/depois da operação","Uma medição de temperatura do tanque"], correct:2, expl:"Medição do nível de água no tanque por sonda manual ou manómetro eletrónico. Corrigir para escora e trim, usar tabela de capacidade do navio, registar no BWRB." },
    { q:"Qual é a relação entre o efeito de superfície livre e o lastro parcial?", opts:["Não há relação entre os dois","O lastro parcial melhora sempre a estabilidade","Um tanque a meio cheio cria superfície livre máxima, reduzindo o GM (ΔGM=ρ×i/Δ); é preciso encher ou esvaziar completamente, nunca deixar vários tanques a 50% simultaneamente","Isto só diz respeito aos tanques de combustível"], correct:2, expl:"Um tanque a meio cheio cria superfície livre máxima → redução GM = ΔGM = ρ×i/Δ. Na prática: encher ou esvaziar completamente os tanques, nunca deixar vários tanques a 50% simultaneamente." },
    { q:"Que espécies invasoras transportadas via água de lastro causaram danos económicos maiores?", opts:["Mexilhão-zebra (América do Norte, >1.000M$/ano), ctenóforo (Mar Negro, colapso da pescaria de anchova), estrela-do-mar do Pacífico Norte (Austrália), Vibrio cholerae (epidemias de cólera, América do Sul, anos 90)","Apenas espécies de peixes comerciais","Nenhuma espécie invasora documentada até à data","Espécies presentes apenas em água doce"], correct:0, expl:"Dreissena polymorpha (mexilhão-zebra): danos > 1.000 M$/ano na América do Norte. Mnemiopsis leidyi: colapso das pescarias no Mar Negro. Vibrio cholerae: epidemias de cólera na América do Sul nos anos 90. Estes casos motivaram a Convenção BWM 2004." },
  ],
};
    ...
    return (
      <div style={{textAlign:"center",padding:"20px 0"}}>
        ...
        <button onClick={()=>setStarted(true)}
          style={{padding:"12px 28px",borderRadius:14,background:`linear-gradient(135deg,${C.purple},${C.blue2})`,border:"none",color:C.navy,fontSize:13,fontWeight:700,cursor:"pointer",letterSpacing:1}}>
    ...
    return (
      <div style={{textAlign:"center",padding:"20px 10px"}}>
        ...
        <button onClick={handleRestart}
          style={{width:"100%",padding:"12px",borderRadius:14,background:"rgba(142,68,173,0.15)",border:`1px solid ${C.purple}55`,color:C.purple,fontSize:13,fontWeight:700,cursor:"pointer"}}>
    ...
    <div>
      <div style={{marginBottom:12}}>
        ...
        <div style={{height:5,background:"rgba(255,255,255,0.07)",borderRadius:4,overflow:"hidden"}}>
          <div style={{height:"100%",width:`${progress}%`,background:`linear-gradient(90deg,${C.purple},${C.blue2})`,borderRadius:4,transition:"width 0.3s"}}/>
        </div>
      </div>
      ...
      <button onClick={handleNext} disabled={!answered}
        style={{width:"100%",padding:"12px",borderRadius:14,background:answered?`linear-gradient(135deg,${C.purple},${C.blue2})`:"rgba(255,255,255,0.05)",border:"none",color:answered?C.navy:C.muted,fontSize:13,fontWeight:700,cursor:answered?"pointer":"default",opacity:answered?1:0.5}}>
...
export const QUIZ = {
  fr:[
    { q:"La Convention BWM 2004 est entrée en vigueur en :", opts:["2004","2010","2017","2020"], correct:2, expl:"La Convention BWM a été adoptée en 2004 mais n'est entrée en vigueur que le 8 septembre 2017, après ratification par 52 États représentant 35% de la jauge brute mondiale." },
    { q:"La norme D-2 de la Convention BWM impose une limite de :", opts:["< 10 organismes/m³ ≥50µm","< 100 organismes/L","< 1 organisme/L","< 50 organismes/m²"], correct:0, expl:"D-2 : < 10 organismes viables/m³ de taille ≥50µm, < 10 organismes/mL de taille 10-50µm, et limites pour Vibrio cholerae, E. coli, entérocoques. Standard précis adopté par l'OMI." },
    { q:"En navigation en lège (ballast voyage), le danger principal est :", opts:["Excès de vitesse","GM insuffisant → risque chavirage","Surchauffe des machines","Corrosion des citernes"], correct:1, expl:"Sans cargaison, le centre de gravité du navire est trop haut → GM peut devenir insuffisant voire négatif. Le ballast est essentiel pour abaisser G et maintenir GM > 0,15m minimum." },
    { q:"L'échange de ballast 'flux continu' (flow-through) nécessite de pomper :", opts:["Le volume exact de la citerne","2× le volume","3× le volume","5× le volume"], correct:2, expl:"La méthode flux continu requiert de pomper 3 fois le volume de la citerne tout en laissant déborder par le dessus. Ceci assure le remplacement de > 95% de l'eau initiale (norme D-1) tout en maintenant la stabilité." },
    { q:"Le MT Erika (1999) a mis en évidence que le ballastage insuffisant provoque :", opts:["Un excès de vitesse","Des contraintes structurelles longitudinales excessives","Un incendie à bord","Une pollution sonore"], correct:1, expl:"L'Erika s'est brisé en deux à cause de contraintes longitudinales (hogging) excessives. La coque corrodée, combinée à un plan de ballastage inadapté aux conditions de mer, n'a pas résisté aux efforts de flexion. Résultat : MARPOL 13G, directive double coque EU, création de l'EMSA." },
  ],
  en:[
    { q:"The BWM Convention 2004 entered into force in:", opts:["2004","2010","2017","2020"], correct:2, expl:"The BWM Convention was adopted in 2004 but only entered into force on September 8, 2017, after ratification by 52 States representing 35% of world gross tonnage." },
    { q:"The D-2 standard of the BWM Convention imposes a limit of:", opts:["< 10 organisms/m³ ≥50µm","< 100 organisms/L","< 1 organism/L","< 50 organisms/m²"], correct:0, expl:"D-2: < 10 viable organisms/m³ ≥50µm, < 10 organisms/mL of 10-50µm, plus limits for Vibrio cholerae, E. coli, enterococci. Precise standard adopted by IMO." },
    { q:"When sailing in ballast voyage, the main danger is:", opts:["Excessive speed","Insufficient GM → capsizing risk","Engine overheating","Tank corrosion"], correct:1, expl:"Without cargo, the vessel's center of gravity is too high → GM can become insufficient or even negative. Ballast is essential to lower G and maintain GM > 0.15m minimum." },
    { q:"The 'flow-through' ballast exchange method requires pumping:", opts:["Exact tank volume","2× the volume","3× the volume","5× the volume"], correct:2, expl:"The flow-through method requires pumping 3 times the tank volume while allowing overflow from the top. This ensures replacement of > 95% of the original water (D-1 standard) while maintaining stability." },
    { q:"The MT Erika (1999) highlighted that insufficient ballasting causes:", opts:["Excessive speed","Excessive longitudinal structural stresses","Fire on board","Noise pollution"], correct:1, expl:"The Erika broke in two due to excessive longitudinal stresses (hogging). The corroded hull, combined with a ballast plan inadequate for sea conditions, could not withstand bending forces. Result: MARPOL 13G, EU double hull directive, creation of EMSA." },
  ],
  es:[
    { q:"El Convenio BWM 2004 entró en vigor en:", opts:["2004","2010","2017","2020"], correct:2, expl:"El Convenio BWM fue adoptado en 2004 pero entró en vigor el 8 de septiembre de 2017, tras la ratificación por 52 Estados que representan el 35% del arqueo bruto mundial." },
    { q:"La norma D-2 del Convenio BWM impone un límite de:", opts:["< 10 organismos/m³ ≥50µm","< 100 organismos/L","< 1 organismo/L","< 50 organismos/m²"], correct:0, expl:"D-2: < 10 organismos viables/m³ ≥50µm, < 10 organismos/mL de 10-50µm, más límites para Vibrio cholerae, E. coli, enterococos." },
    { q:"Navegando en lastre, el peligro principal es:", opts:["Exceso de velocidad","GM insuficiente → riesgo vuelco","Sobrecalentamiento máquinas","Corrosión tanques"], correct:1, expl:"Sin carga, el centro de gravedad es demasiado alto → GM puede volverse insuficiente. El lastre es esencial para mantener GM > 0,15m mínimo." },
    { q:"El método de intercambio de lastre 'flujo continuo' requiere bombear:", opts:["El volumen exacto del tanque","2× el volumen","3× el volumen","5× el volumen"], correct:2, expl:"El método de flujo continuo requiere bombear 3 veces el volumen del tanque mientras rebosa por la parte superior, asegurando sustitución > 95% del agua original." },
    { q:"El MT Erika (1999) demostró que el lastraje insuficiente provoca:", opts:["Exceso de velocidad","Esfuerzos estructurales longitudinales excesivos","Incendio a bordo","Contaminación acústica"], correct:1, expl:"El Erika se partió en dos por esfuerzos longitudinales (hogging) excesivos. Resultado: MARPOL 13G, directiva doble casco UE, creación de EMSA." },
  ],
  pt:[
    { q:"A Convenção BWM 2004 entrou em vigor em:", opts:["2004","2010","2017","2020"], correct:2, expl:"A Convenção BWM foi adotada em 2004 mas só entrou em vigor a 8 de setembro de 2017, após ratificação por 52 Estados representando 35% da arqueação bruta mundial." },
    { q:"A norma D-2 da Convenção BWM impõe um limite de:", opts:["< 10 organismos/m³ ≥50µm","< 100 organismos/L","< 1 organismo/L","< 50 organismos/m²"], correct:0, expl:"D-2: < 10 organismos viáveis/m³ ≥50µm, < 10 organismos/mL de 10-50µm, mais limites para Vibrio cholerae, E. coli, enterococos." },
    { q:"Navegando em lastro, o perigo principal é:", opts:["Excesso de velocidade","GM insuficiente → risco capotamento","Sobreaquecimento das máquinas","Corrosão dos tanques"], correct:1, expl:"Sem carga, o centro de gravidade é demasiado alto → GM pode tornar-se insuficiente. O lastro é essencial para manter GM > 0,15m mínimo." },
    { q:"O método de troca de lastro 'fluxo contínuo' requer bombear:", opts:["O volume exato do tanque","2× o volume","3× o volume","5× o volume"], correct:2, expl:"O método de fluxo contínuo requer bombear 3 vezes o volume do tanque enquanto transborda pelo topo, assegurando substituição > 95% da água original." },
    { q:"O MT Erika (1999) evidenciou que o lastro insuficiente provoca:", opts:["Excesso de velocidade","Esforços estruturais longitudinais excessivos","Incêndio a bordo","Poluição sonora"], correct:1, expl:"O Erika partiu-se em dois devido a esforços longitudinais (hogging) excessivos. Resultado: MARPOL 13G, diretiva duplo casco UE, criação da EMSA." },
  ],
};
...
function QuizComp({ questions, t, onComplete }) {
  ...
  const handleNext = () => {
    if (isLast) { onComplete(score + (sel===q.correct?1:0)); return; }
    setSel(null); setAnswered(false); setIdx(i=>i+1);
  };
  ...
  return (
    <div>
      ...
      {answered && (
        <div style={{padding:"12px",borderRadius:12,background:`rgba(${sel===q.correct?"30,138,74":"192,57,43"},0.1)`,border:`1px solid ${sel===q.correct?C.green:C.red}44`,marginBottom:12}}>
          <div style={{fontSize:12,fontWeight:700,color:sel===q.correct?C.green:C.red,marginBottom:4}}>
