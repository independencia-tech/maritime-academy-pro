...
function QuestionBank({ lang, t, onComplete }) {
  ...
  if(!started) return (
    <div style={{textAlign:"center",padding:"10px 0"}}>
      <div style={{fontSize:12,color:C.muted,marginBottom:14,lineHeight:1.6}}>{lang==="fr"?"15 questions, une a la fois. Prends ton temps.":lang==="en"?"15 questions, one at a time. Take your time.":lang==="es"?"15 preguntas, una a la vez. Tomate tu tiempo.":"15 perguntas, uma de cada vez. Leva o teu tempo."}</div>
...
// MAIN
export default function LessonSafetyS3_L1({ lang="fr", onBack=()=>{}, onComplete=()=>{}, onNext=()=>{} }) {
  const t = T[lang]||T.fr;
      ...
      <div style={{flex:1,overflowY:"auto",padding:"20px 16px 40px",position:"relative",zIndex:1,opacity:vis?1:0,transform:vis?"translateY(0)":"translateY(14px)",transition:"all 0.5s ease"}}>
        <div style={{maxWidth:480,margin:"0 auto"}}>
          ...
          {phase==="content"&&<>
            ...
            <Card style={{marginBottom:14,border:`1px solid ${C.purple}44`,background:"linear-gradient(135deg,rgba(142,68,173,0.08),rgba(13,31,60,0.8))"}}><QuestionBank lang={lang} t={t} onComplete={()=>setBankDone(true)}/></Card>
