...
const T: any = {
  ...
  en: {
    ...
    quiz: [
      { q: "What is the main role of the MSB (Main Switchboard)?", opts: ["Control main engine speed", "Receive generator power and distribute it on board", "Measure motor temperatures", "Regulate steam pressure"], correct: 1, expl: "The MSB receives power from all generating sets and distributes it throughout the vessel via secondary switchboards and distribution circuits." },
      { q: "Which cable type is SOLAS mandatory for fire alarm circuits?", opts: ["Standard XLPE", "LSF halogen-free", "MICC mineral", "SWA armoured"], correct: 2, expl: "MICC cables are SOLAS mandatory for vital circuits that must function during a fire. Their magnesium powder insulation withstands over 1000 degC." },
      { q: "For selectivity, what relationship must exist between breaker ratings?", opts: ["In(ACB) < In(MCCB) < In(MCB)", "In(MCB) < In(MCCB) < In(ACB)", "All breakers must have the same rating", "In(MCCB) = In(ACB)"], correct: 1, expl: "Selectivity requires In(MCB) < In(MCCB) < In(ACB). Thus on a fault, the lowest-rated breaker trips first, leaving upstream circuits energised." },
      { q: "What is the ESB (Emergency Switchboard)?", opts: ["The secondary distribution switchboard", "The switchboard fed by the emergency generator for SOLAS vital circuits", "The main engine control panel", "The generator synchronising panel"], correct: 1, expl: "The ESB is fed by the emergency generator and supplies SOLAS vital circuits (navigation, communication, fire pump, emergency lighting) on MSB failure." },
      { q: "For a 440V / 10 kW / cos phi = 0.85 three-phase motor, what is the approximate nominal current?", opts: ["7.7 A", "15.4 A", "30.8 A", "46.2 A"], correct: 1, expl: "I = P / (sqrt(3) x U x cos phi) = 10000 / (1.732 x 440 x 0.85) = 15.4 A. With motor safety factor (x1.25): 19.3 A." },
    ],
  },
  ...
  es: {
    ...
    quiz: [
      { q: "Cual es la funcion principal del MSB?", opts: ["Controlar la velocidad del motor principal", "Recibir la energia de los grupos y distribuirla a bordo", "Medir las temperaturas de los motores", "Regular la presion del vapor"], correct: 1, expl: "El MSB recibe la energia de todos los grupos electrogenos y la distribuye por todo el buque mediante cuadros secundarios y circuitos de distribucion." },
      { q: "Que tipo de cable es obligatorio segun SOLAS para los circuitos de alarma de incendios?", opts: ["XLPE estandar", "LSF sin halogenos", "MICC mineral", "SWA armado"], correct: 2, expl: "Los cables MICC son obligatorios SOLAS para circuitos vitales que deben funcionar en caso de incendio. Su aislamiento en polvo de magnesio resiste mas de 1000 degC." },
      { q: "Para asegurar la selectividad, que relacion debe existir entre los calibres?", opts: ["In(ACB) < In(MCCB) < In(MCB)", "In(MCB) < In(MCCB) < In(ACB)", "Todos iguales", "In(MCCB) = In(ACB)"], correct: 1, expl: "La selectividad exige In(MCB) < In(MCCB) < In(ACB). En caso de fallo, el disyuntor de menor calibre (mas cercano al fallo) dispara primero." },
      { q: "Que es el ESB?", opts: ["El cuadro de distribucion secundario", "El cuadro alimentado por el grupo de emergencia para circuitos vitales SOLAS", "El panel de control del motor principal", "El panel de sincronizacion"], correct: 1, expl: "El ESB es alimentado por el generador de emergencia y suministra los circuitos vitales SOLAS en caso de fallo del MSB." },
      { q: "Para un motor trifasico 440V / 10 kW / cos phi = 0,85, cual es aproximadamente la corriente nominal?", opts: ["7,7 A", "15,4 A", "30,8 A", "46,2 A"], correct: 1, expl: "I = P / (raiz(3) x U x cos phi) = 10000 / (1,732 x 440 x 0,85) = 15,4 A. Con coeficiente de seguridad (x1,25): 19,3 A." },
    ],
  },
  ...
  pt: {
    ...
    quiz: [
      { q: "Qual e o papel principal do MSB?", opts: ["Controlar a velocidade do motor principal", "Receber energia dos grupos e distribui-la a bordo", "Medir temperaturas dos motores", "Regular a pressao do vapor"], correct: 1, expl: "O MSB recebe energia de todos os grupos geradores e distribui-a pelo navio atraves de quadros secundarios e circuitos de distribuicao." },
      { q: "Que tipo de cabo e obrigatorio segundo o SOLAS para circuitos de alarme de incendio?", opts: ["XLPE padrao", "LSF sem halogenos", "MICC mineral", "SWA armado"], correct: 2, expl: "Os cabos MICC sao obrigatorios SOLAS para circuitos vitais que devem funcionar durante um incendio. O isolamento em po de magnesio resiste a mais de 1000 degC." },
      { q: "Para garantir a seletividade, que relacao deve existir entre os calibres?", opts: ["In(ACB) < In(MCCB) < In(MCB)", "In(MCB) < In(MCCB) < In(ACB)", "Todos iguais", "In(MCCB) = In(ACB)"], correct: 1, expl: "A seletividade exige In(MCB) < In(MCCB) < In(ACB). Em caso de defeito, o disjuntor de menor calibre (mais proximo do defeito) dispara primeiro." },
      { q: "O que e o ESB?", opts: ["O quadro de distribuicao secundario", "O quadro alimentado pelo gerador de emergencia para circuitos vitais SOLAS", "O painel de controlo do motor principal", "O painel de sincronizacao"], correct: 1, expl: "O ESB e alimentado pelo gerador de emergencia e fornece os circuitos vitais SOLAS em caso de falha do MSB." },
      { q: "Para um motor trifasico 440V / 10 kW / cos phi = 0,85, qual e aproximadamente a corrente nominal?", opts: ["7,7 A", "15,4 A", "30,8 A", "46,2 A"], correct: 1, expl: "I = P / (raiz(3) x U x cos phi) = 10000 / (1,732 x 440 x 0,85) = 15,4 A. Com fator de seguranca (x1,25): 19,3 A." },
    ],
  },
};
