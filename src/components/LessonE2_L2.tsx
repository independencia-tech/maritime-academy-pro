...
const T: any = {
  fr: {
    ...
    quiz: [
      { q: "A quelle pression sont chargees les bouteilles d'air de demarrage du moteur principal ?", opts: ["6-7 bar", "13-15 bar", "25-30 bar", "50-60 bar"], correct: 2, expl: "Les bouteilles d'air de demarrage sont chargees a 25-30 bar pour fournir l'energie suffisante au demarrage du moteur principal. Selon SOLAS, elles doivent permettre 12 demarrages consecutifs minimum." },
      { q: "Quel est le role du refrigerant interetage (intercooler) sur un compresseur ?", opts: ["Filtrer les impuretes de l'air", "Refroidir l'air entre les etages pour ameliorer le rendement", "Separer l'eau condensee", "Augmenter la pression"], correct: 1, expl: "L'intercooler refroidit l'air entre les etages de compression. Cela ameliore le rendement (compression plus proche de l'isotherme), reduit la temperature (protection des joints et huiles) et augmente la densite de l'air entrant dans l'etage suivant." },
      { q: "Pourquoi doit-on purger les bouteilles d'air avant le demarrage du moteur principal ?", opts: ["Pour augmenter la pression disponible", "Pour eliminer l'eau condensee et eviter un coup d'eau", "Pour refroidir l'air comprime", "Pour verifier la pression"], correct: 1, expl: "Les bouteilles doivent etre purgees pour eliminer l'eau condensee accumulee. Si cette eau entre dans les cylindres avec l'air de demarrage, elle peut provoquer un coup d'eau qui brise les bielles et pistons." },
      { q: "A quel pourcentage au-dessus de la pression de service est reglee la soupape de surete d'un compresseur ?", opts: ["5%", "10%", "20%", "50%"], correct: 1, expl: "La soupape de surete est reglee a 10% au-dessus de la pression maximale de service. Pour une bouteille de 25 bar, la soupape s'ouvre a 27,5 bar. Pour 30 bar, elle s'ouvre a 33 bar." },
      { q: "Quelle est la pression typique de l'air de service utilise pour les outils et les commandes pneumatiques ?", opts: ["1 bar", "6-7 bar", "25-30 bar", "100 bar"], correct: 1, expl: "L'air de service est a 6-7 bar, produit par un compresseur de service independant. Cette pression est suffisante pour les outils pneumatiques, les commandes de vannes automatiques et le nettoyage. L'air de demarrage (25-30 bar) est distinct et reserve aux demarrages." },
    ],
  },
  ...
  en: {
    ...
    quiz: [
      { q: "At what pressure are main engine starting air bottles charged?", opts: ["6-7 bar", "13-15 bar", "25-30 bar", "50-60 bar"], correct: 2, expl: "Starting air bottles are charged to 25-30 bar to provide sufficient energy for main engine starting. Per SOLAS, they must allow a minimum of 12 consecutive starts." },
      { q: "What is the role of the intercooler on a compressor?", opts: ["Filter air impurities", "Cool air between stages to improve efficiency", "Separate condensed water", "Increase pressure"], correct: 1, expl: "The intercooler cools air between compression stages. This improves efficiency (compression closer to isothermal), reduces temperature (protecting seals and oils) and increases air density entering the next stage." },
      { q: "Why must air bottles be drained before main engine starting?", opts: ["To increase available pressure", "To remove condensed water and prevent water slug", "To cool the compressed air", "To check pressure"], correct: 1, expl: "Bottles must be drained to remove accumulated condensed water. If this water enters cylinders with starting air, it can cause a water slug that breaks connecting rods and pistons." },
      { q: "At what percentage above service pressure is a compressor safety valve set?", opts: ["5%", "10%", "20%", "50%"], correct: 1, expl: "The safety valve is set at 10% above maximum service pressure. For a 25 bar bottle, it opens at 27.5 bar. For 30 bar, it opens at 33 bar." },
      { q: "What is the typical pressure of service air used for tools and pneumatic controls?", opts: ["1 bar", "6-7 bar", "25-30 bar", "100 bar"], correct: 1, expl: "Service air is at 6-7 bar, produced by an independent service compressor. Sufficient for pneumatic tools, automatic valve controls and cleaning. Starting air (25-30 bar) is separate and reserved for starts." },
    ],
  },
  ...
  es: {
    ...
    quiz: [
      { q: "A que presion se cargan las botellas de aire de arranque del motor principal?", opts: ["6-7 bar", "13-15 bar", "25-30 bar", "50-60 bar"], correct: 2, expl: "Las botellas se cargan a 25-30 bar para proporcionar energia suficiente al arranque. Segun SOLAS, deben permitir al menos 12 arranques consecutivos." },
      { q: "Cual es la funcion del refrigerante interetapa (intercooler) en un compresor?", opts: ["Filtrar las impurezas del aire", "Enfriar el aire entre etapas para mejorar el rendimiento", "Separar el agua condensada", "Aumentar la presion"], correct: 1, expl: "El intercooler enfria el aire entre etapas de compresion. Mejora el rendimiento, reduce la temperatura (proteccion de cierres y aceites) y aumenta la densidad del aire entrante." },
      { q: "Por que hay que purgar las botellas de aire antes del arranque del motor principal?", opts: ["Para aumentar la presion disponible", "Para eliminar el agua condensada y evitar un golpe de agua", "Para enfriar el aire comprimido", "Para verificar la presion"], correct: 1, expl: "Para eliminar el agua condensada acumulada. Si entra en los cilindros con el aire de arranque, puede causar un golpe de agua que rompe bielas y pistones." },
      { q: "Al que porcentaje por encima de la presion de servicio se ajusta la valvula de seguridad?", opts: ["5%", "10%", "20%", "50%"], correct: 1, expl: "La valvula de seguridad se ajusta al 10% por encima de la presion maxima de servicio. Para 25 bar, se abre a 27,5 bar. Para 30 bar, a 33 bar." },
      { q: "Cual es la presion tipica del aire de servicio usado para herramientas y mandos neumaticos?", opts: ["1 bar", "6-7 bar", "25-30 bar", "100 bar"], correct: 1, expl: "El aire de servicio esta a 6-7 bar, producido por un compresor de servicio independiente. Suficiente para herramientas neumaticas y mandos. El aire de arranque (25-30 bar) esta reservado para los arranques." },
    ],
  },
  ...
  pt: {
    ...
    quiz: [
      { q: "A que pressao sao carregadas as garrafas de ar de arranque do motor principal?", opts: ["6-7 bar", "13-15 bar", "25-30 bar", "50-60 bar"], correct: 2, expl: "As garrafas sao carregadas a 25-30 bar para fornecer energia suficiente ao arranque. Segundo o SOLAS, devem permitir pelo menos 12 arranques consecutivos." },
      { q: "Qual e o papel do arrefecedor interstadial (intercooler) num compressor?", opts: ["Filtrar impurezas do ar", "Arrefecer o ar entre estadios para melhorar o rendimento", "Separar a agua condensada", "Aumentar a pressao"], correct: 1, expl: "O intercooler arrefece o ar entre estadios de compressao. Melhora o rendimento, reduz a temperatura (protecao de vedacoes e oleos) e aumenta a densidade do ar entrante." },
      { q: "Por que se devem purgar as garrafas de ar antes do arranque do motor principal?", opts: ["Para aumentar a pressao disponivel", "Para eliminar a agua condensada e evitar um golpe de agua", "Para arrefecer o ar comprimido", "Para verificar a pressao"], correct: 1, expl: "Para eliminar a agua condensada acumulada. Se entrar nos cilindros com o ar de arranque, pode causar um golpe de agua que parte bielas e pistoes." },
      { q: "A que percentagem acima da pressao de servico esta regulada a valvula de seguranca?", opts: ["5%", "10%", "20%", "50%"], correct: 1, expl: "A valvula de seguranca esta regulada a 10% acima da pressao maxima de servico. Para 25 bar, abre a 27,5 bar. Para 30 bar, a 33 bar." },
      { q: "Qual e a pressao tipica do ar de servico usado para ferramentas e comandos pneumaticos?", opts: ["1 bar", "6-7 bar", "25-30 bar", "100 bar"], correct: 1, expl: "O ar de servico esta a 6-7 bar, produzido por um compressor de servico independente. Suficiente para ferramentas pneumaticas e comandos. O ar de arranque (25-30 bar) e distinto e reservado para arranques." },
    ],
  },
};
export const QUIZ = { fr: T.fr.quiz, en: T.en.quiz, es: T.es.quiz, pt: T.pt.quiz };
export const BANK = { fr: T.fr.bankQuestions, en: T.en.bankQuestions, es: T.es.bankQuestions, pt: T.pt.bankQuestions };
...
export default function LessonE2_L2({ lang="fr", onBack, onComplete, onQuizScored }:{ lang?:string; onBack:()=>void; onComplete?:(xp?:number)=>void; onQuizScored?:(score:number,maxScore:number)=>void; }) {
  const t = T[lang] || T.fr;
  ...
  const lessonOf=lang==="fr"?"Leçon 2/7":lang==="en"?"Lesson 2/7":lang==="es"?"Lección 2/7":"Lição 2/7";
  const badgeText=lang==="fr"?`💨 ${moduleFull} · Leçon 2/7 · ⭐ Premium · 200 XP`:lang==="en"?`💨 ${moduleFull} · Lesson 2/7 · ⭐ Premium · 200 XP`:lang==="es"?`💨 ${moduleFull} · Lección 2/7 · ⭐ Premium · 200 XP`:`💨 ${moduleFull} · Lição 2/7 · ⭐ Premium · 200 XP`;
    ...
    <div style={{position:"sticky",top:0,zIndex:100,background:"rgba(6,14,26,0.97)",backdropFilter:"blur(14px)",borderBottom:`1px solid ${C.cyan}33`}}>
      <div style={{display:"flex",alignItems:"center",gap:10,padding:"0 14px",height:52}}>
        ...
        <div style={{flex:1,minWidth:0}}>
          <div style={{fontSize:10,color:C.cyan,letterSpacing:1,fontFamily:"'Cinzel',serif"}}>💨 {moduleFull}{subtitle&&" · "+subtitle}</div>
  ...
  if(phase==="content") return(
    <div style={{minHeight:"100vh",background:`linear-gradient(160deg,${C.navy3},${C.navy})`,color:C.white,fontFamily:"'Nunito',sans-serif"}}>
      ...
      <div style={{padding:"14px 14px 80px"}}>
        ...
        <button disabled={!bankDone} onClick={()=>{if(bankDone)setPhase("quiz");}} style={{opacity:bankDone?1:0.45,cursor:bankDone?"pointer":"not-allowed",width:"100%",padding:"16px 0",borderRadius:14,background:`linear-gradient(135deg,${C.cyan},${C.blue})`,border:"none",fontFamily:"'Cinzel',serif",fontSize:15,fontWeight:700,letterSpacing:2,color:C.navy}}>🔧 {t.quizCTA}</button>
      </div>
    </div>
  );
