...
function O2AtmosphereSVG({ lang }) {
  ...
  const zoneLabel = {
    asphyxia: lbl("< 2% - ASPHYXIE IMMEDIATE","< 2% - IMMEDIATE ASPHYXIA","< 2% - ASFIXIA INMEDIATA","< 2% - ASFIXIA IMEDIATA"),
    inert:    lbl("2-8% - ZONE INERTE OK","2-8% - INERT ZONE OK","2-8% - ZONA INERTE OK","2-8% - ZONA INERTE OK"),
    danger:   lbl("8-11% - ZONE CRITIQUE","8-11% - CRITICAL ZONE","8-11% - ZONA CRITICA","8-11% - ZONA CRITICA"),
    flammable:lbl("11-21% - ZONE INFLAMMABLE","11-21% - FLAMMABLE ZONE","11-21% - ZONA INFLAMABLE","11-21% - ZONA INFLAMAVEL"),
...
// ══════════════════════════════════════
  export const BANK = {
    fr:[
      {q:"Quel est le composant IGS qui refroidit et nettoie les gaz de combustion ?",opts:["Soufflante","Scrubber","Non-return valve","PV breaker"],correct:1,expl:"Le scrubber (épurateur) refroidit les fumées avec de l'eau de mer et élimine SO₂, suies et H₂S. Sans scrubber, les gaz corrosifs endommagent les citernes."},
      {q:"La limite O₂ réglementaire (SOLAS) dans une citerne cargo inertée est :",opts:["< 5%","< 8%","< 11%","< 15%"],correct:1,expl:"SOLAS règle II-2/4 : O₂ < 8% dans les citernes cargo. En dessous de 8%, le mélange air/hydrocarbures sort de la zone d'explosivité."},
      {q:"Le gaz inerte produit par une chaudière pétrolier contient principalement :",opts:["Azote pur","CO₂ + N₂ (12-14% CO₂)","Argon","Vapeur d'eau"],correct:1,expl:"Les fumées de combustion d'une chaudière contiennent 12-14% CO₂ + N₂ + traces CO. Ce mélange, une fois lavé par le scrubber, constitue le gaz inerte."},
      {q:"Pourquoi la pression dans les citernes doit-elle rester POSITIVE pendant le déchargement ?",opts:["Pour pomper plus vite","Pour éviter l'aspiration d'air (O₂)","Pour réduire la viscosité","Pour refroidir le cargo"],correct:1,expl:"Si la pression devient négative (dépression), l'air extérieur (21% O₂) est aspiré → le mélange redevient explosif. La surpression positive IGS est critique en déchargement."},
      {q:"La non-return valve sur la tuyauterie IGS sert à :",opts:["Réguler le débit de gaz","Empêcher les vapeurs cargo de remonter","Mesurer la pression","Filtrer les particules"],correct:1,expl:"La non-return valve (clapet anti-retour) empêche les vapeurs d'hydrocarbures sous pression de refluer vers le scrubber et la chaudière — ce qui provoquerait une explosion."},
      {q:"Sur quel type de pétrolier l'IGS est-il OBLIGATOIRE selon SOLAS ?",opts:["> 10 000 tdw","> 20 000 tdw","> 50 000 tdw","> 100 000 tdw"],correct:1,expl:"SOLAS régulation II-2/4 (amendement 1981, en vigueur 1983) : IGS obligatoire sur tous les pétroliers de plus de 20 000 tdw et sur les chimiquier de plus de 8 000 tdw."},
      {q:"La soufflante (blower) du système IGS a pour rôle :",opts:["Refroidir le gaz","Laver le gaz","Maintenir la surpression dans les citernes","Mesurer O₂"],correct:2,expl:"La soufflante (ventilateur centrifuge) crée et maintient la surpression positive (+50 à +150 mmWC) dans les citernes via la tuyauterie de pont. C'est le 'moteur' de distribution du gaz inerte."},
      {q:"Lors de l'inertage initial d'une citerne (21% → < 8% O₂), on parle de :",opts:["Purge","Gazage","Dégazage","Mixing"],correct:0,expl:"La purge (purging) consiste à injecter du gaz inerte dans une citerne contenant de l'air (21% O₂) pour diluer l'O₂ jusqu'à < 8%. Ne pas confondre avec le dégazage (gas-freeing) qui est l'opération inverse."},
      {q:"Le dégazage (gas-freeing) consiste à :",opts:["Injecter du gaz inerte","Ventiler la citerne à l'air jusqu'à < 1% LFL","Mesurer la teneur en CO₂","Remplir la citerne d'eau"],correct:1,expl:"Le dégazage (gas-freeing) consiste à ventiler la citerne avec de l'air frais pour éliminer les vapeurs d'hydrocarbures jusqu'à < 1% LFL (Lower Flammable Limit). Préalable obligatoire aux travaux en espace clos."},
      {q:"Le PV breaker (pressure/vacuum breaker) se déclenche automatiquement quand :",opts:["O₂ > 8%","Surpression > +2000 Pa ou dépression < -350 Pa","T° > 50°C","Débit > 5000 m³/h"],correct:1,expl:"Le PV breaker protège mécaniquement la citerne contre les surpressions excessives (> +2000 Pa → ouverture vers atmosphère) et les dépressions (< -350 Pa → aspiration d'air). C'est le dernier recours si la régulation normale échoue."},
      {q:"Pendant le chargement du cargo, l'IGS fonctionne en :",opts:["Mode échange","Mode retour (vapeurs → pont)","Mode surpression continue","Mode arrêt"],correct:1,expl:"Pendant le chargement, le cargo pousse les vapeurs d'hydrocarbures hors de la citerne. Ces vapeurs partent par la tuyauterie de retour vapeurs (Vapour Return Line) vers le terminal. L'IGS maintient la pression positive mais ne souffle plus activement."},
      {q:"Le MT Betelgeuse (1979) a démontré que sans IGS :",opts:["Le déchargement est plus lent","Les vapeurs + air forment un mélange explosif","La corrosion s'accélère","La viscosité augmente"],correct:1,expl:"Le Betelgeuse a explosé car les citernes non inertées contenaient un mélange air/vapeurs d'hydrocarbures dans la zone explosive (11-21% O₂). L'IGS rendu obligatoire par SOLAS après cet accident a évité de nombreuses catastrophes similaires."},
      {q:"La concentration de CO₂ dans le gaz inerte produit par chaudière est :",opts:["1-3%","5-8%","12-14%","18-20%"],correct:2,expl:"Les fumées d'une chaudière fonctionnant correctement contiennent 12-14% de CO₂. Cette valeur élevée de CO₂ (gaz inerte) est ce qui permet de maintenir O₂ < 8% dans les citernes par dilution."},
      {q:"L'analyseur O₂ en entrée de citerne déclenche l'arrêt automatique de l'IGS si :",opts:["O₂ < 2%","O₂ > 8%","CO₂ > 15%","Pression > 200 mmWC"],correct:1,expl:"Si l'analyseur O₂ en aval du scrubber détecte O₂ > 8% dans le gaz inerte avant son entrée en citerne, il déclenche l'arrêt automatique de l'IGS (isolation automatique). Envoyer un gaz à > 8% O₂ dans la citerne annulerait l'inertage."},
      {q:"Quelle est la plage de pression normale de maintien du système IGS dans les citernes ?",opts:["+10 à +30 mmWC","+50 à +150 mmWC","+200 à +500 mmWC","+500 à +1000 mmWC"],correct:1,expl:"+50 à +150 mmWC (millimètres de colonne d'eau). Cette faible surpression est suffisante pour empêcher l'aspiration d'air tout en évitant de contraindre excessivement la structure des citernes."},
    ],
    en:[
      {q:"Which IGS component cools and cleans the combustion gases?",opts:["Blower","Scrubber","Non-return valve","PV breaker"],correct:1,expl:"The scrubber cools the flue gases with seawater and removes SO₂, soot and H₂S. Without the scrubber, corrosive gases would damage the tanks."},
      {q:"The regulatory O₂ limit (SOLAS) in an inerted cargo tank is:",opts:["< 5%","< 8%","< 11%","< 15%"],correct:1,expl:"SOLAS regulation II-2/4: O₂ < 8% in cargo tanks. Below 8%, the air/hydrocarbon mixture is outside the explosive range."},
      {q:"The inert gas produced by a tanker boiler mainly contains:",opts:["Pure nitrogen","CO₂ + N₂ (12-14% CO₂)","Argon","Water vapor"],correct:1,expl:"Boiler combustion flue gas contains 12-14% CO₂ + N₂ + CO traces. This mixture, once washed by the scrubber, constitutes the inert gas."},
      {q:"Why must tank pressure remain POSITIVE during discharge?",opts:["To pump faster","To prevent air ingress (O₂)","To reduce viscosity","To cool the cargo"],correct:1,expl:"If pressure becomes negative, outside air (21% O₂) is drawn in → the mixture becomes explosive again. Positive IGS overpressure is critical during discharge."},
      {q:"The non-return valve on the IGS piping serves to:",opts:["Regulate gas flow","Prevent cargo vapors from flowing back","Measure pressure","Filter particles"],correct:1,expl:"The non-return valve prevents pressurized hydrocarbon vapors from flowing back toward the scrubber and boiler — which would cause an explosion."},
      {q:"On which type of tanker is IGS MANDATORY under SOLAS?",opts:["> 10,000 DWT","> 20,000 DWT","> 50,000 DWT","> 100,000 DWT"],correct:1,expl:"SOLAS regulation II-2/4 (1981 amendment, in force 1983): IGS mandatory on all tankers over 20,000 DWT and chemical tankers over 8,000 DWT."},
      {q:"The IGS blower's role is to:",opts:["Cool the gas","Wash the gas","Maintain overpressure in tanks","Measure O₂"],correct:2,expl:"The blower (centrifugal fan) creates and maintains positive overpressure (+50 to +150 mmWC) in tanks via the deck piping. It is the 'engine' for inert gas distribution."},
      {q:"When initially inerting a tank (21% → < 8% O₂), the process is called:",opts:["Purging","Gassing","Gas-freeing","Mixing"],correct:0,expl:"Purging consists of injecting inert gas into a tank containing air (21% O₂) to dilute O₂ to < 8%. Not to be confused with gas-freeing, which is the opposite operation."},
      {q:"Gas-freeing consists of:",opts:["Injecting inert gas","Ventilating the tank with air until < 1% LFL","Measuring CO₂ content","Filling the tank with water"],correct:1,expl:"Gas-freeing consists of ventilating the tank with fresh air to eliminate hydrocarbon vapors to < 1% LFL. Mandatory prerequisite for confined space entry."},
      {q:"The PV breaker (pressure/vacuum breaker) triggers automatically when:",opts:["O₂ > 8%","Overpressure > +2000 Pa or vacuum < -350 Pa","T° > 50°C","Flow > 5000 m³/h"],correct:1,expl:"The PV breaker mechanically protects the tank against excessive overpressure (> +2000 Pa → opens to atmosphere) and vacuum (< -350 Pa → air ingress). It is the last resort if normal regulation fails."},
      {q:"During cargo loading, the IGS operates in:",opts:["Exchange mode","Return mode (vapors → deck)","Continuous overpressure mode","Shutdown mode"],correct:1,expl:"During loading, cargo pushes hydrocarbon vapors out of the tank. These vapors exit via the Vapour Return Line to the terminal. IGS maintains positive pressure but no longer actively blows."},
      {q:"The MT Betelgeuse (1979) demonstrated that without IGS:",opts:["Discharge is slower","Vapors + air form an explosive mixture","Corrosion accelerates","Viscosity increases"],correct:1,expl:"Betelgeuse exploded because uninerted tanks contained an air/hydrocarbon vapor mixture in the explosive range (11-21% O₂). IGS made mandatory by SOLAS after this accident has prevented many similar disasters."},
      {q:"CO₂ concentration in boiler-produced inert gas is:",opts:["1-3%","5-8%","12-14%","18-20%"],correct:2,expl:"A correctly operating boiler's flue gas contains 12-14% CO₂. This high CO₂ concentration is what allows O₂ to be maintained below 8% in tanks by dilution."},
      {q:"The inlet O₂ analyser triggers automatic IGS shutdown if:",opts:["O₂ < 2%","O₂ > 8%","CO₂ > 15%","Pressure > 200 mmWC"],correct:1,expl:"If the O₂ analyser downstream of the scrubber detects O₂ > 8% in the inert gas before tank entry, it triggers automatic IGS shutdown. Sending gas at > 8% O₂ into the tank would nullify inerting."},
      {q:"What is the normal IGS maintenance pressure range in tanks?",opts:["+10 to +30 mmWC","+50 to +150 mmWC","+200 to +500 mmWC","+500 to +1000 mmWC"],correct:1,expl:"+50 to +150 mmWC (millimeters of water column). This low overpressure is sufficient to prevent air ingress while avoiding excessive structural stress on tanks."},
    ],
    es:[
      {q:"¿Qué componente del IGS enfría y limpia los gases de combustión?",opts:["Soplante","Depurador (scrubber)","Válvula anti-retorno","Válvula PV"],correct:1,expl:"El scrubber (depurador) enfría los gases con agua de mar y elimina SO₂, hollín y H₂S. Sin scrubber, los gases corrosivos dañarían los tanques."},
      {q:"El límite de O₂ reglamentario (SOLAS) en un tanque de carga inertizado es:",opts:["< 5%","< 8%","< 11%","< 15%"],correct:1,expl:"SOLAS Regla II-2/4: O₂ < 8% en tanques de carga. Por debajo del 8%, la mezcla aire/hidrocarburos sale de la zona de explosividad."},
      {q:"El gas inerte producido por una caldera de petrolero contiene principalmente:",opts:["Nitrógeno puro","CO₂ + N₂ (12-14% CO₂)","Argón","Vapor de agua"],correct:1,expl:"Los gases de combustión de una caldera contienen 12-14% CO₂ + N₂ + trazas de CO. Esta mezcla, una vez lavada, constituye el gas inerte."},
      {q:"¿Por qué la presión en los tanques debe permanecer POSITIVA durante la descarga?",opts:["Para bombear más rápido","Para evitar la entrada de aire (O₂)","Para reducir la viscosidad","Para enfriar la carga"],correct:1,expl:"Si la presión se vuelve negativa, el aire exterior (21% O₂) es aspirado → la mezcla se vuelve explosiva. La sobrepresión positiva del IGS es crítica en la descarga."},
      {q:"La válvula anti-retorno en la tubería IGS sirve para:",opts:["Regular el caudal","Impedir que los vapores de carga regresen","Medir la presión","Filtrar partículas"],correct:1,expl:"La válvula anti-retorno impide que los vapores de hidrocarburos a presión refluyan hacia el scrubber y la caldera, lo que provocaría una explosión."},
      {q:"¿En qué tipo de buque es OBLIGATORIO el IGS según SOLAS?",opts:["> 10.000 TPM","> 20.000 TPM","> 50.000 TPM","> 100.000 TPM"],correct:1,expl:"SOLAS Reg. II-2/4 (enmienda 1981, en vigor 1983): IGS obligatorio en petroleros > 20.000 TPM y buques químicos > 8.000 TPM."},
      {q:"La función de la soplante (blower) del sistema IGS es:",opts:["Enfriar el gas","Lavar el gas","Mantener la sobrepresión en los tanques","Medir O₂"],correct:2,expl:"La soplante (ventilador centrífugo) crea y mantiene la sobrepresión positiva (+50 a +150 mmWC) en los tanques. Es el 'motor' de distribución del gas inerte."},
      {q:"El proceso de llevar un tanque de 21% a < 8% O₂ se llama:",opts:["Purga","Gasificación","Desgasificación","Mezcla"],correct:0,expl:"La purga (purging) consiste en inyectar gas inerte en un tanque con aire para diluir el O₂ hasta < 8%. No confundir con la desgasificación (gas-freeing), que es la operación inversa."},
      {q:"La desgasificación (gas-freeing) consiste en:",opts:["Inyectar gas inerte","Ventilar el tanque con aire hasta < 1% LFL","Medir el contenido de CO₂","Llenar el tanque de agua"],correct:1,expl:"La desgasificación ventila el tanque con aire fresco para eliminar vapores de hidrocarburos hasta < 1% LFL. Requisito previo obligatorio para trabajos en espacios confinados."},
      {q:"La válvula PV (presión/vacío) actúa automáticamente cuando:",opts:["O₂ > 8%","Sobrepresión > +2000 Pa o depresión < -350 Pa","T° > 50°C","Caudal > 5000 m³/h"],correct:1,expl:"La válvula PV protege mecánicamente el tanque contra sobrepresiones (> +2000 Pa) y depresiones (< -350 Pa). Es el último recurso si la regulación normal falla."},
      {q:"Durante la carga de mercancía, el IGS opera en:",opts:["Modo intercambio","Modo retorno (vapores → cubierta)","Modo sobrepresión continua","Modo apagado"],correct:1,expl:"Durante la carga, los vapores salen del tanque por la tubería de retorno de vapores. El IGS mantiene presión positiva pero no sopla activamente."},
      {q:"El MT Betelgeuse (1979) demostró que sin IGS:",opts:["La descarga es más lenta","Vapores + aire forman una mezcla explosiva","La corrosión se acelera","La viscosidad aumenta"],correct:1,expl:"El Betelgeuse explotó porque los tanques no inertizados contenían una mezcla aire/vapores en zona explosiva (11-21% O₂). El IGS hecho obligatorio por SOLAS ha evitado muchas catástrofes similares."},
      {q:"La concentración de CO₂ en el gas inerte de caldera es:",opts:["1-3%","5-8%","12-14%","18-20%"],correct:2,expl:"Los gases de combustión de una caldera correctamente operada contienen 12-14% de CO₂. Esta alta concentración permite mantener O₂ < 8% en los tanques por dilución."},
      {q:"El analizador O₂ de entrada dispara el paro automático del IGS si:",opts:["O₂ < 2%","O₂ > 8%","CO₂ > 15%","Presión > 200 mmWC"],correct:1,expl:"Si el analizador detecta O₂ > 8% en el gas inerte antes de entrar al tanque, dispara el paro automático del IGS. Enviar gas con > 8% O₂ anularía el inertaje."},
      {q:"¿Cuál es el rango de presión de mantenimiento normal del IGS en los tanques?",opts:["+10 a +30 mmWC","+50 a +150 mmWC","+200 a +500 mmWC","+500 a +1000 mmWC"],correct:1,expl:"+50 a +150 mmWC (milímetros de columna de agua). Esta baja sobrepresión es suficiente para evitar la entrada de aire sin estresar excesivamente la estructura."},
    ],
    pt:[
      {q:"Qual componente do IGS arrefece e limpa os gases de combustão?",opts:["Soprador","Scrubber","Válvula anti-retorno","Válvula PV"],correct:1,expl:"O scrubber arrefece os gases de exaustão com água do mar e remove SO₂, fuligem e H₂S. Sem scrubber, os gases corrosivos danificariam os tanques."},
      {q:"O limite de O₂ regulamentar (SOLAS) num tanque de carga inertizado é:",opts:["< 5%","< 8%","< 11%","< 15%"],correct:1,expl:"SOLAS Regulação II-2/4: O₂ < 8% nos tanques de carga. Abaixo de 8%, a mistura ar/hidrocarbonetos sai da zona de explosividade."},
      {q:"O gás inerte produzido por uma caldeira de petroleiro contém principalmente:",opts:["Azoto puro","CO₂ + N₂ (12-14% CO₂)","Árgon","Vapor de água"],correct:1,expl:"Os gases de combustão de uma caldeira contêm 12-14% CO₂ + N₂ + vestígios de CO. Esta mistura, após lavagem pelo scrubber, constitui o gás inerte."},
      {q:"Por que a pressão nos tanques deve permanecer POSITIVA durante a descarga?",opts:["Para bombear mais rápido","Para evitar a entrada de ar (O₂)","Para reduzir a viscosidade","Para arrefecer a carga"],correct:1,expl:"Se a pressão se tornar negativa, o ar exterior (21% O₂) é aspirado → a mistura torna-se explosiva novamente. A sobrepressão positiva do IGS é crítica durante a descarga."},
      {q:"A válvula anti-retorno na tubagem IGS serve para:",opts:["Regular o caudal de gás","Impedir que os vapores de carga regressem","Medir a pressão","Filtrar partículas"],correct:1,expl:"A válvula anti-retorno impede que os vapores de hidrocarbonetos a pressão refluan para o scrubber e caldeira, o que causaria uma explosão."},
      {q:"Em que tipo de navio é OBRIGATÓRIO o IGS segundo SOLAS?",opts:["> 10.000 TPB","> 20.000 TPB","> 50.000 TPB","> 100.000 TPB"],correct:1,expl:"SOLAS Reg. II-2/4 (emenda 1981, em vigor 1983): IGS obrigatório em petroleiros > 20.000 TPB e navios-tanque químicos > 8.000 TPB."},
      {q:"O papel do soprador (blower) do sistema IGS é:",opts:["Arrefecer o gás","Lavar o gás","Manter a sobrepressão nos tanques","Medir O₂"],correct:2,expl:"O soprador (ventilador centrífugo) cria e mantém a sobrepressão positiva (+50 a +150 mmWC) nos tanques. É o 'motor' de distribuição do gás inerte."},
      {q:"O processo de levar um tanque de 21% para < 8% O₂ chama-se:",opts:["Purga","Gasificação","Desgasificação","Mistura"],correct:0,expl:"A purga (purging) consiste em injetar gás inerte num tanque com ar para diluir o O₂ até < 8%. Não confundir com a desgasificação (gas-freeing), que é a operação inversa."},
      {q:"A desgasificação (gas-freeing) consiste em:",opts:["Injetar gás inerte","Ventilar o tanque com ar até < 1% LFL","Medir o teor de CO₂","Encher o tanque de água"],correct:1,expl:"A desgasificação ventila o tanque com ar fresco para eliminar vapores de hidrocarbonetos até < 1% LFL. Pré-requisito obrigatório para entrada em espaço confinado."},
      {q:"A válvula PV (pressão/vácuo) actua automaticamente quando:",opts:["O₂ > 8%","Sobrepressão > +2000 Pa ou vácuo < -350 Pa","T° > 50°C","Caudal > 5000 m³/h"],correct:1,expl:"A válvula PV protege mecanicamente o tanque contra sobrepressões excessivas (> +2000 Pa) e vácuo (< -350 Pa). É o último recurso se a regulação normal falhar."},
      {q:"Durante o carregamento de carga, o IGS opera em:",opts:["Modo troca","Modo retorno (vapores → convés)","Modo sobrepressão contínua","Modo desligado"],correct:1,expl:"Durante o carregamento, os vapores saem do tanque pela tubagem de retorno de vapores. O IGS mantém pressão positiva mas não sopra ativamente."},
      {q:"O MT Betelgeuse (1979) demonstrou que sem IGS:",opts:["A descarga é mais lenta","Vapores + ar formam uma mistura explosiva","A corrosão acelera","A viscosidade aumenta"],correct:1,expl:"O Betelgeuse explodiu porque os tanques não inertizados continham uma mistura ar/vapores de hidrocarbonetos na zona explosiva (11-21% O₂). O IGS tornado obrigatório pelo SOLAS evitou muitas catástrofes semelhantes."},
      {q:"A concentração de CO₂ no gás inerte produzido pela caldeira é:",opts:["1-3%","5-8%","12-14%","18-20%"],correct:2,expl:"Os gases de combustão de uma caldeira a funcionar corretamente contêm 12-14% CO₂. Esta elevada concentração permite manter O₂ < 8% nos tanques por diluição."},
      {q:"O analisador O₂ de entrada dispara o desligamento automático do IGS se:",opts:["O₂ < 2%","O₂ > 8%","CO₂ > 15%","Pressão > 200 mmWC"],correct:1,expl:"Se o analisador detetar O₂ > 8% no gás inerte antes de entrar no tanque, dispara o desligamento automático do IGS. Enviar gás com > 8% O₂ anularia a inertização."},
      {q:"Qual é a gama de pressão normal de manutenção do IGS nos tanques?",opts:["+10 a +30 mmWC","+50 a +150 mmWC","+200 a +500 mmWC","+500 a +1000 mmWC"],correct:1,expl:"+50 a +150 mmWC (milímetros de coluna de água). Esta baixa sobrepressão é suficiente para impedir a entrada de ar sem stressar excessivamente a estrutura dos tanques."},
    ],
  };
...
export const QUIZ = {
  fr:[
    {q:"Quel est le seuil O₂ maximum dans une citerne cargo inertée selon SOLAS ?",opts:["< 5%","< 8%","< 11%","< 21%"],correct:1,expl:"SOLAS Règle II-2/4 : O₂ < 8% dans les citernes inertées. C'est le seuil qui garantit que le mélange air/hydrocarbures est hors de la zone d'explosivité."},
    {q:"Le scrubber dans le système IGS a pour rôle de :",opts:["Comprimer le gaz","Distribuer le gaz aux citernes","Refroidir et laver les fumées","Mesurer O₂"],correct:2,expl:"Le scrubber (épurateur) refroidit les fumées de chaudière avec de l'eau de mer et élimine les polluants (SO₂, suies, H₂S) avant que le gaz ne soit distribué dans les citernes."},
    {q:"Pendant le déchargement, si l'IGS tombe en panne, le risque principal est :",opts:["Surchauffe des pompes","Aspiration d'air → mélange explosif","Corrosion des tuyauteries","Augmentation de viscosité"],correct:1,expl:"Sans IGS, la pression dans les citernes devient négative lors du pompage → aspiration d'air (O₂ 21%) → mélange explosif. C'est exactement ce qui s'est passé sur le Betelgeuse en 1979."},
    {q:"Le MT Betelgeuse (1979) a entraîné l'obligation SOLAS de l'IGS sur les pétroliers :",opts:["> 5 000 tdw","> 20 000 tdw","> 50 000 tdw","> 150 000 tdw"],correct:1,expl:"Suite à l'explosion du Betelgeuse (50 morts), SOLAS a rendu l'IGS obligatoire sur tous les pétroliers > 20 000 tdw et chimiquiers > 8 000 tdw par amendement de 1981 (en vigueur 1983)."},
    {q:"La non-return valve sur la tuyauterie IGS empêche :",opts:["L'excès de pression","Le retour des vapeurs cargo vers la chaudière","La condensation d'eau","La fuite de CO₂"],correct:1,expl:"La non-return valve (clapet anti-retour) est un dispositif de sécurité essentiel qui empêche les vapeurs d'hydrocarbures inflammables de remonter de la citerne vers le scrubber ou la chaudière, évitant ainsi une explosion catastophique."},
  ],
  en:[
    {q:"What is the maximum O₂ threshold in an inerted cargo tank under SOLAS?",opts:["< 5%","< 8%","< 11%","< 21%"],correct:1,expl:"SOLAS Rule II-2/4: O₂ < 8% in inerted tanks. This is the threshold that ensures the air/hydrocarbon mixture is outside the explosive range."},
    {q:"The scrubber in the IGS system serves to:",opts:["Compress the gas","Distribute gas to tanks","Cool and wash the flue gases","Measure O₂"],correct:2,expl:"The scrubber cools the boiler flue gases with seawater and removes pollutants (SO₂, soot, H₂S) before the gas is distributed to the tanks."},
    {q:"During discharge, if the IGS breaks down, the main risk is:",opts:["Pump overheating","Air ingress → explosive mixture","Pipe corrosion","Viscosity increase"],correct:1,expl:"Without IGS, tank pressure becomes negative during pumping → air ingress (21% O₂) → explosive mixture. This is exactly what happened on the Betelgeuse in 1979."},
    {q:"The MT Betelgeuse (1979) led to the SOLAS mandatory requirement for IGS on tankers:",opts:["> 5,000 DWT","> 20,000 DWT","> 50,000 DWT","> 150,000 DWT"],correct:1,expl:"Following the Betelgeuse explosion (50 deaths), SOLAS made IGS mandatory on all tankers > 20,000 DWT and chemical tankers > 8,000 DWT by 1981 amendment (in force 1983)."},
    {q:"The non-return valve on the IGS piping prevents:",opts:["Excess pressure","Cargo vapors from flowing back to the boiler","Water condensation","CO₂ leakage"],correct:1,expl:"The non-return valve is an essential safety device that prevents flammable hydrocarbon vapors from flowing back from the tank to the scrubber or boiler, avoiding a catastrophic explosion."},
  ],
  es:[
    {q:"¿Cuál es el umbral máximo de O₂ en un tanque de carga inertizado según SOLAS?",opts:["< 5%","< 8%","< 11%","< 21%"],correct:1,expl:"SOLAS Regla II-2/4: O₂ < 8% en tanques inertizados. Este es el umbral que garantiza que la mezcla aire/hidrocarburos está fuera de la zona de explosividad."},
    {q:"El scrubber (depurador) en el sistema IGS sirve para:",opts:["Comprimir el gas","Distribuir el gas a los tanques","Enfriar y lavar los gases de combustión","Medir O₂"],correct:2,expl:"El scrubber enfría los gases de combustión de la caldera con agua de mar y elimina contaminantes (SO₂, hollín, H₂S) antes de distribuir el gas a los tanques."},
    {q:"Durante la descarga, si el IGS falla, el riesgo principal es:",opts:["Sobrecalentamiento de bombas","Entrada de aire → mezcla explosiva","Corrosión de tuberías","Aumento de viscosidad"],correct:1,expl:"Sin IGS, la presión en los tanques se vuelve negativa al bombear → entrada de aire (21% O₂) → mezcla explosiva. Exactamente lo que ocurrió en el Betelgeuse en 1979."},
    {q:"El MT Betelgeuse (1979) llevó a SOLAS a exigir el IGS en petroleros:",opts:["> 5.000 TPM","> 20.000 TPM","> 50.000 TPM","> 150.000 TPM"],correct:1,expl:"Tras la explosión del Betelgeuse (50 muertos), SOLAS hizo obligatorio el IGS en petroleros > 20.000 TPM y buques químicos > 8.000 TPM por enmienda de 1981."},
    {q:"La válvula anti-retorno en la tubería IGS impide:",opts:["El exceso de presión","El retorno de vapores de carga a la caldera","La condensación de agua","La fuga de CO₂"],correct:1,expl:"La válvula anti-retorno impide que los vapores inflamables de hidrocarburos refluyan del tanque al scrubber o la caldera, evitando una explosión catastrófica."},
  ],
  pt:[
    {q:"Qual é o limite máximo de O₂ num tanque de carga inertizado segundo SOLAS?",opts:["< 5%","< 8%","< 11%","< 21%"],correct:1,expl:"SOLAS Regra II-2/4: O₂ < 8% nos tanques inertizados. Este é o limiar que garante que a mistura ar/hidrocarbonetos está fora da zona de explosividade."},
    {q:"O scrubber no sistema IGS serve para:",opts:["Comprimir o gás","Distribuir o gás aos tanques","Arrefecer e lavar os gases de exaustão","Medir O₂"],correct:2,expl:"O scrubber arrefece os gases de exaustão da caldeira com água do mar e remove poluentes (SO₂, fuligem, H₂S) antes de distribuir o gás aos tanques."},
    {q:"Durante a descarga, se o IGS avariar, o principal risco é:",opts:["Sobreaquecimento das bombas","Entrada de ar → mistura explosiva","Corrosão das tubagens","Aumento de viscosidade"],correct:1,expl:"Sem IGS, a pressão nos tanques torna-se negativa durante a bombagem → entrada de ar (21% O₂) → mistura explosiva. Foi exatamente o que aconteceu com o Betelgeuse em 1979."},
    {q:"O MT Betelgeuse (1979) levou o SOLAS a exigir o IGS em petroleiros:",opts:["> 5.000 TPB","> 20.000 TPB","> 50.000 TPB","> 150.000 TPB"],correct:1,expl:"Após a explosão do Betelgeuse (50 mortos), o SOLAS tornou o IGS obrigatório em petroleiros > 20.000 TPB e navios-tanque químicos > 8.000 TPB pela emenda de 1981."},
    {q:"A válvula anti-retorno na tubagem IGS impede:",opts:["O excesso de pressão","O retorno dos vapores de carga para a caldeira","A condensação de água","A fuga de CO₂"],correct:1,expl:"A válvula anti-retorno impede que os vapores inflamáveis de hidrocarbonetos regressem do tanque para o scrubber ou caldeira, evitando uma explosão catastrófica."},
  ],
};
...
// MAIN EXPORT
// ══════════════════════════════════════
export default function LessonE6_L3({ lang="fr", onBack=()=>{}, onComplete=()=>{}, onNext=()=>{}, onQuizScored=(score:number,maxScore:number)=>{} }) {
  const t = T[lang]||T.fr;
        ...
        <div style={{maxWidth:480,margin:"0 auto"}}>
          ...
          {phase==="content"&&<>
            ...
            <button disabled={!bankDone} onClick={()=>{if(bankDone)setPhase("quiz");}}
              style={{opacity:bankDone?1:0.45,cursor:bankDone?"pointer":"not-allowed",width:"100%",padding:"17px 0",border:"none",borderRadius:16,background:`linear-gradient(135deg,${C.orange},${C.gold})`,fontFamily:"'Cinzel',serif",fontSize:15,fontWeight:700,letterSpacing:2,color:C.white,boxShadow:"0 10px 36px rgba(230,126,34,0.4)",marginTop:8}}>
              {t.startQuiz}
            </button>
