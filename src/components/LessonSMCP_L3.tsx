...
function MaydaySimulatorSVG({ lang }) {
  ...
  const procedure = [
    { role:"OOW", color:C.emer, action:{fr:"Panne moteur · feu salle des machines · navire prend de la gîte",en:"Engine failure · engine room fire · vessel listing",es:"Avería motor · incendio sala de máquinas · buque escorando",pt:"Avaria motor · incêndio casa das máquinas · navio a adornar"},
      ...
      fr:"[Sélectionne CH 16, puissance max 25W, active DSC ch.70 EN PREMIER]",
...
function EmergencyPhrasesSVG({ lang }) {
  ...
  const categories = {
    fire:{ label:{fr:"Incendie",en:"Fire",es:"Incendio",pt:"Incêndio"}, icon:"🔥", color:C.emer, cards:[
      { q:"How do you report a fire on board?", a:"I have a fire on board in the [engine room / accommodation / cargo hold]. Fire is [under control / not under control].", fr:"J'ai un incendie à bord dans [la salle des machines / les logements / la cale]. L'incendie est [maîtrisé / non maîtrisé]." },
      { q:"How do you report fire spreading?", a:"The fire is spreading to [location]. I am unable to control the fire. I am preparing to abandon ship.", fr:"L'incendie se propage à [emplacement]. Je ne peux pas maîtriser l'incendie. Je prépare l'abandon du navire." },
      { q:"How do you report CO2 release in engine room?", a:"CO2 has been released in the engine room. Engine room is sealed. Engines are stopped.", fr:"Le CO2 a été libéré dans la salle des machines. La salle des machines est étanche. Les machines sont arrêtées." },
      { q:"How do you request fire-fighting assistance?", a:"I require immediate fire-fighting assistance. Please send fire brigade to berth [X] / my position.", fr:"J'ai besoin d'une assistance immédiate de lutte contre l'incendie. Veuillez envoyer les pompiers au poste [X] / à ma position." },
    ]},
    collision:{ label:{fr:"Collision",en:"Collision",es:"Colisión",pt:"Colisão"}, icon:"💥", color:C.orange, cards:[
      { q:"How do you report a collision?", a:"I have been in collision with [vessel name / unknown vessel] at [time] UTC. Position [lat/long]. Extent of damage is [describe].", fr:"Je suis entré en collision avec [nom du navire / navire inconnu] à [heure] UTC. Position [lat/long]. L'étendue des dommages est [décrire]." },
      { q:"How do you report taking on water after collision?", a:"I am taking on water. Rate of flooding is [severe / moderate / slow]. I am [able to / unable to] control the flooding.", fr:"Je prends de l'eau. Le taux de remplissage est [grave / modéré / lent]. Je [peux / ne peux pas] contrôler l'envahissement." },
      { q:"How do you report hull damage?", a:"I have hull damage on the [port / starboard] side. Damage is [above / below] the waterline. [X] metres long, [X] metres wide.", fr:"J'ai des dommages à la coque sur [bâbord / tribord]. Les dommages sont [au-dessus / en dessous] de la ligne de flottaison." },
      { q:"How do you report loss of buoyancy?", a:"I am losing buoyancy. I have [X] degrees of list to [port / starboard]. I may capsize.", fr:"Je perds de la flottabilité. J'ai [X] degrés de gîte sur [bâbord / tribord]. Je risque de chavirer." },
    ]},
    mob:{ label:{fr:"Homme à la mer",en:"Man Overboard",es:"Hombre al agua",pt:"Homem ao mar"}, icon:"🆘", color:C.blue2, cards:[
      { q:"How do you report a man overboard?", a:"Man overboard! [Port / Starboard / Forward / Aft] side. Time [UTC]. Position [lat/long].", fr:"Homme à la mer ! Côté [bâbord / tribord / avant / arrière]. Heure [UTC]. Position [lat/long]." },
      { q:"What do you broadcast after MOB report?", a:"PAN-PAN PAN-PAN PAN-PAN. All stations. MV [name]. Man overboard at [position]. I am manoeuvring to recover. All vessels in vicinity please assist and keep clear.", fr:"PAN-PAN PAN-PAN PAN-PAN. Toutes stations. MV [nom]. Homme à la mer en [position]. Je manœuvre pour récupérer. Tous navires à proximité, assistez et gardez vos distances." },
      { q:"How do you report recovery of MOB?", a:"MV [name]. Man overboard is recovered. Person is [conscious / unconscious]. I require [medical assistance / no further assistance]. Cancel PAN-PAN.", fr:"MV [nom]. L'homme à la mer est récupéré. La personne est [consciente / inconsciente]. J'ai besoin [d'assistance médicale / d'aucune autre assistance]. Annulez le PAN-PAN." },
      { q:"How do you describe MOB for helicopter search?", a:"Person in water wearing [life jacket / survival suit / no lifejacket]. [Hair color, clothing description if known]. Last seen at [position] at [time] UTC.", fr:"Personne à l'eau portant [gilet de sauvetage / combinaison de survie / sans gilet]. [Couleur des cheveux, description des vêtements si connue]. Dernière vue en [position] à [heure] UTC." },
    ]},
    grounding:{ label:{fr:"Échouage",en:"Grounding",es:"Varada",pt:"Encalhe"}, icon:"🏔️", color:C.purple, cards:[
      { q:"How do you report a grounding?", a:"I have grounded at [position]. Time [UTC]. I am [able to / unable to] refloat. I require [tug / salvage / pumping] assistance.", fr:"J'ai échoué en [position]. Heure [UTC]. Je [peux / ne peux pas] me renflouer. J'ai besoin d'assistance [de remorqueur / de sauvetage / de pompage]." },
      { q:"How do you report hull damage from grounding?", a:"I have hull damage from grounding. [X] tanks are flooded. Vessel has [X] degrees list. Engine room is [flooded / dry].", fr:"J'ai des dommages à la coque dus à l'échouage. [X] citernes sont envahies. Le navire a [X] degrés de gîte. La salle des machines est [envahie / sèche]." },
      { q:"How do you request salvage assistance?", a:"I require salvage assistance. I am hard aground in position [lat/long]. Water depth alongside is [X] metres. Nature of bottom is [rock/sand/mud].", fr:"J'ai besoin d'assistance de sauvetage. J'ai échoué solidement en position [lat/long]. La profondeur d'eau le long du bord est [X] mètres. La nature du fond est [rochers/sable/vase]." },
      { q:"How do you report pollution from grounding?", a:"I am reporting an oil spill from grounding. [X] tonnes of [fuel oil / cargo] is leaking. The slick is spreading in direction [X] degrees. I require pollution control assistance.", fr:"Je signale un déversement de pétrole suite à un échouage. [X] tonnes de [fioul / cargaison] s'écoulent. La nappe se répand en direction [X] degrés. J'ai besoin d'assistance en matière de contrôle de pollution." },
    ]},
  };
    ...
    <div>
      ...
      {sel_&&<div style={{padding:"12px",borderRadius:14,background:`${sel_.color}10`,border:`1.5px solid ${sel_.color}44`,animation:"fadeUp 0.3s ease"}}>
        <div style={{padding:"6px 10px",borderRadius:8,background:`${sel_.color}22`,marginBottom:10,fontSize:10,color:sel_.color,fontWeight:700}}>
          ⚡ {lang==="fr"?"Déclencher quand :":lang==="en"?"Trigger when:":"Activar cuando:"} {sel_.trigger[lang]||sel_.trigger.en}
        </div>
        ...
        <div style={{fontSize:10,color:sel_.color,fontWeight:700,marginBottom:4}}>{lang==="fr"?"EXEMPLES :":lang==="en"?"EXAMPLES:":"EJEMPLOS:"}</div>
...
export default function LessonSMCP_L3({ lang="en", onBack=()=>{}, onComplete=()=>{} }) {
        ...
        <div style={{maxWidth:480,margin:"0 auto"}}>
          {phase==="content"&&<>
            ...
            <Card style={{marginBottom:14,background:"rgba(20,0,0,0.7)",border:`1px solid ${C.emer}22`}}>
              <div style={{fontSize:11,color:C.emer,letterSpacing:2,fontFamily:"'Cinzel',serif",marginBottom:10}}>🆘 {lang==="fr"?"SIMULATEUR PROCÉDURE MAYDAY":lang==="en"?"MAYDAY PROCEDURE SIMULATOR":"SIMULADOR PROCEDIMIENTO MAYDAY"}</div>
            ...
            <Card style={{marginBottom:14,border:`1px solid ${C.urgent}22`}}>
              <div style={{fontSize:11,color:C.urgent,letterSpacing:2,fontFamily:"'Cinzel',serif",marginBottom:10}}>🃏 {lang==="fr"?"FICHES URGENCES":lang==="en"?"EMERGENCY FLASHCARDS":"FICHAS DE URGENCIA"}</div>
            ...
            <Card style={{marginBottom:14,border:`1px solid ${C.orange}33`}}>
              <div style={{fontSize:11,color:C.orange,letterSpacing:2,fontFamily:"'Cinzel',serif",marginBottom:10}}>🎯 {lang==="fr"?"QUIZ SCÉNARIOS D'URGENCE":lang==="en"?"EMERGENCY SCENARIO QUIZ":"QUIZ ESCENARIOS URGENCIA"}</div>
            ...
            <button onClick={()=>setPhase("quiz")} style={{width:"100%",padding:"17px 0",border:"none",borderRadius:16,background:`linear-gradient(135deg,${C.emer},${C.urgent},${C.gold})`,fontFamily:"'Cinzel',serif",fontSize:15,fontWeight:700,letterSpacing:2,color:C.white,cursor:"pointer",boxShadow:`0 10px 36px ${C.emer}33`,marginTop:8}}>{t.startQuiz}</button>
          ...
          {phase==="done"&&<div style={{paddingTop:10}}>
            ...
            <button onClick={onComplete} style={{width:"100%",padding:"16px 0",border:"none",borderRadius:16,background:`linear-gradient(135deg,${C.emer},${C.gold})`,fontFamily:"'Cinzel',serif",fontSize:14,fontWeight:700,letterSpacing:2,color:C.white,cursor:"pointer",boxShadow:`0 8px 28px ${C.emer}33`,marginBottom:10}}>
