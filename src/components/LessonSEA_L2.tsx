...
const getContent = lang => {
  const d={
    en:{
      ...
      p5:"🎯 EXERCISES",p6:"📝 QUESTION BANK — 14 QUESTIONS",
    ...
    fr:{
      ...
      p5:"🎯 EXERCICES",p6:"📝 BANQUE 14 QUESTIONS",
    ...
    es:{
      ...
      p5:"🎯 EJERCICIOS",p6:"📝 BANCO 14 PREGUNTAS",
    ...
    pt:{
      ...
      p5:"🎯 EXERCÍCIOS",p6:"📝 BANCO 14 QUESTÕES",
...
export default function LessonSEA_L2({ lang="en", onBack=()=>{}, onComplete=()=>{}, onNext=()=>{}, onQuizScored=(score:number,maxScore:number)=>{} }) {
