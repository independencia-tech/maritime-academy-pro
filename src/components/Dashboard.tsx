...
const T = {
  fr:{
    ...
    navShips:"Navires", navExams:"Examens", navProfile:"Profil",
  ...
  en:{
    ...
    navShips:"Ships", navExams:"Exams", navProfile:"Profile",
  ...
  es:{
    ...
    navShips:"Barcos", navExams:"Exámenes", navProfile:"Perfil",
  ...
  pt:{
    ...
    navShips:"Navios", navExams:"Exames", navProfile:"Perfil",
    continueLesson:"▶ CONTINUAR",
...
export const MODULES = {
  ...
  lessons:[
    ...
    { id:"d7", icon:"🌦️", color:C.teal, access:"free",
      freeLessons:0, totalLessons:7,
      ...
      xp:350, status:"available", progress:0,
      lessons:[
        {id:"l1",title:{fr:"Fondamentaux de la météorologie marine",en:"Fundamentals of Marine Meteorology",es:"Fundamentos de meteorología marina",pt:"Fundamentos de meteorologia marítima"},access:"free",status:"available"},
        {id:"l2",title:{fr:"Nuages, visibilité et observation météo",en:"Clouds, Visibility and Weather Observation",es:"Nubes, visibilidad y observación meteorológica",pt:"Nuvens, visibilidade e observação meteorológica"},access:"free",status:"available"},
        {id:"l3",title:{fr:"Instruments météorologiques et observations à bord",en:"Meteorological Instruments and Shipboard Observations",es:"Instrumentos meteorológicos y observaciones a bordo",pt:"Instrumentos meteorológicos e observações a bordo"},access:"free",status:"available"},
        {id:"l4",title:{fr:"Systèmes de pression, masses d'air et fronts",en:"Pressure Systems, Air Masses and Fronts",es:"Sistemas de presión, masas de aire y frentes",pt:"Sistemas de pressão, massas de ar e frentes"},access:"free",status:"available"},
        {id:"l5",title:{fr:"Phénomènes tropicaux et dangereux",en:"Tropical and Dangerous Phenomena",es:"Fenómenos tropicales y peligrosos",pt:"Fenómenos tropicais e perigosos"},access:"free",status:"available"},
        {id:"l6",title:{fr:"Cartes météo, prévisions et informations maritimes",en:"Weather Charts, Forecasts and Maritime Information",es:"Cartas meteorológicas, previsiones e información marítima",pt:"Cartas meteorológicas, previsões e informação marítima"},access:"free",status:"available"},
        {id:"l7",title:{fr:"Routage météo et décisions par gros temps",en:"Weather Routing and Heavy Weather Decision Making",es:"Ruteo meteorológico y decisiones en mal tiempo",pt:"Rota meteorológica e decisões em mau tempo"},access:"free",status:"available"},
      ]
    },
  ],
  engine:[
...
{val:`🔥${userStreak}`,label:t.statStreak,color:C.red},
      ...
      <div style={{
        ...
        {[
          ...
          {icon:"📝",labelKey:"navExams",key:"exams",onClick:onNavExams},
